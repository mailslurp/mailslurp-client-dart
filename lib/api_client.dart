  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'InboxRulesetProjection':
          return InboxRulesetProjection.fromJson(value);
        case 'MatchOption':
        ...
        case 'PageInboxRulesetProjection':
          return PageInboxRulesetProjection.fromJson(value);
        ...
        case 'WebhookResultEntity':
          return WebhookResultEntity.fromJson(value);
