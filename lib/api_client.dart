  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'ConnectorSyncRequestResultExceptionCauseStackTrace':
          return ConnectorSyncRequestResultExceptionCauseStackTrace.fromJson(value);
        case 'ConnectorSyncRequestResultExceptionCauseSuppressed':
          return ConnectorSyncRequestResultExceptionCauseSuppressed.fromJson(value);
