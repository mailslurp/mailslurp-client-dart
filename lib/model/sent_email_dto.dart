...
class SentEmailDto {
  ...
  @override
  String toString() {
    return 'SentEmailDto[attachments=$attachments, bcc=$bcc, body=$body, bodyMD5Hash=$bodyMD5Hash, cc=$cc, charset=$charset, from=$from, id=$id, inboxId=$inboxId, isHTML=$isHTML, sentAt=$sentAt, subject=$subject, to=$to, userId=$userId, ]';
  }
