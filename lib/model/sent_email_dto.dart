...
class SentEmailDto {
  ...
  @override
  String toString() => 'SentEmailDto[id=$id, userId=$userId, inboxId=$inboxId, to=$to, from=$from, replyTo=$replyTo, cc=$cc, bcc=$bcc, attachments=$attachments, subject=$subject, bodyMD5Hash=$bodyMD5Hash, body=$body, charset=$charset, isHTML=$isHTML, sentAt=$sentAt, pixelIds=$pixelIds, messageId=$messageId]';
