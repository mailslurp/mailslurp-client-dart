...
class AliasThreadProjection {
  ...
  @override
  String toString() => 'AliasThreadProjection[userId=$userId, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, to=$to, cc=$cc, bcc=$bcc, aliasId=$aliasId, subject=$subject, name=$name, id=$id]';
