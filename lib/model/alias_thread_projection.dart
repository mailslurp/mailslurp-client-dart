...
class AliasThreadProjection {
  ...
  @override
  String toString() => 'AliasThreadProjection[name=$name, id=$id, subject=$subject, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, to=$to, cc=$cc, bcc=$bcc, updatedAt=$updatedAt, aliasId=$aliasId]';
