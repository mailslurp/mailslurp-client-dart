...
class AliasThreadProjection {
  ...
  @override
  String toString() => 'AliasThreadProjection[subject=$subject, updatedAt=$updatedAt, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, to=$to, cc=$cc, bcc=$bcc, aliasId=$aliasId, name=$name, id=$id]';
