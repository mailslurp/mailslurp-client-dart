...
class AliasThreadProjection {
  ...
  @override
  String toString() => 'AliasThreadProjection[userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, to=$to, cc=$cc, bcc=$bcc, aliasId=$aliasId, subject=$subject, name=$name, id=$id]';
