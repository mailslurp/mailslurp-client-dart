...
class AliasThreadProjection {
  ...
  @override
  String toString() => 'AliasThreadProjection[inboxId=$inboxId, userId=$userId, updatedAt=$updatedAt, createdAt=$createdAt, to=$to, cc=$cc, bcc=$bcc, aliasId=$aliasId, subject=$subject, name=$name, id=$id]';
