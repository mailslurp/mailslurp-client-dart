...
class AliasThreadProjection {
  ...
  @override
  String toString() => 'AliasThreadProjection[subject=$subject, createdAt=$createdAt, updatedAt=$updatedAt, userId=$userId, inboxId=$inboxId, to=$to, cc=$cc, bcc=$bcc, aliasId=$aliasId, name=$name, id=$id]';
