...
class AliasThreadProjection {
  ...
  @override
  String toString() => 'AliasThreadProjection[subject=$subject, userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, to=$to, cc=$cc, bcc=$bcc, aliasId=$aliasId, name=$name, id=$id]';
