...
class ValidateEmailAddressListOptions {
  ...
  bool operator ==(Object other) => identical(this, other) || other is ValidateEmailAddressListOptions &&
     ...
     other.ignoreOldResults == ignoreOldResults;

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (emailAddressList.hashCode) +
    (ignoreOldResults == null ? 0 : ignoreOldResults!.hashCode);

  @override
  String toString() => 'ValidateEmailAddressListOptions[emailAddressList=$emailAddressList, ignoreOldResults=$ignoreOldResults]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'emailAddressList'] = this.emailAddressList;
    if (this.ignoreOldResults != null) {
      json[r'ignoreOldResults'] = this.ignoreOldResults;
    } else {
      json[r'ignoreOldResults'] = null;
    }
    return json;
  }
    ...
    if (value is Map) {
      ...
      return ValidateEmailAddressListOptions(
        emailAddressList: json[r'emailAddressList'] is List
            ...
            : const [],
        ignoreOldResults: mapValueOfType<bool>(json, r'ignoreOldResults'),
      );
    }
    return null;
  }
  ...
  static Map<String, List<ValidateEmailAddressListOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ValidateEmailAddressListOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
