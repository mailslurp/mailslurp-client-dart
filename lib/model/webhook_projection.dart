...
class WebhookProjection {
  ...
  @override
  String toString() => 'WebhookProjection[name=$name, id=$id, url=$url, inboxId=$inboxId, eventName=$eventName, createdAt=$createdAt, phoneNumberId=$phoneNumberId, updatedAt=$updatedAt]';
