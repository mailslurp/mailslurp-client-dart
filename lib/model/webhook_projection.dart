...
class WebhookProjection {
  ...
  @override
  String toString() => 'WebhookProjection[url=$url, password=$password, username=$username, userId=$userId, inboxId=$inboxId, eventName=$eventName, updatedAt=$updatedAt, createdAt=$createdAt, healthStatus=$healthStatus, phoneNumberId=$phoneNumberId, name=$name, id=$id]';
