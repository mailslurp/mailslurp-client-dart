...
class WebhookProjection {
  ...
  @override
  String toString() => 'WebhookProjection[url=$url, password=$password, username=$username, updatedAt=$updatedAt, userId=$userId, inboxId=$inboxId, eventName=$eventName, createdAt=$createdAt, aiTransformId=$aiTransformId, healthStatus=$healthStatus, aiTransformerId=$aiTransformerId, phoneNumberId=$phoneNumberId, name=$name, id=$id]';
