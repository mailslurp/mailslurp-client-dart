...
class WebhookProjection {
  ...
  @override
  String toString() => 'WebhookProjection[name=$name, id=$id, url=$url, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, eventName=$eventName, phoneNumberId=$phoneNumberId]';
