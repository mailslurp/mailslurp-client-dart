...
class WebhookProjection {
  ...
  @override
  String toString() => 'WebhookProjection[inboxId=$inboxId, eventName=$eventName, createdAt=$createdAt, updatedAt=$updatedAt, phoneNumberId=$phoneNumberId, name=$name, id=$id, url=$url]';
