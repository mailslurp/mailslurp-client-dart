...
class WebhookProjection {
  ...
  @override
  String toString() => 'WebhookProjection[createdAt=$createdAt, updatedAt=$updatedAt, url=$url, inboxId=$inboxId, eventName=$eventName, phoneNumberId=$phoneNumberId, name=$name, id=$id]';
