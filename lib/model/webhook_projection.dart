...
class WebhookProjection {
  ...
  @override
  String toString() => 'WebhookProjection[url=$url, password=$password, username=$username, userId=$userId, inboxId=$inboxId, eventName=$eventName, updatedAt=$updatedAt, createdAt=$createdAt, healthStatus=$healthStatus, aiTransformerId=$aiTransformerId, aiTransformId=$aiTransformId, phoneNumberId=$phoneNumberId, name=$name, id=$id]';
