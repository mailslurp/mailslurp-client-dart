...
class GenerateStructuredContentEmailOptions {
  ...
  @override
  String toString() => 'GenerateStructuredContentEmailOptions[emailId=$emailId, contentSelector=$contentSelector, instructions=$instructions, outputSchema=$outputSchema]';
