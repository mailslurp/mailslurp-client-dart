...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[enabled=$enabled, emailAddress=$emailAddress, userId=$userId, inboxId=$inboxId, syncEnabled=$syncEnabled, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, createdAt=$createdAt, name=$name, id=$id]';
