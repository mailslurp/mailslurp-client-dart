...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[inboxId=$inboxId, userId=$userId, syncEnabled=$syncEnabled, connectorType=$connectorType, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, createdAt=$createdAt, id=$id]';
