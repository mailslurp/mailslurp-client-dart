...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[id=$id, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, syncEnabled=$syncEnabled, connectorType=$connectorType, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval]';
