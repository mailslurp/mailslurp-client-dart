...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[enabled=$enabled, inboxId=$inboxId, userId=$userId, emailAddress=$emailAddress, syncEnabled=$syncEnabled, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, createdAt=$createdAt, name=$name, id=$id]';
