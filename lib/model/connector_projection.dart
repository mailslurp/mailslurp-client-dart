...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[createdAt=$createdAt, inboxId=$inboxId, userId=$userId, syncEnabled=$syncEnabled, connectorType=$connectorType, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, id=$id]';
