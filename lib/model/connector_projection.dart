...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[inboxId=$inboxId, userId=$userId, createdAt=$createdAt, syncEnabled=$syncEnabled, connectorType=$connectorType, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, id=$id]';
