...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[enabled=$enabled, inboxId=$inboxId, emailAddress=$emailAddress, userId=$userId, syncEnabled=$syncEnabled, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, createdAt=$createdAt, name=$name, id=$id]';
