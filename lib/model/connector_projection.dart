...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[createdAt=$createdAt, enabled=$enabled, inboxId=$inboxId, userId=$userId, emailAddress=$emailAddress, syncEnabled=$syncEnabled, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, name=$name, id=$id]';
