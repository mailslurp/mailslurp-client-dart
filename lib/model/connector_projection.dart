...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[createdAt=$createdAt, userId=$userId, inboxId=$inboxId, syncEnabled=$syncEnabled, connectorType=$connectorType, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, id=$id]';
