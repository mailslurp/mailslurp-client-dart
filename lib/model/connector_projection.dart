...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[enabled=$enabled, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, syncEnabled=$syncEnabled, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, createdAt=$createdAt, name=$name, id=$id]';
