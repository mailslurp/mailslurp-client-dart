...
class ConnectorProjection {
  ...
  @override
  String toString() => 'ConnectorProjection[createdAt=$createdAt, enabled=$enabled, inboxId=$inboxId, emailAddress=$emailAddress, userId=$userId, syncEnabled=$syncEnabled, syncScheduleType=$syncScheduleType, syncInterval=$syncInterval, name=$name, id=$id]';
