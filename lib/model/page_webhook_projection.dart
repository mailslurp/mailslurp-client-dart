...
class PageWebhookProjection {
  ...
  @override
  String toString() => 'PageWebhookProjection[content=$content, pageable=$pageable, totalPages=$totalPages, totalElements=$totalElements, last=$last, size=$size, number=$number, numberOfElements=$numberOfElements, sort=$sort, first=$first, empty=$empty]';
