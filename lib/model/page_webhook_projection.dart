...
class PageWebhookProjection {
  ...
  @override
  String toString() => 'PageWebhookProjection[content=$content, pageable=$pageable, totalPages=$totalPages, totalElements=$totalElements, last=$last, size=$size, number=$number, first=$first, numberOfElements=$numberOfElements, sort=$sort, empty=$empty]';
