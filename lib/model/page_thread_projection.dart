...
class PageThreadProjection {
  ...
  @override
  String toString() => 'PageThreadProjection[content=$content, pageable=$pageable, total=$total, totalPages=$totalPages, totalElements=$totalElements, last=$last, size=$size, number=$number, sort=$sort, numberOfElements=$numberOfElements, first=$first, empty=$empty]';
