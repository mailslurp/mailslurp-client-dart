...
class PhonePlanDto {
  ...
  static Map<String, List<PhonePlanDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PhonePlanDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class PhonePlanDtoPhoneCountryEnum {
  ...
  static const CA = PhonePlanDtoPhoneCountryEnum._(r'CA');
  static const EE = PhonePlanDtoPhoneCountryEnum._(r'EE');
  static const HK = PhonePlanDtoPhoneCountryEnum._(r'HK');
  static const PL = PhonePlanDtoPhoneCountryEnum._(r'PL');
  static const CH = PhonePlanDtoPhoneCountryEnum._(r'CH');
  static const PT = PhonePlanDtoPhoneCountryEnum._(r'PT');
  static const NL = PhonePlanDtoPhoneCountryEnum._(r'NL');
  static const IL = PhonePlanDtoPhoneCountryEnum._(r'IL');
  static const SE = PhonePlanDtoPhoneCountryEnum._(r'SE');
  ...
  PhonePlanDtoPhoneCountryEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'CA': return PhonePlanDtoPhoneCountryEnum.CA;
        case r'EE': return PhonePlanDtoPhoneCountryEnum.EE;
        case r'HK': return PhonePlanDtoPhoneCountryEnum.HK;
        case r'PL': return PhonePlanDtoPhoneCountryEnum.PL;
        case r'CH': return PhonePlanDtoPhoneCountryEnum.CH;
        case r'PT': return PhonePlanDtoPhoneCountryEnum.PT;
        case r'NL': return PhonePlanDtoPhoneCountryEnum.NL;
        case r'IL': return PhonePlanDtoPhoneCountryEnum.IL;
        case r'SE': return PhonePlanDtoPhoneCountryEnum.SE;
        default:
          if (!allowNull) {
