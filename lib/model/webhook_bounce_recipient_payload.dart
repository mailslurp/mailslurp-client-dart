...
class WebhookBounceRecipientPayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookBounceRecipientPayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  WebhookBounceRecipientPayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookBounceRecipientPayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
