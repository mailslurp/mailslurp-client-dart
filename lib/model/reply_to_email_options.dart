...
class ReplyToEmailOptions {
  ...
  @override
  String toString() => 'ReplyToEmailOptions[body=$body, isHTML=$isHTML, from=$from, replyTo=$replyTo, charset=$charset, attachments=$attachments, templateVariables=$templateVariables, template=$template, sendStrategy=$sendStrategy, useInboxName=$useInboxName]';
