...
class ReplyToEmailOptions {
  ...
  @override
  String toString() {
    return 'ReplyToEmailOptions[attachments=$attachments, body=$body, charset=$charset, isHTML=$isHTML, replyTo=$replyTo, sendStrategy=$sendStrategy, template=$template, templateVariables=$templateVariables, ]';
  }
