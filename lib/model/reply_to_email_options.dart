...
class ReplyToEmailOptions {
  ...
  @override
  String toString() => 'ReplyToEmailOptions[attachments=$attachments, body=$body, charset=$charset, from=$from, isHTML=$isHTML, replyTo=$replyTo, sendStrategy=$sendStrategy, template=$template, templateVariables=$templateVariables, useInboxName=$useInboxName]';
