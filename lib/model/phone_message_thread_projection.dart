...
class PhoneMessageThreadProjection {
  ...
  @override
  String toString() => 'PhoneMessageThreadProjection[phoneNumber=$phoneNumber, phoneNumberId=$phoneNumberId, otherPhoneNumber=$otherPhoneNumber, lastMessageDirection=$lastMessageDirection, lastBody=$lastBody, lastCreated=$lastCreated]';
