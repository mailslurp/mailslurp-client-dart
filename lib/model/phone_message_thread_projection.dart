...
class PhoneMessageThreadProjection {
  ...
  @override
  String toString() => 'PhoneMessageThreadProjection[lastBody=$lastBody, phoneNumber=$phoneNumber, phoneNumberId=$phoneNumberId, otherPhoneNumber=$otherPhoneNumber, lastMessageDirection=$lastMessageDirection, lastCreated=$lastCreated]';
