...
class WebhookDeliveryStatusPayload {
  ...
  static Map<String, List<WebhookDeliveryStatusPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = WebhookDeliveryStatusPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class WebhookDeliveryStatusPayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookDeliveryStatusPayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  static const NEW_GUEST_USER = WebhookDeliveryStatusPayloadEventNameEnum._(r'NEW_GUEST_USER');
  ...
  WebhookDeliveryStatusPayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookDeliveryStatusPayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
        ...
        case r'NEW_GUEST_USER': return WebhookDeliveryStatusPayloadEventNameEnum.NEW_GUEST_USER;
        default:
          if (!allowNull) {
