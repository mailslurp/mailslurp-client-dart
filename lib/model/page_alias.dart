...
class PageAlias {
  ...
  @override
  String toString() => 'PageAlias[content=$content, pageable=$pageable, totalPages=$totalPages, totalElements=$totalElements, last=$last, size=$size, number=$number, first=$first, numberOfElements=$numberOfElements, sort=$sort, empty=$empty]';
