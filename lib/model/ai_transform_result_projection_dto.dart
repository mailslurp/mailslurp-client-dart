...
class AITransformResultProjectionDto {
  ...
  @override
  String toString() => 'AITransformResultProjectionDto[id=$id, aiTransformId=$aiTransformId, aiTransformMappingId=$aiTransformMappingId, userId=$userId, value=$value, entityId=$entityId, entityType=$entityType, smsId=$smsId, emailId=$emailId, attachmentId=$attachmentId, createdAt=$createdAt]';
