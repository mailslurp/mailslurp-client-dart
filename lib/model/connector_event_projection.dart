...
class ConnectorEventProjection {
  ...
  @override
  String toString() => 'ConnectorEventProjection[message=$message, id=$id, size=$size, status=$status, eventType=$eventType, createdAt=$createdAt, connectorId=$connectorId, seen=$seen]';
