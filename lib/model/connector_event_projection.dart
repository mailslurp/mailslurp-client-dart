...
class ConnectorEventProjection {
  ...
  @override
  String toString() => 'ConnectorEventProjection[message=$message, id=$id, size=$size, eventType=$eventType, createdAt=$createdAt, connectorId=$connectorId, seen=$seen, status=$status]';
