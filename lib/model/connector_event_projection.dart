...
class ConnectorEventProjection {
  ...
  @override
  String toString() => 'ConnectorEventProjection[eventType=$eventType, createdAt=$createdAt, connectorId=$connectorId, seen=$seen, message=$message, id=$id, size=$size, status=$status]';
