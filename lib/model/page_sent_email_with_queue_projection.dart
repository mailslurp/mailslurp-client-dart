...
class PageSentEmailWithQueueProjection {
  ...
  @override
  String toString() => 'PageSentEmailWithQueueProjection[content=$content, pageable=$pageable, total=$total, size=$size, number=$number, numberOfElements=$numberOfElements, totalPages=$totalPages, totalElements=$totalElements, last=$last, sort=$sort, first=$first, empty=$empty]';
