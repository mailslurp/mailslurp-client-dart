...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[createdAt=$createdAt, userId=$userId, inboxId=$inboxId, sentEmailId=$sentEmailId, recipient=$recipient, seen=$seen, seenAt=$seenAt, name=$name, id=$id]';
