...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[sentEmailId=$sentEmailId, userId=$userId, inboxId=$inboxId, recipient=$recipient, seen=$seen, seenAt=$seenAt, createdAt=$createdAt, name=$name, id=$id]';
