...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[inboxId=$inboxId, userId=$userId, sentEmailId=$sentEmailId, recipient=$recipient, seen=$seen, seenAt=$seenAt, createdAt=$createdAt, name=$name, id=$id]';
