...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, inboxId=$inboxId, userId=$userId, sentEmailId=$sentEmailId, createdAt=$createdAt, recipient=$recipient, seen=$seen, seenAt=$seenAt]';
