...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[userId=$userId, sentEmailId=$sentEmailId, inboxId=$inboxId, createdAt=$createdAt, recipient=$recipient, seen=$seen, seenAt=$seenAt, name=$name, id=$id]';
