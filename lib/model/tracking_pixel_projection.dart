...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[createdAt=$createdAt, sentEmailId=$sentEmailId, userId=$userId, inboxId=$inboxId, recipient=$recipient, seen=$seen, seenAt=$seenAt, name=$name, id=$id]';
