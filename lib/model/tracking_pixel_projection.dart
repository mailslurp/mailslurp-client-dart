...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, seen=$seen, recipient=$recipient, seenAt=$seenAt, sentEmailId=$sentEmailId]';
