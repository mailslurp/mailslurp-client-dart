...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, userId=$userId, sentEmailId=$sentEmailId, inboxId=$inboxId, createdAt=$createdAt, recipient=$recipient, seen=$seen, seenAt=$seenAt]';
