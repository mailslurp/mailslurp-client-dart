...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[userId=$userId, inboxId=$inboxId, sentEmailId=$sentEmailId, createdAt=$createdAt, recipient=$recipient, seen=$seen, seenAt=$seenAt, name=$name, id=$id]';
