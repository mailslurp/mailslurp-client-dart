...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[userId=$userId, inboxId=$inboxId, sentEmailId=$sentEmailId, recipient=$recipient, seen=$seen, seenAt=$seenAt, createdAt=$createdAt, name=$name, id=$id]';
