...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[createdAt=$createdAt, id=$id, inboxId=$inboxId, name=$name, recipient=$recipient, seen=$seen, seenAt=$seenAt, sentEmailId=$sentEmailId, userId=$userId]';
