...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, sentEmailId=$sentEmailId, recipient=$recipient, seen=$seen, seenAt=$seenAt]';
