...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[createdAt=$createdAt, inboxId=$inboxId, userId=$userId, sentEmailId=$sentEmailId, recipient=$recipient, seen=$seen, seenAt=$seenAt, name=$name, id=$id]';
