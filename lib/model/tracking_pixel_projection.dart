...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, createdAt=$createdAt, userId=$userId, inboxId=$inboxId, recipient=$recipient, seen=$seen, seenAt=$seenAt, sentEmailId=$sentEmailId]';
