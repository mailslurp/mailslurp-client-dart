...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, sentEmailId=$sentEmailId, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, recipient=$recipient, seen=$seen, seenAt=$seenAt]';
