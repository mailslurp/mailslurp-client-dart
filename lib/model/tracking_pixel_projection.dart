...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, recipient=$recipient, seen=$seen, seenAt=$seenAt, sentEmailId=$sentEmailId]';
