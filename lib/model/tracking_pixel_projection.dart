...
class TrackingPixelProjection {
  ...
  @override
  String toString() => 'TrackingPixelProjection[name=$name, id=$id, createdAt=$createdAt, userId=$userId, inboxId=$inboxId, seen=$seen, recipient=$recipient, seenAt=$seenAt, sentEmailId=$sentEmailId]';
