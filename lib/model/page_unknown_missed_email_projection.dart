...
class PageUnknownMissedEmailProjection {
  ...
  @override
  String toString() => 'PageUnknownMissedEmailProjection[content=$content, pageable=$pageable, totalElements=$totalElements, totalPages=$totalPages, last=$last, numberOfElements=$numberOfElements, sort=$sort, first=$first, size=$size, number=$number, empty=$empty]';
