...
class PageUnknownMissedEmailProjection {
  ...
  @override
  String toString() => 'PageUnknownMissedEmailProjection[content=$content, pageable=$pageable, totalPages=$totalPages, totalElements=$totalElements, last=$last, numberOfElements=$numberOfElements, size=$size, number=$number, sort=$sort, first=$first, empty=$empty]';
