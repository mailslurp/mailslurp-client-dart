...
class PageUnknownMissedEmailProjection {
  ...
  @override
  String toString() => 'PageUnknownMissedEmailProjection[content=$content, pageable=$pageable, total=$total, last=$last, totalElements=$totalElements, totalPages=$totalPages, size=$size, number=$number, sort=$sort, first=$first, numberOfElements=$numberOfElements, empty=$empty]';
