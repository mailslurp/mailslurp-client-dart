...
class ContactDto {
  ...
  @override
  String toString() => 'ContactDto[company=$company, createdAt=$createdAt, emailAddresses=$emailAddresses, firstName=$firstName, groupId=$groupId, id=$id, lastName=$lastName, metaData=$metaData, optOut=$optOut, tags=$tags]';
