...
class TestNewInboxForwarderOptions {
  ...
  int get hashCode =>
    ...
    (inboxForwarderTestOptions.hashCode) +
    (createInboxForwarderOptions.hashCode);
  ...
  static TestNewInboxForwarderOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TestNewInboxForwarderOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TestNewInboxForwarderOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TestNewInboxForwarderOptions> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TestNewInboxForwarderOptions>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TestNewInboxForwarderOptions.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TestNewInboxForwarderOptions> mapFromJson(dynamic json) {
    final map = <String, TestNewInboxForwarderOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TestNewInboxForwarderOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<TestNewInboxForwarderOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TestNewInboxForwarderOptions>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TestNewInboxForwarderOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
