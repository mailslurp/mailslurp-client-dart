...
class InboxDto {
  ...
  @override
  String toString() => 'InboxDto[id=$id, userId=$userId, createdAt=$createdAt, name=$name, description=$description, emailAddress=$emailAddress, expiresAt=$expiresAt, favourite=$favourite, tags=$tags, inboxType=$inboxType, readOnly=$readOnly, virtualInbox=$virtualInbox]';
