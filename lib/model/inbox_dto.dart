...
class InboxDtoFunctionsAsEnum {
  ...
  static const OAUTH_CONNECTION_GMAIL = InboxDtoFunctionsAsEnum._(r'OAUTH_CONNECTION_GMAIL');
  ...
  InboxDtoFunctionsAsEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'OAUTH_CONNECTION_GMAIL': return InboxDtoFunctionsAsEnum.OAUTH_CONNECTION_GMAIL;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
...
class InboxDtoAccountRegionEnum {
  ...
  static const uSWEST2ACCOUNTSTAGING = InboxDtoAccountRegionEnum._(r'US_WEST_2_ACCOUNT_STAGING');
  static const uSEAST1ACCOUNTSTAGING = InboxDtoAccountRegionEnum._(r'US_EAST_1_ACCOUNT_STAGING');
  static const eUWEST1ACCOUNTSTAGING = InboxDtoAccountRegionEnum._(r'EU_WEST_1_ACCOUNT_STAGING');
  static const uSWEST2ACCOUNTSES1 = InboxDtoAccountRegionEnum._(r'US_WEST_2_ACCOUNT_SES_1');
  static const eUWEST1ACCOUNTSES1 = InboxDtoAccountRegionEnum._(r'EU_WEST_1_ACCOUNT_SES_1');
  static const uSWEST2ACCOUNTSES2 = InboxDtoAccountRegionEnum._(r'US_WEST_2_ACCOUNT_SES_2');
  static const eUWEST1ACCOUNTSES2 = InboxDtoAccountRegionEnum._(r'EU_WEST_1_ACCOUNT_SES_2');
  static const uSWEST2ACCOUNTBYTEWISE = InboxDtoAccountRegionEnum._(r'US_WEST_2_ACCOUNT_BYTEWISE');
  static const eUWEST1ACCOUNTBYTEWISE = InboxDtoAccountRegionEnum._(r'EU_WEST_1_ACCOUNT_BYTEWISE');
  static const uSWEST2 = InboxDtoAccountRegionEnum._(r'US_WEST_2');
  static const eUWEST1 = InboxDtoAccountRegionEnum._(r'EU_WEST_1');
  static const uSEAST1 = InboxDtoAccountRegionEnum._(r'US_EAST_1');
...
class InboxDtoAccountRegionEnumTypeTransformer {
  ...
  InboxDtoAccountRegionEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'US_WEST_2_ACCOUNT_STAGING': return InboxDtoAccountRegionEnum.uSWEST2ACCOUNTSTAGING;
        case r'US_EAST_1_ACCOUNT_STAGING': return InboxDtoAccountRegionEnum.uSEAST1ACCOUNTSTAGING;
        case r'EU_WEST_1_ACCOUNT_STAGING': return InboxDtoAccountRegionEnum.eUWEST1ACCOUNTSTAGING;
        case r'US_WEST_2_ACCOUNT_SES_1': return InboxDtoAccountRegionEnum.uSWEST2ACCOUNTSES1;
        case r'EU_WEST_1_ACCOUNT_SES_1': return InboxDtoAccountRegionEnum.eUWEST1ACCOUNTSES1;
        case r'US_WEST_2_ACCOUNT_SES_2': return InboxDtoAccountRegionEnum.uSWEST2ACCOUNTSES2;
        case r'EU_WEST_1_ACCOUNT_SES_2': return InboxDtoAccountRegionEnum.eUWEST1ACCOUNTSES2;
        case r'US_WEST_2_ACCOUNT_BYTEWISE': return InboxDtoAccountRegionEnum.uSWEST2ACCOUNTBYTEWISE;
        case r'EU_WEST_1_ACCOUNT_BYTEWISE': return InboxDtoAccountRegionEnum.eUWEST1ACCOUNTBYTEWISE;
        case r'US_WEST_2': return InboxDtoAccountRegionEnum.uSWEST2;
        case r'EU_WEST_1': return InboxDtoAccountRegionEnum.eUWEST1;
        case r'US_EAST_1': return InboxDtoAccountRegionEnum.uSEAST1;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
