...
class SendEmailOptions {
  ...
  List<SendEmailBodyPart>? bodyParts;
  ...
  bool operator ==(Object other) => identical(this, other) || other is SendEmailOptions &&
     ...
     other.ignoreEmptyRecipients == ignoreEmptyRecipients &&
  ...
  int get hashCode =>
    ...
    (ignoreEmptyRecipients == null ? 0 : ignoreEmptyRecipients!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.fromName != null) {
      json[r'fromName'] = this.fromName;
    } else {
      json[r'fromName'] = null;
    }
    if (this.cc != null) {
      json[r'cc'] = this.cc;
    } else {
    ...
    if (this.ignoreEmptyRecipients != null) {
      json[r'ignoreEmptyRecipients'] = this.ignoreEmptyRecipients;
    } else {
      json[r'ignoreEmptyRecipients'] = null;
    }
    ...
    if (this.bodyParts != null) {
      json[r'bodyParts'] = this.bodyParts;
    } else {
      json[r'bodyParts'] = null;
    }
    return json;
  }
  ...
  static SendEmailOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SendEmailOptions(
        ...
        fromName: mapValueOfType<String>(json, r'fromName'),
        ...
        ignoreEmptyRecipients: mapValueOfType<bool>(json, r'ignoreEmptyRecipients'),
        isXAmpHtml: mapValueOfType<bool>(json, r'isXAmpHtml'),
        bodyParts: SendEmailBodyPart.listFromJson(json[r'bodyParts']),
      );
    }
    return null;
  }
