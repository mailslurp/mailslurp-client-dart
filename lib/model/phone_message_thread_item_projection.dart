...
class PhoneMessageThreadItemProjection {
  ...
  @override
  String toString() => 'PhoneMessageThreadItemProjection[body=$body, phoneNumberId=$phoneNumberId, created=$created, fromPhoneNumber=$fromPhoneNumber, toPhoneNumber=$toPhoneNumber, messageDirection=$messageDirection]';
