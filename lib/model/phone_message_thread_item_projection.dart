...
class PhoneMessageThreadItemProjection {
  ...
  @override
  String toString() => 'PhoneMessageThreadItemProjection[id=$id, body=$body, created=$created, phoneNumberId=$phoneNumberId, messageDirection=$messageDirection, fromPhoneNumber=$fromPhoneNumber, toPhoneNumber=$toPhoneNumber]';
