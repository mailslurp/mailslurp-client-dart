...
class PhoneMessageThreadItemProjection {
  ...
  @override
  String toString() => 'PhoneMessageThreadItemProjection[body=$body, phoneNumberId=$phoneNumberId, created=$created, messageDirection=$messageDirection, fromPhoneNumber=$fromPhoneNumber, toPhoneNumber=$toPhoneNumber, id=$id]';
