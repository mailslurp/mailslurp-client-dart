...
class PhoneMessageThreadItemProjection {
  ...
  @override
  String toString() => 'PhoneMessageThreadItemProjection[body=$body, phoneNumberId=$phoneNumberId, created=$created, toPhoneNumber=$toPhoneNumber, messageDirection=$messageDirection, fromPhoneNumber=$fromPhoneNumber]';
