...
class PhoneMessageThreadItemProjection {
  ...
  @override
  String toString() => 'PhoneMessageThreadItemProjection[id=$id, body=$body, phoneNumberId=$phoneNumberId, created=$created, messageDirection=$messageDirection, fromPhoneNumber=$fromPhoneNumber, toPhoneNumber=$toPhoneNumber]';
