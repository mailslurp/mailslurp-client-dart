...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, contentId=$contentId, createdAt=$createdAt, attachmentId=$attachmentId, name=$name, id=$id, contentLength=$contentLength, contentType=$contentType]';
