...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[createdAt=$createdAt, updatedAt=$updatedAt, userId=$userId, contentId=$contentId, attachmentId=$attachmentId, name=$name, contentLength=$contentLength, contentType=$contentType]';
