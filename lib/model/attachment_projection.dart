...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, id=$id, contentLength=$contentLength, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, contentId=$contentId, attachmentId=$attachmentId, contentType=$contentType]';
