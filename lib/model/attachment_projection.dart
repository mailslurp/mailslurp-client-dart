...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, id=$id, contentLength=$contentLength, contentType=$contentType, userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, contentId=$contentId, attachmentId=$attachmentId]';
