...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[createdAt=$createdAt, updatedAt=$updatedAt, userId=$userId, inboxId=$inboxId, contentId=$contentId, attachmentId=$attachmentId, name=$name, id=$id, contentLength=$contentLength, contentType=$contentType]';
