...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[updatedAt=$updatedAt, contentId=$contentId, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, attachmentId=$attachmentId, name=$name, id=$id, contentLength=$contentLength, contentType=$contentType]';
