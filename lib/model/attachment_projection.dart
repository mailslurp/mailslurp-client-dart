...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, contentLength=$contentLength, contentType=$contentType, attachmentId=$attachmentId, userId=$userId, createdAt=$createdAt, updatedAt=$updatedAt]';
