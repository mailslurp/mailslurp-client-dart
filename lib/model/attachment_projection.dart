...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, contentLength=$contentLength, updatedAt=$updatedAt, userId=$userId, attachmentId=$attachmentId, createdAt=$createdAt, contentType=$contentType]';
