...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, contentLength=$contentLength, userId=$userId, attachmentId=$attachmentId, updatedAt=$updatedAt, createdAt=$createdAt, contentType=$contentType]';
