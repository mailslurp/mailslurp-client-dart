...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[inboxId=$inboxId, userId=$userId, updatedAt=$updatedAt, createdAt=$createdAt, contentId=$contentId, attachmentId=$attachmentId, name=$name, id=$id, contentLength=$contentLength, contentType=$contentType]';
