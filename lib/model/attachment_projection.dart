...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[userId=$userId, attachmentId=$attachmentId, createdAt=$createdAt, updatedAt=$updatedAt, contentId=$contentId, name=$name, contentLength=$contentLength, contentType=$contentType]';
