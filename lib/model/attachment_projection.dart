...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, contentId=$contentId, attachmentId=$attachmentId, name=$name, id=$id, contentLength=$contentLength, contentType=$contentType]';
