...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, contentLength=$contentLength, contentType=$contentType, userId=$userId, attachmentId=$attachmentId, createdAt=$createdAt, updatedAt=$updatedAt]';
