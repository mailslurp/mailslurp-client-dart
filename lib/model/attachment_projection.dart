...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, contentLength=$contentLength, userId=$userId, createdAt=$createdAt, attachmentId=$attachmentId, updatedAt=$updatedAt, contentType=$contentType]';
