...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, contentLength=$contentLength, contentType=$contentType, userId=$userId, createdAt=$createdAt, updatedAt=$updatedAt, attachmentId=$attachmentId]';
