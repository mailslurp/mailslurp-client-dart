...
class AttachmentProjection {
  ...
  @override
  String toString() => 'AttachmentProjection[name=$name, id=$id, contentLength=$contentLength, userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, contentId=$contentId, attachmentId=$attachmentId, contentType=$contentType]';
