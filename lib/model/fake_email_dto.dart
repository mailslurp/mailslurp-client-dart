...
class FakeEmailDto {
  ...
  @override
  String toString() => 'FakeEmailDto[id=$id, emailAddress=$emailAddress, sender=$sender, recipients=$recipients, subject=$subject, preview=$preview, body=$body, seen=$seen, createdAt=$createdAt]';
