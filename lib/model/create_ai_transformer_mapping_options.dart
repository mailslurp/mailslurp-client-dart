...
class CreateAITransformerMappingOptions {
  ...
  @override
  String toString() => 'CreateAITransformerMappingOptions[name=$name, aiTransformId=$aiTransformId, entityId=$entityId, entityType=$entityType, contentSelector=$contentSelector, triggerSelector=$triggerSelector, spreadRootArray=$spreadRootArray, matchOptions=$matchOptions]';
  ...
  static CreateAITransformerMappingOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateAITransformerMappingOptions(
        ...
        matchOptions: AIMappingMatchOptions.fromJson(json[r'matchOptions']),
      );
    }
    return null;
  }
