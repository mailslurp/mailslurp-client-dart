...
class Email {
  ...
  @override
  String toString() => 'Email[analysis=$analysis, attachments=$attachments, bcc=$bcc, body=$body, bodyExcerpt=$bodyExcerpt, bodyMD5Hash=$bodyMD5Hash, cc=$cc, charset=$charset, createdAt=$createdAt, from=$from, headers=$headers, id=$id, inboxId=$inboxId, isHTML=$isHTML, read=$read, recipients=$recipients, replyTo=$replyTo, sender=$sender, subject=$subject, teamAccess=$teamAccess, to=$to, updatedAt=$updatedAt, userId=$userId]';
