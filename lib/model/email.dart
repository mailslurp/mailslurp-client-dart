...
class Email {
  ...
  @override
  String toString() => 'Email[id=$id, userId=$userId, inboxId=$inboxId, domainId=$domainId, to=$to, from=$from, sender=$sender, recipients=$recipients, replyTo=$replyTo, cc=$cc, bcc=$bcc, headers=$headers, headersMap=$headersMap, attachments=$attachments, subject=$subject, body=$body, bodyExcerpt=$bodyExcerpt, bodyMD5Hash=$bodyMD5Hash, isHTML=$isHTML, charset=$charset, analysis=$analysis, createdAt=$createdAt, updatedAt=$updatedAt, read=$read, teamAccess=$teamAccess, html=$html]';
  ...
  static Email fromJson(Map<String, dynamic> json) => json == null
    ...
    : Email(
        ...
        headersMap: json[r'headersMap'] == null
          ? null
          : (json[r'headersMap'] as Map).cast<String, List>(),
