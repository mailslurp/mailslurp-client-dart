...
class Email {
  ...
  @override
  String toString() {
    return 'Email[analysis=$analysis, attachments=$attachments, bcc=$bcc, body=$body, bodyMD5Hash=$bodyMD5Hash, cc=$cc, charset=$charset, createdAt=$createdAt, from=$from, headers=$headers, id=$id, inboxId=$inboxId, isHTML=$isHTML, read=$read, subject=$subject, to=$to, updatedAt=$updatedAt, userId=$userId, ]';
  }
