...
class Email {
  ...
  @override
  String toString() => 'Email[id=$id, userId=$userId, inboxId=$inboxId, to=$to, from=$from, sender=$sender, recipients=$recipients, replyTo=$replyTo, cc=$cc, bcc=$bcc, headers=$headers, attachments=$attachments, subject=$subject, body=$body, bodyExcerpt=$bodyExcerpt, bodyMD5Hash=$bodyMD5Hash, charset=$charset, analysis=$analysis, createdAt=$createdAt, updatedAt=$updatedAt, read=$read, teamAccess=$teamAccess, html=$html]';
