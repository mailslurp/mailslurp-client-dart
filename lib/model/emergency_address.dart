...
class EmergencyAddress {
  ...
  static Map<String, List<EmergencyAddress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmergencyAddress.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class EmergencyAddressPhoneCountryEnum {
  ...
  static const CA = EmergencyAddressPhoneCountryEnum._(r'CA');
  static const EE = EmergencyAddressPhoneCountryEnum._(r'EE');
  static const HK = EmergencyAddressPhoneCountryEnum._(r'HK');
  static const PL = EmergencyAddressPhoneCountryEnum._(r'PL');
  static const CH = EmergencyAddressPhoneCountryEnum._(r'CH');
  static const PT = EmergencyAddressPhoneCountryEnum._(r'PT');
  static const NL = EmergencyAddressPhoneCountryEnum._(r'NL');
  static const IL = EmergencyAddressPhoneCountryEnum._(r'IL');
  static const SE = EmergencyAddressPhoneCountryEnum._(r'SE');
  ...
  EmergencyAddressPhoneCountryEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'CA': return EmergencyAddressPhoneCountryEnum.CA;
        case r'EE': return EmergencyAddressPhoneCountryEnum.EE;
        case r'HK': return EmergencyAddressPhoneCountryEnum.HK;
        case r'PL': return EmergencyAddressPhoneCountryEnum.PL;
        case r'CH': return EmergencyAddressPhoneCountryEnum.CH;
        case r'PT': return EmergencyAddressPhoneCountryEnum.PT;
        case r'NL': return EmergencyAddressPhoneCountryEnum.NL;
        case r'IL': return EmergencyAddressPhoneCountryEnum.IL;
        case r'SE': return EmergencyAddressPhoneCountryEnum.SE;
        default:
          if (!allowNull) {
