...
class CreatePhoneNumberOptions {
  ...
  @override
  String toString() => 'CreatePhoneNumberOptions[phoneCountry=$phoneCountry, name=$name, description=$description, schedule=$schedule, phoneNumberEndpointOverride=$phoneNumberEndpointOverride, phoneNumberVariant=$phoneNumberVariant, phoneProvider=$phoneProvider]';
...
class CreatePhoneNumberOptionsPhoneProviderEnum {
  ...
  static const TWILIO = CreatePhoneNumberOptionsPhoneProviderEnum._(r'TWILIO');
  static const TELNYX = CreatePhoneNumberOptionsPhoneProviderEnum._(r'TELNYX');
...
class CreatePhoneNumberOptionsPhoneProviderEnumTypeTransformer {
  ...
  CreatePhoneNumberOptionsPhoneProviderEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'TWILIO': return CreatePhoneNumberOptionsPhoneProviderEnum.TWILIO;
        case r'TELNYX': return CreatePhoneNumberOptionsPhoneProviderEnum.TELNYX;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
