...
class AbstractWebhookPayload {
  ...
  @override
  String toString() => 'AbstractWebhookPayload[messageId=$messageId, eventName=$eventName, webhookId=$webhookId, webhookName=$webhookName]';
  ...
  static Map<String, List<AbstractWebhookPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AbstractWebhookPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class AbstractWebhookPayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = AbstractWebhookPayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  static const NEW_GUEST_USER = AbstractWebhookPayloadEventNameEnum._(r'NEW_GUEST_USER');
  ...
  AbstractWebhookPayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return AbstractWebhookPayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
        ...
        case r'NEW_GUEST_USER': return AbstractWebhookPayloadEventNameEnum.NEW_GUEST_USER;
        default:
          if (!allowNull) {
