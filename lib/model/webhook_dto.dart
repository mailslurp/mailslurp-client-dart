...
class WebhookDto {
  ...
  @override
  String toString() => 'WebhookDto[id=$id, userId=$userId, basicAuth=$basicAuth, name=$name, phoneId=$phoneId, inboxId=$inboxId, url=$url, method=$method, payloadJsonSchema=$payloadJsonSchema, createdAt=$createdAt, updatedAt=$updatedAt, eventName=$eventName, requestHeaders=$requestHeaders]';
