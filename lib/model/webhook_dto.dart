...
class WebhookDtoEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookDtoEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  WebhookDtoEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookDtoEventNameEnum.NEW_AI_TRANSFORM_RESULT;
