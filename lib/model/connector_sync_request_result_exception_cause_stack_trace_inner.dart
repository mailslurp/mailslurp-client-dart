...
class ConnectorSyncRequestResultExceptionCauseStackTraceInner {
  ...
  @override
  String toString() => 'ConnectorSyncRequestResultExceptionCauseStackTraceInner[classLoaderName=$classLoaderName, moduleName=$moduleName, moduleVersion=$moduleVersion, methodName=$methodName, fileName=$fileName, lineNumber=$lineNumber, className=$className, nativeMethod=$nativeMethod]';
