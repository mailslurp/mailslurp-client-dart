...
class PageWebhookResult {
  ...
  @override
  String toString() => 'PageWebhookResult[content=$content, pageable=$pageable, totalElements=$totalElements, totalPages=$totalPages, last=$last, size=$size, number=$number, numberOfElements=$numberOfElements, sort=$sort, first=$first, empty=$empty]';
