...
class PageWebhookResult {
  ...
  List<WebhookResultEntity> content;
  ...
  @override
  String toString() => 'PageWebhookResult[content=$content, empty=$empty, first=$first, last=$last, number=$number, numberOfElements=$numberOfElements, pageable=$pageable, size=$size, sort=$sort, totalElements=$totalElements, totalPages=$totalPages]';
  ...
  static PageWebhookResult fromJson(Map<String, dynamic> json) => json == null
    ? null
    : PageWebhookResult(
        content: WebhookResultEntity.listFromJson(json[r'content']),
        empty: json[r'empty'],
        first: json[r'first'],
        last: json[r'last'],
