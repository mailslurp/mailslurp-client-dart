...
class PageExpiredInboxRecordProjection {
  ...
  @override
  String toString() => 'PageExpiredInboxRecordProjection[content=$content, pageable=$pageable, totalElements=$totalElements, totalPages=$totalPages, last=$last, size=$size, number=$number, numberOfElements=$numberOfElements, sort=$sort, first=$first, empty=$empty]';
