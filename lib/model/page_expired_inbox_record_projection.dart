...
class PageExpiredInboxRecordProjection {
  ...
  @override
  String toString() => 'PageExpiredInboxRecordProjection[content=$content, pageable=$pageable, totalPages=$totalPages, totalElements=$totalElements, last=$last, numberOfElements=$numberOfElements, size=$size, number=$number, sort=$sort, first=$first, empty=$empty]';
