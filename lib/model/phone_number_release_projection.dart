...
class PhoneNumberReleaseProjection {
  ...
  @override
  String toString() => 'PhoneNumberReleaseProjection[name=$name, id=$id, userId=$userId, phoneCountry=$phoneCountry, createdAt=$createdAt, phoneNumber=$phoneNumber, subscriptionSchedule=$subscriptionSchedule, planCurrency=$planCurrency]';
