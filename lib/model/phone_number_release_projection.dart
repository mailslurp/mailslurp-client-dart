...
class PhoneNumberReleaseProjection {
  ...
  @override
  String toString() => 'PhoneNumberReleaseProjection[userId=$userId, createdAt=$createdAt, phoneNumber=$phoneNumber, phoneCountry=$phoneCountry, subscriptionSchedule=$subscriptionSchedule, planCurrency=$planCurrency, name=$name, id=$id]';
