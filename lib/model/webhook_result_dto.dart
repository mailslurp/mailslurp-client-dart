...
class WebhookResultDto {
  ...
  bool operator ==(Object other) => identical(this, other) || other is WebhookResultDto &&
     ...
     other.smsId == smsId &&
     other.aiTransformerId == aiTransformerId;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.aiTransformerId != null) {
      json[r'aiTransformerId'] = this.aiTransformerId;
    } else {
      json[r'aiTransformerId'] = null;
    }
    return json;
  }
  ...
  static WebhookResultDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return WebhookResultDto(
        ...
        aiTransformerId: mapValueOfType<String>(json, r'aiTransformerId'),
      );
    }
    return null;
  }
...
class WebhookResultDtoWebhookEventEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookResultDtoWebhookEventEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  static const NEW_GUEST_USER = WebhookResultDtoWebhookEventEnum._(r'NEW_GUEST_USER');
  ...
  WebhookResultDtoWebhookEventEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookResultDtoWebhookEventEnum.NEW_AI_TRANSFORM_RESULT;
        ...
        case r'NEW_GUEST_USER': return WebhookResultDtoWebhookEventEnum.NEW_GUEST_USER;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
