...
class WebhookBouncePayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookBouncePayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  WebhookBouncePayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookBouncePayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
