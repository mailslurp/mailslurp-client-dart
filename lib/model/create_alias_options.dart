...
class CreateAliasOptions {
  ...
  bool operator ==(Object other) => identical(this, other) || other is CreateAliasOptions &&
     ...
     other.verifyEmailAddress == verifyEmailAddress;
  ...
  int get hashCode =>
    ...
    (verifyEmailAddress == null ? 0 : verifyEmailAddress!.hashCode);

  @override
  String toString() => 'CreateAliasOptions[emailAddress=$emailAddress, inboxId=$inboxId, name=$name, useThreads=$useThreads, domainId=$domainId, verifyEmailAddress=$verifyEmailAddress]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.verifyEmailAddress != null) {
      json[r'verifyEmailAddress'] = this.verifyEmailAddress;
    } else {
      json[r'verifyEmailAddress'] = null;
    }
    return json;
  }
  ...
  static CreateAliasOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateAliasOptions(
        ...
        verifyEmailAddress: mapValueOfType<bool>(json, r'verifyEmailAddress'),
      );
    }
    return null;
  }
