...
class AITransformMappingProjection {
  ...
  @override
  String toString() => 'AITransformMappingProjection[userId=$userId, aiTransformId=$aiTransformId, entityId=$entityId, entityType=$entityType, contentSelector=$contentSelector, triggerSelector=$triggerSelector, name=$name, id=$id]';
