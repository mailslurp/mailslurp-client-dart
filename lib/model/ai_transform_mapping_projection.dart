...
class AITransformMappingProjection {
  ...
  @override
  String toString() => 'AITransformMappingProjection[name=$name, id=$id, userId=$userId, createdAt=$createdAt, entityType=$entityType, aiTransformId=$aiTransformId, entityId=$entityId, contentSelector=$contentSelector, triggerSelector=$triggerSelector]';
