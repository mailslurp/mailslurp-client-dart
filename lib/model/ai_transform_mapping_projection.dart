...
class AITransformMappingProjection {
  ...
  @override
  String toString() => 'AITransformMappingProjection[userId=$userId, createdAt=$createdAt, entityType=$entityType, aiTransformId=$aiTransformId, entityId=$entityId, contentSelector=$contentSelector, triggerSelector=$triggerSelector, name=$name, id=$id]';
