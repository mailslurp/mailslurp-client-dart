...
class WebhookEmailOpenedPayload {
  ...
  static Map<String, List<WebhookEmailOpenedPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = WebhookEmailOpenedPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class WebhookEmailOpenedPayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookEmailOpenedPayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  static const NEW_GUEST_USER = WebhookEmailOpenedPayloadEventNameEnum._(r'NEW_GUEST_USER');
  ...
  WebhookEmailOpenedPayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookEmailOpenedPayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
        ...
        case r'NEW_GUEST_USER': return WebhookEmailOpenedPayloadEventNameEnum.NEW_GUEST_USER;
        default:
          if (!allowNull) {
