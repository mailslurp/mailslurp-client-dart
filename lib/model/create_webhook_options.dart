...
class CreateWebhookOptions {
  ...
  @override
  String toString() => 'CreateWebhookOptions[url=$url, basicAuth=$basicAuth, name=$name, eventName=$eventName, includeHeaders=$includeHeaders, requestBodyTemplate=$requestBodyTemplate, aiTransformId=$aiTransformId, useStaticIpRange=$useStaticIpRange, ignoreInsecureSslCertificates=$ignoreInsecureSslCertificates, tags=$tags]';
...
class CreateWebhookOptionsEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = CreateWebhookOptionsEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  CreateWebhookOptionsEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return CreateWebhookOptionsEventNameEnum.NEW_AI_TRANSFORM_RESULT;
