...
class PageInboxForwarderEvents {
  ...
  @override
  String toString() => 'PageInboxForwarderEvents[content=$content, pageable=$pageable, totalElements=$totalElements, totalPages=$totalPages, last=$last, numberOfElements=$numberOfElements, sort=$sort, first=$first, size=$size, number=$number, empty=$empty]';
