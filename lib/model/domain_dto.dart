...
class DomainDto {
  ...
  DomainDto({
    ...
    this.duplicateRecordsMessage,
    required this.hasDuplicateRecords,
  ...
  bool operator ==(Object other) => identical(this, other) || other is DomainDto &&
     ...
     other.duplicateRecordsMessage == duplicateRecordsMessage &&
     other.hasDuplicateRecords == hasDuplicateRecords &&
  ...
  int get hashCode =>
    ...
    (dkimTokens.hashCode) +
    (duplicateRecordsMessage == null ? 0 : duplicateRecordsMessage!.hashCode) +
    (hasDuplicateRecords.hashCode) +
  ...
  @override
  String toString() => 'DomainDto[id=$id, userId=$userId, domain=$domain, verificationToken=$verificationToken, dkimTokens=$dkimTokens, duplicateRecordsMessage=$duplicateRecordsMessage, hasDuplicateRecords=$hasDuplicateRecords, missingRecordsMessage=$missingRecordsMessage, hasMissingRecords=$hasMissingRecords, isVerified=$isVerified, domainNameRecords=$domainNameRecords, catchAllInboxId=$catchAllInboxId, createdAt=$createdAt, updatedAt=$updatedAt, domainType=$domainType]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.duplicateRecordsMessage != null) {
      json[r'duplicateRecordsMessage'] = this.duplicateRecordsMessage;
    } else {
      json[r'duplicateRecordsMessage'] = null;
    }
      json[r'hasDuplicateRecords'] = this.hasDuplicateRecords;
    ...
    if (value is Map) {
      ...
      return DomainDto(
        ...
        dkimTokens: json[r'dkimTokens'] is List
            ...
            : const [],
        duplicateRecordsMessage: mapValueOfType<String>(json, r'duplicateRecordsMessage'),
        hasDuplicateRecords: mapValueOfType<bool>(json, r'hasDuplicateRecords')!,
