...
class DomainDto {
  ...
  @override
  String toString() => 'DomainDto[id=$id, userId=$userId, domain=$domain, verificationToken=$verificationToken, dkimTokens=$dkimTokens, isVerified=$isVerified, domainNameRecords=$domainNameRecords, catchAllInboxId=$catchAllInboxId, createdAt=$createdAt, updatedAt=$updatedAt, domainType=$domainType]';
