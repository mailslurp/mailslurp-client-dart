...
class DomainDto {
  ...
  @override
  String toString() {
    return 'DomainDto[createdAt=$createdAt, dkimTokens=$dkimTokens, domain=$domain, domainNameRecords=$domainNameRecords, id=$id, isVerified=$isVerified, updatedAt=$updatedAt, userId=$userId, verificationToken=$verificationToken, ]';
  }
