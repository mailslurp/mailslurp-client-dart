...
class SentSmsProjection {
  ...
  @override
  String toString() => 'SentSmsProjection[id=$id, body=$body, userId=$userId, createdAt=$createdAt, phoneNumber=$phoneNumber, fromNumber=$fromNumber, toNumber=$toNumber, replyToId=$replyToId]';
