...
class SentSmsProjection {
  ...
  @override
  String toString() => 'SentSmsProjection[body=$body, userId=$userId, createdAt=$createdAt, phoneNumber=$phoneNumber, fromNumber=$fromNumber, toNumber=$toNumber, replyToId=$replyToId, id=$id]';
