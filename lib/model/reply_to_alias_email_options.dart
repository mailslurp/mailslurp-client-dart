...
class ReplyToAliasEmailOptions {
  ...
  @override
  String toString() => 'ReplyToAliasEmailOptions[body=$body, isHTML=$isHTML, charset=$charset, attachments=$attachments, templateVariables=$templateVariables, template=$template, sendStrategy=$sendStrategy, useInboxName=$useInboxName]';
