...
class PageSentEmailProjection {
  ...
  @override
  String toString() => 'PageSentEmailProjection[content=$content, pageable=$pageable, total=$total, size=$size, number=$number, totalPages=$totalPages, numberOfElements=$numberOfElements, totalElements=$totalElements, last=$last, sort=$sort, first=$first, empty=$empty]';
