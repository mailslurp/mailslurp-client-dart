...
class PageSentEmailProjection {
  ...
  @override
  String toString() => 'PageSentEmailProjection[content=$content, pageable=$pageable, size=$size, number=$number, numberOfElements=$numberOfElements, totalElements=$totalElements, totalPages=$totalPages, last=$last, sort=$sort, first=$first, empty=$empty]';
