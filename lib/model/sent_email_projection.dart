...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, userId=$userId, subject=$subject, inboxId=$inboxId, attachments=$attachments, to=$to, createdAt=$createdAt, bcc=$bcc, cc=$cc, bodyMD5Hash=$bodyMD5Hash, virtualSend=$virtualSend]';
