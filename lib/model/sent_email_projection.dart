...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[subject=$subject, id=$id, bodyMD5Hash=$bodyMD5Hash, from=$from, inboxId=$inboxId, userId=$userId, attachments=$attachments, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, virtualSend=$virtualSend]';
