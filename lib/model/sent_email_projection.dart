...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[inboxId=$inboxId, id=$id, from=$from, subject=$subject, userId=$userId, attachments=$attachments, createdAt=$createdAt, to=$to, bcc=$bcc, cc=$cc, bodyMD5Hash=$bodyMD5Hash, virtualSend=$virtualSend]';
