...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, userId=$userId, subject=$subject, createdAt=$createdAt, bodyMD5Hash=$bodyMD5Hash, bcc=$bcc, cc=$cc, virtualSend=$virtualSend, inboxId=$inboxId, attachments=$attachments, to=$to]';
