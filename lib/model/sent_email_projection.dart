...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, userId=$userId, subject=$subject, inboxId=$inboxId, bodyMD5Hash=$bodyMD5Hash, bcc=$bcc, cc=$cc, virtualSend=$virtualSend, attachments=$attachments, to=$to, createdAt=$createdAt]';
