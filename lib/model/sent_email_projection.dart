...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, subject=$subject, attachments=$attachments, userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, bodyMD5Hash=$bodyMD5Hash, virtualSend=$virtualSend]';
