...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, userId=$userId, subject=$subject, createdAt=$createdAt, attachments=$attachments, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, bodyMD5Hash=$bodyMD5Hash, virtualSend=$virtualSend]';
