...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, userId=$userId, subject=$subject, bodyMD5Hash=$bodyMD5Hash, bcc=$bcc, cc=$cc, inboxId=$inboxId, attachments=$attachments, to=$to, createdAt=$createdAt]';
