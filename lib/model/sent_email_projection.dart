...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, userId=$userId, subject=$subject, attachments=$attachments, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, bodyMD5Hash=$bodyMD5Hash]';
