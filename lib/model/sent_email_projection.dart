...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[createdAt=$createdAt, id=$id, from=$from, subject=$subject, inboxId=$inboxId, userId=$userId, attachments=$attachments, to=$to, bcc=$bcc, cc=$cc, bodyMD5Hash=$bodyMD5Hash, virtualSend=$virtualSend]';
