...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[createdAt=$createdAt, id=$id, subject=$subject, from=$from, attachments=$attachments, userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, bodyMD5Hash=$bodyMD5Hash, virtualSend=$virtualSend]';
