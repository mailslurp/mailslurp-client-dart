...
class SentEmailProjection {
  ...
  @override
  String toString() => 'SentEmailProjection[id=$id, from=$from, userId=$userId, subject=$subject, attachments=$attachments, inboxId=$inboxId, createdAt=$createdAt, to=$to, bcc=$bcc, cc=$cc, bodyMD5Hash=$bodyMD5Hash]';
