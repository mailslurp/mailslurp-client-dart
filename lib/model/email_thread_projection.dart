...
class EmailThreadProjection {
  ...
  @override
  String toString() => 'EmailThreadProjection[subject=$subject, createdAt=$createdAt, updatedAt=$updatedAt, unread=$unread, sender=$sender, recipients=$recipients, userId=$userId, inboxId=$inboxId, to=$to, cc=$cc, bcc=$bcc, hasAttachments=$hasAttachments, messageCount=$messageCount, lastBodyExcerpt=$lastBodyExcerpt, lastTextExcerpt=$lastTextExcerpt, lastCreatedAt=$lastCreatedAt, lastFrom=$lastFrom, lastSender=$lastSender, id=$id, from=$from]';
