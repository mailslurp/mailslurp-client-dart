...
class InboxForwarderEventDto {
  ...
  @override
  String toString() => 'InboxForwarderEventDto[id=$id, inboxId=$inboxId, emailId=$emailId, sentId=$sentId, userId=$userId, forwarderId=$forwarderId, message=$message, status=$status, createdAt=$createdAt]';
