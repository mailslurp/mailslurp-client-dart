...
class MissedEmailDto {
  ...
  static MissedEmailDto fromJson(Map<String, dynamic> json) => json == null
    ? null
    : MissedEmailDto(
        id: json[r'id'],
  ...
  static List<MissedEmailDto> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <MissedEmailDto>[]
      : json.map((v) => MissedEmailDto.fromJson(v)).toList(growable: true == growable);

  static Map<String, MissedEmailDto> mapFromJson(Map<String, dynamic> json) {
    final map = <String, MissedEmailDto>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = MissedEmailDto.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of MissedEmailDto-objects as value to a dart map
  static Map<String, List<MissedEmailDto>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<MissedEmailDto>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = MissedEmailDto.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
