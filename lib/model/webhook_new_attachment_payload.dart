...
class WebhookNewAttachmentPayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookNewAttachmentPayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  static const NEW_GUEST_USER = WebhookNewAttachmentPayloadEventNameEnum._(r'NEW_GUEST_USER');
  ...
  WebhookNewAttachmentPayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookNewAttachmentPayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
        ...
        case r'NEW_GUEST_USER': return WebhookNewAttachmentPayloadEventNameEnum.NEW_GUEST_USER;
        default:
          if (!allowNull) {
