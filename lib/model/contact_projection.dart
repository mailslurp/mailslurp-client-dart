...
class ContactProjection {
  ...
  @override
  String toString() => 'ContactProjection[id=$id, groupId=$groupId, createdAt=$createdAt, emailAddresses=$emailAddresses, optOut=$optOut, firstName=$firstName, lastName=$lastName, company=$company]';
