...
class ContactProjection {
  ...
  @override
  String toString() => 'ContactProjection[id=$id, emailAddress=$emailAddress, createdAt=$createdAt, emailAddresses=$emailAddresses, firstName=$firstName, lastName=$lastName, company=$company, optOut=$optOut, groupId=$groupId]';
