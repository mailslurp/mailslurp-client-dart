...
class ContactProjection {
  ...
  @override
  String toString() => 'ContactProjection[emailAddress=$emailAddress, createdAt=$createdAt, emailAddresses=$emailAddresses, firstName=$firstName, lastName=$lastName, company=$company, optOut=$optOut, id=$id, groupId=$groupId]';
