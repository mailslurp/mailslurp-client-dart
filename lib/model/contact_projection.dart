...
class ContactProjection {
  ...
  @override
  String toString() => 'ContactProjection[id=$id, groupId=$groupId, emailAddress=$emailAddress, createdAt=$createdAt, emailAddresses=$emailAddresses, firstName=$firstName, lastName=$lastName, company=$company, optOut=$optOut]';
