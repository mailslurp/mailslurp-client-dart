...
class ContactProjection {
  ...
  @override
  String toString() => 'ContactProjection[id=$id, groupId=$groupId, createdAt=$createdAt, lastName=$lastName, company=$company, emailAddresses=$emailAddresses, optOut=$optOut, firstName=$firstName]';
