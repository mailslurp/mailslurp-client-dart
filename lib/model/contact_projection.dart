...
class ContactProjection {
  ...
  @override
  String toString() => 'ContactProjection[emailAddress=$emailAddress, emailAddresses=$emailAddresses, firstName=$firstName, lastName=$lastName, company=$company, optOut=$optOut, createdAt=$createdAt, id=$id, groupId=$groupId]';
