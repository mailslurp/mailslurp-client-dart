...
class ContactProjection {
  ...
  @override
  String toString() => 'ContactProjection[emailAddress=$emailAddress, emailAddresses=$emailAddresses, createdAt=$createdAt, firstName=$firstName, lastName=$lastName, company=$company, optOut=$optOut, id=$id, groupId=$groupId]';
