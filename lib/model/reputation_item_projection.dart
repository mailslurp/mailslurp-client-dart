...
class ReputationItemProjection {
  ...
  @override
  String toString() => 'ReputationItemProjection[id=$id, severity=$severity, createdAt=$createdAt, recipient=$recipient, reputationType=$reputationType, source_=$source_]';
