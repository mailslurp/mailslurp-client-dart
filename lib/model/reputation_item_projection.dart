...
class ReputationItemProjection {
  ...
  @override
  String toString() => 'ReputationItemProjection[id=$id, severity=$severity, source_=$source_, createdAt=$createdAt, recipient=$recipient, reputationType=$reputationType]';
