...
class WebhookPayload {
  ...
  @override
  String toString() => 'WebhookPayload[attachmentMetaDatas=$attachmentMetaDatas, bcc=$bcc, cc=$cc, createdAt=$createdAt, emailId=$emailId, eventName=$eventName, from=$from, inboxId=$inboxId, messageId=$messageId, subject=$subject, to=$to, webhookId=$webhookId, webhookName=$webhookName]';
