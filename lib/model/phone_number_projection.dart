...
class PhoneNumberProjection {
  ...
  @override
  String toString() => 'PhoneNumberProjection[name=$name, id=$id, userId=$userId, phoneCountry=$phoneCountry, createdAt=$createdAt, providerLabel=$providerLabel, lineType=$lineType, carrierName=$carrierName, mobileCountryCode=$mobileCountryCode, mobileNetworkCode=$mobileNetworkCode, phoneNumber=$phoneNumber]';
...
class PhoneNumberProjectionPhoneCountryEnum {
  ...
  static const FI = PhoneNumberProjectionPhoneCountryEnum._(r'FI');
  ...
  PhoneNumberProjectionPhoneCountryEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'FI': return PhoneNumberProjectionPhoneCountryEnum.FI;
