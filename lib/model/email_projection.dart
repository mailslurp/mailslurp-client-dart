...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[inboxId=$inboxId, attachments=$attachments, createdAt=$createdAt, to=$to, bcc=$bcc, cc=$cc, domainId=$domainId, read=$read, bodyExcerpt=$bodyExcerpt, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash, textExcerpt=$textExcerpt, subject=$subject, id=$id, from=$from]';
