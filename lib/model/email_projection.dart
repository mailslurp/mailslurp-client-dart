...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, subject=$subject, inboxId=$inboxId, attachments=$attachments, bodyMD5Hash=$bodyMD5Hash, bodyExcerpt=$bodyExcerpt, to=$to, createdAt=$createdAt, bcc=$bcc, cc=$cc, domainId=$domainId, teamAccess=$teamAccess, read=$read]';
