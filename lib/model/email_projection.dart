...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, inboxId=$inboxId, subject=$subject, to=$to, attachments=$attachments, bcc=$bcc, cc=$cc, createdAt=$createdAt, teamAccess=$teamAccess, read=$read, bodyMD5Hash=$bodyMD5Hash, bodyExcerpt=$bodyExcerpt]';
