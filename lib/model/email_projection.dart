...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[subject=$subject, inboxId=$inboxId, attachments=$attachments, to=$to, domainId=$domainId, bcc=$bcc, cc=$cc, read=$read, bodyExcerpt=$bodyExcerpt, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash, textExcerpt=$textExcerpt, createdAt=$createdAt, id=$id, from=$from]';
