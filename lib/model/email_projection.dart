...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[subject=$subject, sizeBytes=$sizeBytes, messageId=$messageId, favourite=$favourite, domainId=$domainId, attachments=$attachments, inboxId=$inboxId, createdAt=$createdAt, to=$to, cc=$cc, bcc=$bcc, sender=$sender, recipients=$recipients, plusAddress=$plusAddress, imapUid=$imapUid, inReplyTo=$inReplyTo, read=$read, bodyExcerpt=$bodyExcerpt, textExcerpt=$textExcerpt, bodyPartContentTypes=$bodyPartContentTypes, bodyMD5Hash=$bodyMD5Hash, teamAccess=$teamAccess, id=$id, threadId=$threadId, from=$from]';
