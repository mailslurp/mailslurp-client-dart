...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[subject=$subject, inboxId=$inboxId, attachments=$attachments, sender=$sender, recipients=$recipients, sizeBytes=$sizeBytes, createdAt=$createdAt, to=$to, cc=$cc, bcc=$bcc, messageId=$messageId, domainId=$domainId, favourite=$favourite, plusAddress=$plusAddress, imapUid=$imapUid, inReplyTo=$inReplyTo, read=$read, bodyExcerpt=$bodyExcerpt, textExcerpt=$textExcerpt, bodyPartContentTypes=$bodyPartContentTypes, bodyMD5Hash=$bodyMD5Hash, teamAccess=$teamAccess, id=$id, threadId=$threadId, from=$from]';
