...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, subject=$subject, inboxId=$inboxId, createdAt=$createdAt, to=$to, attachments=$attachments, bcc=$bcc, cc=$cc, teamAccess=$teamAccess, read=$read, bodyMD5Hash=$bodyMD5Hash, bodyExcerpt=$bodyExcerpt]';
