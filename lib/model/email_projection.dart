...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, createdAt=$createdAt, subject=$subject, inboxId=$inboxId, to=$to, attachments=$attachments, bcc=$bcc, cc=$cc, teamAccess=$teamAccess, read=$read, bodyMD5Hash=$bodyMD5Hash, bodyExcerpt=$bodyExcerpt]';
