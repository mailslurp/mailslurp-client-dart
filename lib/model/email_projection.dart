...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, subject=$subject, attachments=$attachments, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, domainId=$domainId, read=$read, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash, bodyExcerpt=$bodyExcerpt]';
