...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, subject=$subject, attachments=$attachments, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, read=$read, bodyMD5Hash=$bodyMD5Hash, bodyExcerpt=$bodyExcerpt, teamAccess=$teamAccess]';
