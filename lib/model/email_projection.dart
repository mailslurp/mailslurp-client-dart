...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, subject=$subject, inboxId=$inboxId, attachments=$attachments, createdAt=$createdAt, to=$to, bcc=$bcc, cc=$cc, domainId=$domainId, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash, read=$read, bodyExcerpt=$bodyExcerpt]';
