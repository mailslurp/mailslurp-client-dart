...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[subject=$subject, attachments=$attachments, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, domainId=$domainId, read=$read, bodyExcerpt=$bodyExcerpt, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash, textExcerpt=$textExcerpt, createdAt=$createdAt, id=$id, from=$from]';
