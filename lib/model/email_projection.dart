...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[id=$id, from=$from, subject=$subject, attachments=$attachments, inboxId=$inboxId, createdAt=$createdAt, to=$to, bcc=$bcc, cc=$cc, domainId=$domainId, read=$read, bodyExcerpt=$bodyExcerpt, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash]';
