...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[createdAt=$createdAt, inboxId=$inboxId, attachments=$attachments, to=$to, domainId=$domainId, bcc=$bcc, cc=$cc, read=$read, bodyExcerpt=$bodyExcerpt, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash, textExcerpt=$textExcerpt, subject=$subject, id=$id, from=$from]';
