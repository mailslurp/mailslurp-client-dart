...
class EmailProjection {
  ...
  @override
  String toString() => 'EmailProjection[attachments=$attachments, inboxId=$inboxId, to=$to, domainId=$domainId, bcc=$bcc, cc=$cc, read=$read, bodyExcerpt=$bodyExcerpt, teamAccess=$teamAccess, bodyMD5Hash=$bodyMD5Hash, textExcerpt=$textExcerpt, createdAt=$createdAt, subject=$subject, id=$id, from=$from]';
