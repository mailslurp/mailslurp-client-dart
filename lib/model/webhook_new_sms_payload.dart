...
class WebhookNewSmsPayload {
  ...
  static Map<String, List<WebhookNewSmsPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = WebhookNewSmsPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class WebhookNewSmsPayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookNewSmsPayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  static const NEW_GUEST_USER = WebhookNewSmsPayloadEventNameEnum._(r'NEW_GUEST_USER');
  ...
  WebhookNewSmsPayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookNewSmsPayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
        ...
        case r'NEW_GUEST_USER': return WebhookNewSmsPayloadEventNameEnum.NEW_GUEST_USER;
        default:
          if (!allowNull) {
