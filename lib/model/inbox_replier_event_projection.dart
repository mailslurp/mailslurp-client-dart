...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[message=$message, id=$id, status=$status, emailId=$emailId, inboxId=$inboxId, userId=$userId, recipients=$recipients, createdAt=$createdAt, sentId=$sentId, replierId=$replierId]';
