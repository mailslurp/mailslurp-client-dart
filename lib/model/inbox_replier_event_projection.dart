...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[createdAt=$createdAt, recipients=$recipients, userId=$userId, emailId=$emailId, inboxId=$inboxId, sentId=$sentId, replierId=$replierId, message=$message, id=$id, status=$status]';
