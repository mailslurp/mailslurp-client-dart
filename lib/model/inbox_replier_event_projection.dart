...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[message=$message, id=$id, status=$status, userId=$userId, emailId=$emailId, inboxId=$inboxId, createdAt=$createdAt, replierId=$replierId]';
