...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[createdAt=$createdAt, replierId=$replierId, recipients=$recipients, emailId=$emailId, inboxId=$inboxId, userId=$userId, sentId=$sentId, message=$message, id=$id, status=$status]';
