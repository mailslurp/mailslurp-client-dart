...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[recipients=$recipients, emailId=$emailId, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, sentId=$sentId, replierId=$replierId, message=$message, id=$id, status=$status]';
