...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[createdAt=$createdAt, recipients=$recipients, emailId=$emailId, inboxId=$inboxId, userId=$userId, sentId=$sentId, replierId=$replierId, message=$message, id=$id, status=$status]';
