...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[recipients=$recipients, userId=$userId, emailId=$emailId, inboxId=$inboxId, sentId=$sentId, replierId=$replierId, createdAt=$createdAt, message=$message, id=$id, status=$status]';
