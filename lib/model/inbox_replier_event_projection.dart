...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[message=$message, id=$id, recipients=$recipients, userId=$userId, emailId=$emailId, inboxId=$inboxId, createdAt=$createdAt, sentId=$sentId, replierId=$replierId, status=$status]';
