...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[emailId=$emailId, inboxId=$inboxId, recipients=$recipients, userId=$userId, createdAt=$createdAt, sentId=$sentId, replierId=$replierId, message=$message, id=$id, status=$status]';
