...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[userId=$userId, emailId=$emailId, inboxId=$inboxId, recipients=$recipients, createdAt=$createdAt, sentId=$sentId, replierId=$replierId, message=$message, id=$id, status=$status]';
