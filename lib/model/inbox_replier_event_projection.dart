...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[userId=$userId, emailId=$emailId, inboxId=$inboxId, createdAt=$createdAt, recipients=$recipients, sentId=$sentId, replierId=$replierId, message=$message, id=$id, status=$status]';
