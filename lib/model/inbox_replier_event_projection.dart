...
class InboxReplierEventProjection {
  ...
  @override
  String toString() => 'InboxReplierEventProjection[message=$message, id=$id, status=$status, recipients=$recipients, emailId=$emailId, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, sentId=$sentId, replierId=$replierId]';
