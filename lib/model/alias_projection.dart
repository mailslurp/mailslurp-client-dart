...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[createdAt=$createdAt, updatedAt=$updatedAt, emailAddress=$emailAddress, userId=$userId, inboxId=$inboxId, useThreads=$useThreads, name=$name, id=$id]';
