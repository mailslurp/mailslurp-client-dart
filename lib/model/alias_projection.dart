...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[name=$name, id=$id, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, useThreads=$useThreads, createdAt=$createdAt, updatedAt=$updatedAt]';
