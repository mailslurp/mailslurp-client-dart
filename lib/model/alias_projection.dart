...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[name=$name, id=$id, emailAddress=$emailAddress, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, useThreads=$useThreads]';
