...
class AliasProjection {
  ...
  @override
  String toString() {
    return 'AliasProjection[id=$id, inboxId=$inboxId, name=$name, pendingEmailAddress=$pendingEmailAddress, useThreads=$useThreads, userId=$userId, verifiedEmailAddress=$verifiedEmailAddress, ]';
  }
