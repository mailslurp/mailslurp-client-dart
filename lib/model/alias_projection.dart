...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, useThreads=$useThreads, name=$name, id=$id]';
