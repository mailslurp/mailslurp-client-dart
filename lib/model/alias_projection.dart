...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[userId=$userId, inboxId=$inboxId, emailAddress=$emailAddress, createdAt=$createdAt, updatedAt=$updatedAt, useThreads=$useThreads, name=$name, id=$id]';
