...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[updatedAt=$updatedAt, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, createdAt=$createdAt, useThreads=$useThreads, name=$name, id=$id]';
