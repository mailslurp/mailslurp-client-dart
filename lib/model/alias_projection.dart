...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[name=$name, id=$id, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, useThreads=$useThreads]';
