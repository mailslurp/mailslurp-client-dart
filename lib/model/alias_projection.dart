...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[createdAt=$createdAt, updatedAt=$updatedAt, inboxId=$inboxId, userId=$userId, emailAddress=$emailAddress, useThreads=$useThreads, name=$name, id=$id]';
