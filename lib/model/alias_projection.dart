...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[inboxId=$inboxId, emailAddress=$emailAddress, userId=$userId, useThreads=$useThreads, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, id=$id]';
