...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[inboxId=$inboxId, userId=$userId, emailAddress=$emailAddress, useThreads=$useThreads, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, id=$id]';
