...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[emailAddress=$emailAddress, userId=$userId, inboxId=$inboxId, useThreads=$useThreads, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, id=$id]';
