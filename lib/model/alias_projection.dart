...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[name=$name, id=$id, createdAt=$createdAt, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, useThreads=$useThreads, updatedAt=$updatedAt]';
