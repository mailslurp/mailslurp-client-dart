...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[emailAddress=$emailAddress, inboxId=$inboxId, userId=$userId, useThreads=$useThreads, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, id=$id]';
