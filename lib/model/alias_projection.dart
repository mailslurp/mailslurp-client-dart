...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[name=$name, id=$id, inboxId=$inboxId, emailAddress=$emailAddress, userId=$userId, createdAt=$createdAt, updatedAt=$updatedAt, useThreads=$useThreads]';
