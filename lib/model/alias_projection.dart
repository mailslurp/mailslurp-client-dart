...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[createdAt=$createdAt, updatedAt=$updatedAt, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, useThreads=$useThreads, name=$name, id=$id]';
