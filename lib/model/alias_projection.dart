...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[name=$name, id=$id, inboxId=$inboxId, userId=$userId, emailAddress=$emailAddress, updatedAt=$updatedAt, createdAt=$createdAt, useThreads=$useThreads]';
