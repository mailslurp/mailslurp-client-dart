...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[name=$name, id=$id, emailAddress=$emailAddress, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, useThreads=$useThreads, updatedAt=$updatedAt]';
