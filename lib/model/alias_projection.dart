...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[inboxId=$inboxId, userId=$userId, emailAddress=$emailAddress, createdAt=$createdAt, updatedAt=$updatedAt, useThreads=$useThreads, name=$name, id=$id]';
