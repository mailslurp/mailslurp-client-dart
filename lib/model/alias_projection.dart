...
class AliasProjection {
  ...
  @override
  String toString() => 'AliasProjection[userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, useThreads=$useThreads, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, id=$id]';
