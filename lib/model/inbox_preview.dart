...
class InboxPreview {
  ...
  @override
  String toString() => 'InboxPreview[id=$id, domainId=$domainId, emailAddress=$emailAddress, createdAt=$createdAt, favourite=$favourite, name=$name, tags=$tags, teamAccess=$teamAccess, inboxType=$inboxType, virtualInbox=$virtualInbox, expiresAt=$expiresAt, functionsAs=$functionsAs]';
