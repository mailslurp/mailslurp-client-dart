...
class InboxPreview {
  ...
  @override
  String toString() => 'InboxPreview[id=$id, emailAddress=$emailAddress, createdAt=$createdAt, favourite=$favourite, name=$name, tags=$tags, teamAccess=$teamAccess, inboxType=$inboxType, virtualInbox=$virtualInbox, expiresAt=$expiresAt]';
