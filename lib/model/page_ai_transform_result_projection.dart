...
class PageAITransformResultProjection {
  ...
  @override
  String toString() => 'PageAITransformResultProjection[content=$content, pageable=$pageable, columns=$columns, totalPages=$totalPages, totalElements=$totalElements, last=$last, size=$size, number=$number, first=$first, numberOfElements=$numberOfElements, sort=$sort, empty=$empty]';
