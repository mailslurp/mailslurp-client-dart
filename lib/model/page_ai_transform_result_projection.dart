...
class PageAITransformResultProjection {
  ...
  @override
  String toString() => 'PageAITransformResultProjection[content=$content, pageable=$pageable, columns=$columns, totalElements=$totalElements, totalPages=$totalPages, last=$last, size=$size, number=$number, numberOfElements=$numberOfElements, sort=$sort, first=$first, empty=$empty]';
