...
class DomainNameRecordLabelEnum {
  ...
  static DomainNameRecordLabelEnum fromJson(dynamic value) =>
    DomainNameRecordLabelEnumTypeTransformer().decode(value);

  static List<DomainNameRecordLabelEnum> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <DomainNameRecordLabelEnum>[]
      : json
          .map((value) => DomainNameRecordLabelEnum.fromJson(value))
...
class DomainNameRecordLabelEnumTypeTransformer {
  ...
  factory DomainNameRecordLabelEnumTypeTransformer() => _instance ??= DomainNameRecordLabelEnumTypeTransformer._();
  ...
  DomainNameRecordLabelEnum decode(dynamic data, {bool allowNull}) {
    switch (data) {
