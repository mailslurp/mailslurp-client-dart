...
class DomainNameRecord {
  ...
  DomainNameRecord({
    ...
    required this.ttl,
    this.alternativeRecordEntries = const [],
  });
  ...
  List<String>? alternativeRecordEntries;
  ...
  bool operator ==(Object other) => identical(this, other) || other is DomainNameRecord &&
     ...
     other.ttl == ttl &&
     other.alternativeRecordEntries == alternativeRecordEntries;
  ...
  int get hashCode =>
    ...
    (ttl.hashCode) +
    (alternativeRecordEntries == null ? 0 : alternativeRecordEntries!.hashCode);

  @override
  String toString() => 'DomainNameRecord[label=$label, required_=$required_, recordType=$recordType, name=$name, recordEntries=$recordEntries, ttl=$ttl, alternativeRecordEntries=$alternativeRecordEntries]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.alternativeRecordEntries != null) {
      json[r'alternativeRecordEntries'] = this.alternativeRecordEntries;
    } else {
      json[r'alternativeRecordEntries'] = null;
    }
    return json;
  }
  ...
  static DomainNameRecord? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DomainNameRecord(
        ...
        alternativeRecordEntries: json[r'alternativeRecordEntries'] is List
            ? (json[r'alternativeRecordEntries'] as List).cast<String>()
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<DomainNameRecord>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DomainNameRecord.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
