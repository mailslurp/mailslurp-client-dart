...
class CreateContactOptions {
  ...
  bool operator ==(Object other) => identical(this, other) || other is CreateContactOptions &&
     ...
     other.verifyEmailAddresses == verifyEmailAddresses;
  ...
  int get hashCode =>
    ...
    (verifyEmailAddresses == null ? 0 : verifyEmailAddresses!.hashCode);

  @override
  String toString() => 'CreateContactOptions[firstName=$firstName, lastName=$lastName, company=$company, emailAddresses=$emailAddresses, tags=$tags, metaData=$metaData, optOut=$optOut, groupId=$groupId, verifyEmailAddresses=$verifyEmailAddresses]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.verifyEmailAddresses != null) {
      json[r'verifyEmailAddresses'] = this.verifyEmailAddresses;
    } else {
      json[r'verifyEmailAddresses'] = null;
    }
    return json;
  }
  ...
  static CreateContactOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateContactOptions(
        ...
        verifyEmailAddresses: mapValueOfType<bool>(json, r'verifyEmailAddresses'),
      );
    }
    return null;
  }
  ...
  static Map<String, List<CreateContactOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CreateContactOptions.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
