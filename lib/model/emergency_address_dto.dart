...
class EmergencyAddressDto {
  ...
  static Map<String, List<EmergencyAddressDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = EmergencyAddressDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class EmergencyAddressDtoPhoneCountryEnum {
  ...
  static const CA = EmergencyAddressDtoPhoneCountryEnum._(r'CA');
  static const EE = EmergencyAddressDtoPhoneCountryEnum._(r'EE');
  static const HK = EmergencyAddressDtoPhoneCountryEnum._(r'HK');
  static const PL = EmergencyAddressDtoPhoneCountryEnum._(r'PL');
  static const CH = EmergencyAddressDtoPhoneCountryEnum._(r'CH');
  static const PT = EmergencyAddressDtoPhoneCountryEnum._(r'PT');
  static const NL = EmergencyAddressDtoPhoneCountryEnum._(r'NL');
  static const IL = EmergencyAddressDtoPhoneCountryEnum._(r'IL');
  static const SE = EmergencyAddressDtoPhoneCountryEnum._(r'SE');
  ...
  EmergencyAddressDtoPhoneCountryEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'CA': return EmergencyAddressDtoPhoneCountryEnum.CA;
        case r'EE': return EmergencyAddressDtoPhoneCountryEnum.EE;
        case r'HK': return EmergencyAddressDtoPhoneCountryEnum.HK;
        case r'PL': return EmergencyAddressDtoPhoneCountryEnum.PL;
        case r'CH': return EmergencyAddressDtoPhoneCountryEnum.CH;
        case r'PT': return EmergencyAddressDtoPhoneCountryEnum.PT;
        case r'NL': return EmergencyAddressDtoPhoneCountryEnum.NL;
        case r'IL': return EmergencyAddressDtoPhoneCountryEnum.IL;
        case r'SE': return EmergencyAddressDtoPhoneCountryEnum.SE;
        default:
          if (!allowNull) {
