...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[userId=$userId, emailId=$emailId, inboxId=$inboxId, createdAt=$createdAt, sentId=$sentId, forwarderId=$forwarderId, message=$message, id=$id, status=$status]';
