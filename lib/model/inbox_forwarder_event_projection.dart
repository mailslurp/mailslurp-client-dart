...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[message=$message, id=$id, status=$status, userId=$userId, emailId=$emailId, inboxId=$inboxId, createdAt=$createdAt, sentId=$sentId, forwarderId=$forwarderId]';
