...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[emailId=$emailId, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, sentId=$sentId, forwarderId=$forwarderId, message=$message, id=$id, status=$status]';
