...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[message=$message, id=$id, userId=$userId, emailId=$emailId, inboxId=$inboxId, createdAt=$createdAt, sentId=$sentId, forwarderId=$forwarderId, status=$status]';
