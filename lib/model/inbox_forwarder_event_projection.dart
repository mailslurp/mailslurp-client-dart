...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[emailId=$emailId, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, forwarderId=$forwarderId, message=$message, id=$id, status=$status]';
