...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[createdAt=$createdAt, emailId=$emailId, inboxId=$inboxId, userId=$userId, forwarderId=$forwarderId, message=$message, id=$id, status=$status]';
