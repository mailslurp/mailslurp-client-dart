...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[emailId=$emailId, inboxId=$inboxId, userId=$userId, forwarderId=$forwarderId, createdAt=$createdAt, message=$message, id=$id, status=$status]';
