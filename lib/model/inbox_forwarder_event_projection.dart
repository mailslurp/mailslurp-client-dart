...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[createdAt=$createdAt, userId=$userId, emailId=$emailId, inboxId=$inboxId, forwarderId=$forwarderId, message=$message, id=$id, status=$status]';
