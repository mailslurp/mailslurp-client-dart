...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[message=$message, id=$id, status=$status, forwarderId=$forwarderId, emailId=$emailId, inboxId=$inboxId, userId=$userId, createdAt=$createdAt]';
