...
class InboxForwarderEventProjection {
  ...
  @override
  String toString() => 'InboxForwarderEventProjection[createdAt=$createdAt, userId=$userId, emailId=$emailId, inboxId=$inboxId, sentId=$sentId, forwarderId=$forwarderId, message=$message, id=$id, status=$status]';
