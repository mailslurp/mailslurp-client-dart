...
class InboxRulesetDtoActionEnum {
  ...
  static const BOUNCE_SOFT = InboxRulesetDtoActionEnum._(r'BOUNCE_SOFT');
  static const BOUNCE_HARD = InboxRulesetDtoActionEnum._(r'BOUNCE_HARD');
  ...
  InboxRulesetDtoActionEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'BOUNCE_SOFT': return InboxRulesetDtoActionEnum.BOUNCE_SOFT;
        case r'BOUNCE_HARD': return InboxRulesetDtoActionEnum.BOUNCE_HARD;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
