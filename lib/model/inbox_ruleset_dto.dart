...
class InboxRulesetDto {
  ...
  @override
  String toString() => 'InboxRulesetDto[action=$action, handler=$handler, id=$id, inboxId=$inboxId, scope=$scope, target=$target]';
...
class InboxRulesetDtoActionEnum {
  ...
  static const FORWARD = InboxRulesetDtoActionEnum._(r'FORWARD');
...
class InboxRulesetDtoActionEnumTypeTransformer {
  ...
  InboxRulesetDtoActionEnum decode(dynamic data, {bool allowNull}) {
    switch (data) {
      ...
      case r'FORWARD': return InboxRulesetDtoActionEnum.FORWARD;
      default:
        if (allowNull == false) {
