...
class ConnectorSyncEventProjection {
  ...
  @override
  String toString() => 'ConnectorSyncEventProjection[createdAt=$createdAt, connectorId=$connectorId, syncCount=$syncCount, syncStatus=$syncStatus, message=$message, id=$id]';
