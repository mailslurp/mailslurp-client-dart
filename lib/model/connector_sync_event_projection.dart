...
class ConnectorSyncEventProjection {
  ...
  @override
  String toString() => 'ConnectorSyncEventProjection[connectorId=$connectorId, syncCount=$syncCount, syncStatus=$syncStatus, createdAt=$createdAt, message=$message, id=$id]';
