...
class PageInboxReplierDto {
  ...
  @override
  String toString() => 'PageInboxReplierDto[content=$content, pageable=$pageable, totalPages=$totalPages, totalElements=$totalElements, last=$last, numberOfElements=$numberOfElements, first=$first, size=$size, number=$number, sort=$sort, empty=$empty]';
