...
class ExpirationDefaults {
  ...
  @override
  String toString() => 'ExpirationDefaults[canPermanentInbox=$canPermanentInbox, defaultExpirationMillis=$defaultExpirationMillis, defaultExpiresAt=$defaultExpiresAt, maxExpirationMillis=$maxExpirationMillis, nextInboxAllowsPermanent=$nextInboxAllowsPermanent]';
