...
class WebhookNewContactPayload {
  ...
  static Map<String, List<WebhookNewContactPayload>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = WebhookNewContactPayload.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
class WebhookNewContactPayloadEventNameEnum {
  ...
  static const NEW_AI_TRANSFORM_RESULT = WebhookNewContactPayloadEventNameEnum._(r'NEW_AI_TRANSFORM_RESULT');
  ...
  static const NEW_GUEST_USER = WebhookNewContactPayloadEventNameEnum._(r'NEW_GUEST_USER');
  ...
  WebhookNewContactPayloadEventNameEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'NEW_AI_TRANSFORM_RESULT': return WebhookNewContactPayloadEventNameEnum.NEW_AI_TRANSFORM_RESULT;
        ...
        case r'NEW_GUEST_USER': return WebhookNewContactPayloadEventNameEnum.NEW_GUEST_USER;
        default:
          if (!allowNull) {
