...
class WaitForConditions {
  ...
  @override
  String toString() => 'WaitForConditions[count=$count, countType=$countType, inboxId=$inboxId, matches=$matches, since=$since, sortDirection=$sortDirection, timeout=$timeout, unreadOnly=$unreadOnly]';
