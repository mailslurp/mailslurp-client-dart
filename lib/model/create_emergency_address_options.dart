...
class CreateEmergencyAddressOptionsIsoCountryCodeEnum {
  ...
  static const CA = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'CA');
  static const EE = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'EE');
  static const HK = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'HK');
  static const PL = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'PL');
  static const CH = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'CH');
  static const PT = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'PT');
  static const NL = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'NL');
  static const IL = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'IL');
  static const SE = CreateEmergencyAddressOptionsIsoCountryCodeEnum._(r'SE');
  ...
  CreateEmergencyAddressOptionsIsoCountryCodeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'CA': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.CA;
        case r'EE': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.EE;
        case r'HK': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.HK;
        case r'PL': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.PL;
        case r'CH': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.CH;
        case r'PT': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.PT;
        case r'NL': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.NL;
        case r'IL': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.IL;
        case r'SE': return CreateEmergencyAddressOptionsIsoCountryCodeEnum.SE;
        default:
          if (!allowNull) {
