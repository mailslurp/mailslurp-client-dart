...
class MissedEmail {
  ...
  @override
  String toString() => 'MissedEmail[attachmentCount=$attachmentCount, bcc=$bcc, bodyExcerpt=$bodyExcerpt, cc=$cc, createdAt=$createdAt, id=$id, inboxIds=$inboxIds, subject=$subject, to=$to, updatedAt=$updatedAt, userId=$userId]';
