...
class CreateInboxDto {
  ...
  @override
  String toString() => 'CreateInboxDto[emailAddress=$emailAddress, domainName=$domainName, domainId=$domainId, name=$name, description=$description, useDomainPool=$useDomainPool, tags=$tags, expiresAt=$expiresAt, favourite=$favourite, expiresIn=$expiresIn, allowTeamAccess=$allowTeamAccess, inboxType=$inboxType, virtualInbox=$virtualInbox, useShortAddress=$useShortAddress]';
