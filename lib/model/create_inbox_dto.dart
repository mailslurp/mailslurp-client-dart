...
class CreateInboxDto {
  ...
  @override
  String toString() {
    return 'CreateInboxDto[description=$description, emailAddress=$emailAddress, expiresAt=$expiresAt, favourite=$favourite, name=$name, tags=$tags, useDomainPool=$useDomainPool, ]';
  }
