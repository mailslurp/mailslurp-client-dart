...
class CreateInboxDto {
  ...
  @override
  String toString() => 'CreateInboxDto[emailAddress=$emailAddress, name=$name, description=$description, useDomainPool=$useDomainPool, tags=$tags, expiresAt=$expiresAt, favourite=$favourite, expiresIn=$expiresIn, allowTeamAccess=$allowTeamAccess, inboxType=$inboxType, virtualInbox=$virtualInbox, useShortAddress=$useShortAddress]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (useShortAddress != null) {
      json[r'useShortAddress'] = useShortAddress;
    }
    return json;
  }
  ...
  static CreateInboxDto fromJson(Map<String, dynamic> json) => json == null
    ...
    : CreateInboxDto(
        ...
        useShortAddress: json[r'useShortAddress'],
    );
