...
class InvokeTransformerOptions {
  ...
  int get hashCode =>
    ...
    (rawConditions == null ? 0 : rawConditions!.hashCode) +
    (rawInstructions == null ? 0 : rawInstructions!.hashCode) +
    (rawOutputSchema == null ? 0 : rawOutputSchema!.hashCode) +
    (contentSelector == null ? 0 : contentSelector!.hashCode) +
    (saveResults == null ? 0 : saveResults!.hashCode);

  @override
  String toString() => 'InvokeTransformerOptions[aiTransformId=$aiTransformId, aiTransformMappingId=$aiTransformMappingId, rawInput=$rawInput, entityId=$entityId, entityType=$entityType, rawConditions=$rawConditions, rawInstructions=$rawInstructions, rawOutputSchema=$rawOutputSchema, contentSelector=$contentSelector, saveResults=$saveResults]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.saveResults != null) {
      json[r'saveResults'] = this.saveResults;
    } else {
      json[r'saveResults'] = null;
    }
    return json;
  }
  ...
  static InvokeTransformerOptions? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return InvokeTransformerOptions(
        ...
        saveResults: mapValueOfType<bool>(json, r'saveResults'),
      );
    }
    return null;
  }
