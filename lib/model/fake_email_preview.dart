...
class FakeEmailPreview {
  ...
  @override
  String toString() => 'FakeEmailPreview[id=$id, emailAddress=$emailAddress, sender=$sender, recipients=$recipients, subject=$subject, preview=$preview, createdAt=$createdAt, seen=$seen]';
