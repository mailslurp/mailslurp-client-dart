...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, inboxId=$inboxId, userId=$userId, createdAt=$createdAt, updatedAt=$updatedAt, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId]';
