...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, userId=$userId, inboxId=$inboxId, to=$to, createdAt=$createdAt, bcc=$bcc, cc=$cc, updatedAt=$updatedAt, aliasId=$aliasId]';
