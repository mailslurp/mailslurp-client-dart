...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[subject=$subject, inboxId=$inboxId, userId=$userId, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, id=$id]';
