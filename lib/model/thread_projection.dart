...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId, createdAt=$createdAt, updatedAt=$updatedAt, subject=$subject, name=$name, id=$id]';
