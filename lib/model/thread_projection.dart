...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, createdAt=$createdAt, subject=$subject, userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, updatedAt=$updatedAt, aliasId=$aliasId]';
