...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, userId=$userId, inboxId=$inboxId, to=$to, updatedAt=$updatedAt, bcc=$bcc, cc=$cc, createdAt=$createdAt, aliasId=$aliasId]';
