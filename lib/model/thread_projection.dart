...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, inboxId=$inboxId, userId=$userId, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, updatedAt=$updatedAt, aliasId=$aliasId]';
