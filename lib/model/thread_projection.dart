...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, userId=$userId, inboxId=$inboxId, subject=$subject, to=$to, createdAt=$createdAt, updatedAt=$updatedAt, bcc=$bcc, cc=$cc, aliasId=$aliasId]';
