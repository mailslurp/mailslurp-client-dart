...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, createdAt=$createdAt, userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, updatedAt=$updatedAt, aliasId=$aliasId]';
