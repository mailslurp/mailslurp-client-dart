...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, inboxId=$inboxId, userId=$userId, to=$to, createdAt=$createdAt, bcc=$bcc, cc=$cc, updatedAt=$updatedAt, aliasId=$aliasId]';
