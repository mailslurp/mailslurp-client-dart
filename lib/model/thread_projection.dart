...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, inboxId=$inboxId, userId=$userId, to=$to, updatedAt=$updatedAt, createdAt=$createdAt, bcc=$bcc, cc=$cc, aliasId=$aliasId]';
