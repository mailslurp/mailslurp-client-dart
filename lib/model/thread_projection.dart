...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, userId=$userId, inboxId=$inboxId, to=$to, createdAt=$createdAt, updatedAt=$updatedAt, bcc=$bcc, cc=$cc, aliasId=$aliasId]';
