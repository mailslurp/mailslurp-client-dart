...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[createdAt=$createdAt, updatedAt=$updatedAt, userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId, subject=$subject, name=$name, id=$id]';
