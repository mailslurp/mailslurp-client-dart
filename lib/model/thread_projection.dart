...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, userId=$userId, subject=$subject, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, updatedAt=$updatedAt, aliasId=$aliasId]';
