...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, subject=$subject, userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, createdAt=$createdAt, updatedAt=$updatedAt, aliasId=$aliasId]';
