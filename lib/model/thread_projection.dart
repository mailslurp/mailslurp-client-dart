...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[inboxId=$inboxId, userId=$userId, createdAt=$createdAt, updatedAt=$updatedAt, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId, subject=$subject, name=$name, id=$id]';
