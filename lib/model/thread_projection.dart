...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[name=$name, id=$id, userId=$userId, subject=$subject, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId]';
