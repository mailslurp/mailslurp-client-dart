...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[inboxId=$inboxId, userId=$userId, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId, createdAt=$createdAt, updatedAt=$updatedAt, subject=$subject, name=$name, id=$id]';
