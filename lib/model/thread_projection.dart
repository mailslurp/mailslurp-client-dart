...
class ThreadProjection {
  ...
  @override
  String toString() => 'ThreadProjection[subject=$subject, userId=$userId, inboxId=$inboxId, to=$to, bcc=$bcc, cc=$cc, aliasId=$aliasId, createdAt=$createdAt, updatedAt=$updatedAt, name=$name, id=$id]';
