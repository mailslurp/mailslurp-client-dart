...
class CreateInboxRulesetOptions {
  ...
  @override
  String toString() => 'CreateInboxRulesetOptions[action=$action, scope=$scope, target=$target]';
...
class CreateInboxRulesetOptionsActionEnum {
  ...
  static const FORWARD = CreateInboxRulesetOptionsActionEnum._(r'FORWARD');
...
class CreateInboxRulesetOptionsActionEnumTypeTransformer {
  ...
  CreateInboxRulesetOptionsActionEnum decode(dynamic data, {bool allowNull}) {
    switch (data) {
      ...
      case r'FORWARD': return CreateInboxRulesetOptionsActionEnum.FORWARD;
      default:
        if (allowNull == false) {
