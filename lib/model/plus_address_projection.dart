...
class PlusAddressProjection {
  ...
  @override
  String toString() => 'PlusAddressProjection[id=$id, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, plusAddress=$plusAddress, fullAddress=$fullAddress]';
