...
class PlusAddressProjection {
  ...
  @override
  String toString() => 'PlusAddressProjection[updatedAt=$updatedAt, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, plusAddress=$plusAddress, fullAddress=$fullAddress, id=$id]';
