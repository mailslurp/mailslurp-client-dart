...
class PlusAddressProjection {
  ...
  @override
  String toString() => 'PlusAddressProjection[id=$id, userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, plusAddress=$plusAddress, fullAddress=$fullAddress]';
