...
class PlusAddressProjection {
  ...
  @override
  String toString() => 'PlusAddressProjection[userId=$userId, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, plusAddress=$plusAddress, fullAddress=$fullAddress, id=$id]';
