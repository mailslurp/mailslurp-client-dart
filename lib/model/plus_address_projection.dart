...
class PlusAddressProjection {
  ...
  @override
  String toString() => 'PlusAddressProjection[userId=$userId, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, plusAddress=$plusAddress, fullAddress=$fullAddress, id=$id]';
