...
class AITransformMappingDto {
  ...
  @override
  String toString() => 'AITransformMappingDto[id=$id, aiTransformId=$aiTransformId, matchOptions=$matchOptions, userId=$userId, name=$name, entityId=$entityId, entityType=$entityType, createdAt=$createdAt]';
