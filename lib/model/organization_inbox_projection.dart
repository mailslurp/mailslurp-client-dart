...
class OrganizationInboxProjection {
  ...
  @override
  String toString() => 'OrganizationInboxProjection[id=$id, createdAt=$createdAt, name=$name, emailAddress=$emailAddress, favourite=$favourite, tags=$tags, teamAccess=$teamAccess, inboxType=$inboxType, readOnly=$readOnly]';
