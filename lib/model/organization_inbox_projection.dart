...
class OrganizationInboxProjection {
  ...
  @override
  String toString() => 'OrganizationInboxProjection[id=$id, domainId=$domainId, createdAt=$createdAt, name=$name, emailAddress=$emailAddress, favourite=$favourite, tags=$tags, teamAccess=$teamAccess, inboxType=$inboxType, readOnly=$readOnly, virtualInbox=$virtualInbox, functionsAs=$functionsAs]';
