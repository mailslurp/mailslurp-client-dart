...
class BounceRecipientProjection {
  ...
  @override
  String toString() => 'BounceRecipientProjection[sentEmailId=$sentEmailId, createdAt=$createdAt, recipient=$recipient, bounceType=$bounceType, action=$action, id=$id, status=$status]';
