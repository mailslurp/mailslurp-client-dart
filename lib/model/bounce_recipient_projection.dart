...
class BounceRecipientProjection {
  ...
  @override
  String toString() => 'BounceRecipientProjection[id=$id, sentEmailId=$sentEmailId, createdAt=$createdAt, recipient=$recipient, bounceType=$bounceType, action=$action, status=$status]';
