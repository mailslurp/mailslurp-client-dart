...
class BounceRecipientProjection {
  ...
  @override
  String toString() => 'BounceRecipientProjection[createdAt=$createdAt, sentEmailId=$sentEmailId, recipient=$recipient, action=$action, bounceType=$bounceType, id=$id, status=$status]';
