...
class BounceRecipientProjection {
  ...
  @override
  String toString() => 'BounceRecipientProjection[id=$id, status=$status, sentEmailId=$sentEmailId, createdAt=$createdAt, recipient=$recipient, bounceType=$bounceType, action=$action]';
