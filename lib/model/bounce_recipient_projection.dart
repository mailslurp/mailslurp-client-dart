...
class BounceRecipientProjection {
  ...
  @override
  String toString() => 'BounceRecipientProjection[sentEmailId=$sentEmailId, recipient=$recipient, bounceType=$bounceType, action=$action, createdAt=$createdAt, id=$id, status=$status]';
