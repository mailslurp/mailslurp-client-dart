...
class BounceRecipientProjection {
  ...
  @override
  String toString() => 'BounceRecipientProjection[sentEmailId=$sentEmailId, createdAt=$createdAt, recipient=$recipient, action=$action, bounceType=$bounceType, id=$id, status=$status]';
