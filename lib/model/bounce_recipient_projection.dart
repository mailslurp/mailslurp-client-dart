...
class BounceRecipientProjection {
  ...
  @override
  String toString() => 'BounceRecipientProjection[sentEmailId=$sentEmailId, recipient=$recipient, action=$action, bounceType=$bounceType, createdAt=$createdAt, id=$id, status=$status]';
