...
class ImapSmtpAccessDetails {
  ...
  @override
  int get hashCode =>
    (secureSmtpServerHost == null ? 0 : secureSmtpServerHost.hashCode) +
    (secureSmtpServerPort == null ? 0 : secureSmtpServerPort.hashCode) +
    (secureSmtpUsername == null ? 0 : secureSmtpUsername.hashCode) +
    (secureSmtpPassword == null ? 0 : secureSmtpPassword.hashCode) +
  ...
  @override
  String toString() => 'ImapSmtpAccessDetails[secureSmtpServerHost=$secureSmtpServerHost, secureSmtpServerPort=$secureSmtpServerPort, secureSmtpUsername=$secureSmtpUsername, secureSmtpPassword=$secureSmtpPassword, smtpServerHost=$smtpServerHost, smtpServerPort=$smtpServerPort, smtpUsername=$smtpUsername, smtpPassword=$smtpPassword, imapServerHost=$imapServerHost, imapServerPort=$imapServerPort, imapUsername=$imapUsername, imapPassword=$imapPassword]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'secureSmtpServerHost'] = secureSmtpServerHost;
      json[r'secureSmtpServerPort'] = secureSmtpServerPort;
      json[r'secureSmtpUsername'] = secureSmtpUsername;
      json[r'secureSmtpPassword'] = secureSmtpPassword;
  ...
  static ImapSmtpAccessDetails fromJson(Map<String, dynamic> json) => json == null
    ? null
    : ImapSmtpAccessDetails(
        secureSmtpServerHost: json[r'secureSmtpServerHost'],
        secureSmtpServerPort: json[r'secureSmtpServerPort'],
        secureSmtpUsername: json[r'secureSmtpUsername'],
        secureSmtpPassword: json[r'secureSmtpPassword'],
