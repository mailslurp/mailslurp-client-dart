...
class GuestPortalUserProjection {
  ...
  @override
  String toString() => 'GuestPortalUserProjection[username=$username, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, portalId=$portalId, name=$name, id=$id]';
