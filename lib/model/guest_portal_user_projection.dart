...
class GuestPortalUserProjection {
  ...
  @override
  String toString() => 'GuestPortalUserProjection[name=$name, id=$id, username=$username, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, updatedAt=$updatedAt, createdAt=$createdAt, portalId=$portalId]';
