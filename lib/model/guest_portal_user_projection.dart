...
class GuestPortalUserProjection {
  ...
  @override
  String toString() => 'GuestPortalUserProjection[name=$name, id=$id, username=$username, emailAddress=$emailAddress, userId=$userId, inboxId=$inboxId, createdAt=$createdAt, updatedAt=$updatedAt, portalId=$portalId]';
