...
class GuestPortalUserProjection {
  ...
  @override
  String toString() => 'GuestPortalUserProjection[username=$username, updatedAt=$updatedAt, userId=$userId, emailAddress=$emailAddress, inboxId=$inboxId, createdAt=$createdAt, portalId=$portalId, name=$name, id=$id]';
