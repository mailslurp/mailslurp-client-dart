...
class SentEmailsControllerApi {
  ...
  ///
  /// * [String] deliveryId (required):
  Future<DeliveryStatus> getSentDeliveryStatus(String deliveryId) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DeliveryStatus',) as DeliveryStatus;
        }
    return Future<DeliveryStatus>.value(null);
  }
