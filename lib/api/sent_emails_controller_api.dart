...
class SentEmailsControllerApi {
  ...
  Future<Response> getAllSentTrackingPixelsWithHttpInfo({ int page, String searchFilter, int size, String sort }) async {
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageTrackingPixelProjection> getAllSentTrackingPixels({ int page, String searchFilter, int size, String sort }) async {
    final response = await getAllSentTrackingPixelsWithHttpInfo( page: page, searchFilter: searchFilter, size: size, sort: sort );
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getSentEmailTrackingPixelsWithHttpInfo(String id, { int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
    if (id == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: id');
    }
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageTrackingPixelProjection> getSentEmailTrackingPixels(String id, { int page, String searchFilter, int size, String sort }) async {
    final response = await getSentEmailTrackingPixelsWithHttpInfo(id,  page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
