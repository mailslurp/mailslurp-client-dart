...
class ExpiredControllerApi {
  ...
  /// Parameters:
  ///
  /// * [String] iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis (required):
  Future<Response> getExpiredInboxRecordWithHttpInfo(String iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis) async {
    // Verify required params are set.
    if (iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis');
    }

    final path = r'/expired/{expiredId}'
      .replaceAll('{' + 'ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId)' + '}', iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis.toString());
  ...
  ///
  /// * [String] iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis (required):
  Future<ExpiredInboxDto> getExpiredInboxRecord(String iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis) async {
    final response = await getExpiredInboxRecordWithHttpInfo(iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
