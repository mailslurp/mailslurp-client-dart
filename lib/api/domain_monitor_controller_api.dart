...
class DomainMonitorControllerApi {
  ...
  ///
  /// * [String] otherRunId (required):
  Future<Response> compareDomainMonitorRunsWithHttpInfo(String monitorId, String runId, String otherRunId,) async {
    // ignore: prefer_const_declarations
    final path = r'/domain-monitor/monitors/{monitorId}/runs/{runId}/compare/{otherRunId}'
      .replaceAll('{monitorId}', monitorId)
      .replaceAll('{runId}', runId)
      .replaceAll('{otherRunId}', otherRunId);
  ...
  ///
  /// * [String] otherRunId (required):
  Future<DomainMonitorRunComparisonDto?> compareDomainMonitorRuns(String monitorId, String runId, String otherRunId,) async {
    final response = await compareDomainMonitorRunsWithHttpInfo(monitorId, runId, otherRunId,);
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DomainMonitorRunComparisonDto',) as DomainMonitorRunComparisonDto;
  ...
  ///
  /// * [String] dkimSelector:
  Future<Response> getDomainMonitorAuthStackWithHttpInfo(String monitorId, { String? dkimSelector, }) async {
    // ignore: prefer_const_declarations
    final path = r'/domain-monitor/monitors/{monitorId}/auth-stack'
      .replaceAll('{monitorId}', monitorId);
    ...
    if (dkimSelector != null) {
      queryParams.addAll(_queryParams('', 'dkimSelector', dkimSelector));
    }
  ...
  ///
  /// * [String] dkimSelector:
  Future<CheckEmailAuthStackResults?> getDomainMonitorAuthStack(String monitorId, { String? dkimSelector, }) async {
    final response = await getDomainMonitorAuthStackWithHttpInfo(monitorId,  dkimSelector: dkimSelector, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] runId (required):
  Future<Response> getDomainMonitorRunWithHttpInfo(String monitorId, String runId,) async {
    // ignore: prefer_const_declarations
    final path = r'/domain-monitor/monitors/{monitorId}/runs/{runId}'
      .replaceAll('{monitorId}', monitorId)
      .replaceAll('{runId}', runId);
  ...
  ///
  /// * [String] runId (required):
  Future<DomainMonitorRunDto?> getDomainMonitorRun(String monitorId, String runId,) async {
    final response = await getDomainMonitorRunWithHttpInfo(monitorId, runId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DomainMonitorRunDto',) as DomainMonitorRunDto;
  ...
  ///
  /// * [String] dkimSelector:
  Future<Response> getDomainMonitorSummaryWithHttpInfo(String monitorId, { String? dkimSelector, }) async {
    // ignore: prefer_const_declarations
    final path = r'/domain-monitor/monitors/{monitorId}/summary'
      .replaceAll('{monitorId}', monitorId);
  ...
  ///
  /// * [String] dkimSelector:
  Future<DomainMonitorSummaryDto?> getDomainMonitorSummary(String monitorId, { String? dkimSelector, }) async {
    final response = await getDomainMonitorSummaryWithHttpInfo(monitorId,  dkimSelector: dkimSelector, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'DomainMonitorSummaryDto',) as DomainMonitorSummaryDto;
