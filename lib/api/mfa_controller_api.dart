...
class MFAControllerApi {
  ...
  /// Parameters:
  ///
  /// * [CreateTotpDeviceBase32SecretKeyOptions] createTotpDeviceBase32SecretKeyOptions (required):
  Future<Response> createTotpDeviceForBase32SecretKeyWithHttpInfo(CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/mfa/totp/device/base32SecretKey';

    // ignore: prefer_final_locals
    Object? postBody = createTotpDeviceBase32SecretKeyOptions;
  ...
  ///
  /// * [CreateTotpDeviceBase32SecretKeyOptions] createTotpDeviceBase32SecretKeyOptions (required):
  Future<TotpDeviceDto?> createTotpDeviceForBase32SecretKey(CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions,) async {
    final response = await createTotpDeviceForBase32SecretKeyWithHttpInfo(createTotpDeviceBase32SecretKeyOptions,);
  ...
  /// Parameters:
  ///
  /// * [CreateTotpDeviceCustomOptions] createTotpDeviceCustomOptions (required):
  Future<Response> createTotpDeviceForCustomWithHttpInfo(CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/mfa/totp/device/custom';

    // ignore: prefer_final_locals
    Object? postBody = createTotpDeviceCustomOptions;
  ...
  ///
  /// * [CreateTotpDeviceCustomOptions] createTotpDeviceCustomOptions (required):
  Future<TotpDeviceDto?> createTotpDeviceForCustom(CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions,) async {
    final response = await createTotpDeviceForCustomWithHttpInfo(createTotpDeviceCustomOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
