...
class CampaignProbeControllerApi {
  ...
  Future<Response> compareCampaignProbeRunsWithHttpInfo(String probeId, String runId, String otherRunId,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaign-probe/probes/{probeId}/runs/{runId}/compare/{otherRunId}'
  ...
  ///
  /// * [String] otherRunId (required):
  Future<CampaignProbeRunComparisonDto?> compareCampaignProbeRuns(String probeId, String runId, String otherRunId,) async {
    final response = await compareCampaignProbeRunsWithHttpInfo(probeId, runId, otherRunId,);
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CampaignProbeRunComparisonDto',) as CampaignProbeRunComparisonDto;
  ...
  ///
  /// * [String] runId (required):
  Future<Response> getCampaignProbeRunWithHttpInfo(String probeId, String runId,) async {
    // ignore: prefer_const_declarations
    final path = r'/campaign-probe/probes/{probeId}/runs/{runId}'
      .replaceAll('{probeId}', probeId)
      .replaceAll('{runId}', runId);
  ...
  ///
  /// * [String] runId (required):
  Future<CampaignProbeRunDto?> getCampaignProbeRun(String probeId, String runId,) async {
    final response = await getCampaignProbeRunWithHttpInfo(probeId, runId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CampaignProbeRunDto',) as CampaignProbeRunDto;
