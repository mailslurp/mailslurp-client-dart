...
class ToolsControllerApi {
  ...
  /// Parameters:
  ///
  /// * [AnalyzeDmarcReportOptions] analyzeDmarcReportOptions (required):
  Future<Response> analyzeDmarcReportWithHttpInfo(AnalyzeDmarcReportOptions analyzeDmarcReportOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/analyze-dmarc-report';

    // ignore: prefer_final_locals
    Object? postBody = analyzeDmarcReportOptions;
  ...
  ///
  /// * [AnalyzeDmarcReportOptions] analyzeDmarcReportOptions (required):
  Future<AnalyzeDmarcReportResults?> analyzeDmarcReport(AnalyzeDmarcReportOptions analyzeDmarcReportOptions,) async {
    final response = await analyzeDmarcReportWithHttpInfo(analyzeDmarcReportOptions,);
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AnalyzeDmarcReportResults',) as AnalyzeDmarcReportResults;
  ...
  /// Parameters:
  ///
  /// * [AnalyzeEmailHeadersOptions] analyzeEmailHeadersOptions (required):
  Future<Response> analyzeEmailHeadersWithHttpInfo(AnalyzeEmailHeadersOptions analyzeEmailHeadersOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/analyze-email-headers';

    // ignore: prefer_final_locals
    Object? postBody = analyzeEmailHeadersOptions;
  ...
  ///
  /// * [AnalyzeEmailHeadersOptions] analyzeEmailHeadersOptions (required):
  Future<AnalyzeEmailHeadersResults?> analyzeEmailHeaders(AnalyzeEmailHeadersOptions analyzeEmailHeadersOptions,) async {
    final response = await analyzeEmailHeadersWithHttpInfo(analyzeEmailHeadersOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AnalyzeEmailHeadersResults',) as AnalyzeEmailHeadersResults;
  ...
  /// Parameters:
  ///
  /// * [CheckCampaignProbeOptions] checkCampaignProbeOptions (required):
  Future<Response> checkCampaignProbeWithHttpInfo(CheckCampaignProbeOptions checkCampaignProbeOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/check-campaign-probe';

    // ignore: prefer_final_locals
    Object? postBody = checkCampaignProbeOptions;
  ...
  ///
  /// * [CheckCampaignProbeOptions] checkCampaignProbeOptions (required):
  Future<CheckCampaignProbeResults?> checkCampaignProbe(CheckCampaignProbeOptions checkCampaignProbeOptions,) async {
    final response = await checkCampaignProbeWithHttpInfo(checkCampaignProbeOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CheckCampaignProbeResults',) as CheckCampaignProbeResults;
  ...
  /// Parameters:
  ///
  /// * [CheckDnsPropagationOptions] checkDnsPropagationOptions (required):
  Future<Response> checkDnsPropagationWithHttpInfo(CheckDnsPropagationOptions checkDnsPropagationOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/check-dns-propagation';

    // ignore: prefer_final_locals
    Object? postBody = checkDnsPropagationOptions;
  ...
  ///
  /// * [CheckDnsPropagationOptions] checkDnsPropagationOptions (required):
  Future<CheckDnsPropagationResults?> checkDnsPropagation(CheckDnsPropagationOptions checkDnsPropagationOptions,) async {
    final response = await checkDnsPropagationWithHttpInfo(checkDnsPropagationOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CheckDnsPropagationResults',) as CheckDnsPropagationResults;
  ...
  /// Parameters:
  ///
  /// * [CheckDomainMonitorOptions] checkDomainMonitorOptions (required):
  Future<Response> checkDomainMonitorWithHttpInfo(CheckDomainMonitorOptions checkDomainMonitorOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/check-domain-monitor';

    // ignore: prefer_final_locals
    Object? postBody = checkDomainMonitorOptions;
  ...
  ///
  /// * [CheckDomainMonitorOptions] checkDomainMonitorOptions (required):
  Future<CheckDomainMonitorResults?> checkDomainMonitor(CheckDomainMonitorOptions checkDomainMonitorOptions,) async {
    final response = await checkDomainMonitorWithHttpInfo(checkDomainMonitorOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CheckDomainMonitorResults',) as CheckDomainMonitorResults;
  ...
  /// Parameters:
  ///
  /// * [CheckEmailAuditOptions] checkEmailAuditOptions (required):
  Future<Response> checkEmailAuditWithHttpInfo(CheckEmailAuditOptions checkEmailAuditOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/check-email-audit';

    // ignore: prefer_final_locals
    Object? postBody = checkEmailAuditOptions;
  ...
  ///
  /// * [CheckEmailAuditOptions] checkEmailAuditOptions (required):
  Future<EmailAuditAnalysisResult?> checkEmailAudit(CheckEmailAuditOptions checkEmailAuditOptions,) async {
    final response = await checkEmailAuditWithHttpInfo(checkEmailAuditOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'EmailAuditAnalysisResult',) as EmailAuditAnalysisResult;
  ...
  /// Parameters:
  ///
  /// * [CheckEmailAuthStackOptions] checkEmailAuthStackOptions (required):
  Future<Response> checkEmailAuthStackWithHttpInfo(CheckEmailAuthStackOptions checkEmailAuthStackOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/check-email-auth-stack';

    // ignore: prefer_final_locals
    Object? postBody = checkEmailAuthStackOptions;
  ...
  ///
  /// * [CheckEmailAuthStackOptions] checkEmailAuthStackOptions (required):
  Future<CheckEmailAuthStackResults?> checkEmailAuthStack(CheckEmailAuthStackOptions checkEmailAuthStackOptions,) async {
    final response = await checkEmailAuthStackWithHttpInfo(checkEmailAuthStackOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CheckEmailAuthStackResults',) as CheckEmailAuthStackResults;
  ...
  /// Parameters:
  ///
  /// * [CheckEmailBlacklistOptions] checkEmailBlacklistOptions (required):
  Future<Response> checkEmailBlacklistWithHttpInfo(CheckEmailBlacklistOptions checkEmailBlacklistOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/check-email-blacklists';

    // ignore: prefer_final_locals
    Object? postBody = checkEmailBlacklistOptions;
  ...
  ///
  /// * [CheckEmailBlacklistOptions] checkEmailBlacklistOptions (required):
  Future<CheckEmailBlacklistResults?> checkEmailBlacklist(CheckEmailBlacklistOptions checkEmailBlacklistOptions,) async {
    final response = await checkEmailBlacklistWithHttpInfo(checkEmailBlacklistOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'CheckEmailBlacklistResults',) as CheckEmailBlacklistResults;
  ...
  /// Parameters:
  ///
  /// * [GenerateSpfRecordOptions] generateSpfRecordOptions (required):
  Future<Response> generateSpfRecordWithHttpInfo(GenerateSpfRecordOptions generateSpfRecordOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/generate-spf-record';

    // ignore: prefer_final_locals
    Object? postBody = generateSpfRecordOptions;
  ...
  ///
  /// * [GenerateSpfRecordOptions] generateSpfRecordOptions (required):
  Future<GenerateSpfRecordResults?> generateSpfRecord(GenerateSpfRecordOptions generateSpfRecordOptions,) async {
    final response = await generateSpfRecordWithHttpInfo(generateSpfRecordOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'GenerateSpfRecordResults',) as GenerateSpfRecordResults;
  ...
  /// Parameters:
  ///
  /// * [LookupDkimDomainOptions] lookupDkimDomainOptions (required):
  Future<Response> lookupDkimDomainWithHttpInfo(LookupDkimDomainOptions lookupDkimDomainOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/lookup-dkim-domain';

    // ignore: prefer_final_locals
    Object? postBody = lookupDkimDomainOptions;
  ...
  ///
  /// * [LookupDkimDomainOptions] lookupDkimDomainOptions (required):
  Future<LookupDkimDomainResults?> lookupDkimDomain(LookupDkimDomainOptions lookupDkimDomainOptions,) async {
    final response = await lookupDkimDomainWithHttpInfo(lookupDkimDomainOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'LookupDkimDomainResults',) as LookupDkimDomainResults;
  ...
  /// Parameters:
  ///
  /// * [LookupPtrOptions] lookupPtrOptions (required):
  Future<Response> lookupPtrWithHttpInfo(LookupPtrOptions lookupPtrOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/lookup-ptr';

    // ignore: prefer_final_locals
    Object? postBody = lookupPtrOptions;
  ...
  ///
  /// * [LookupPtrOptions] lookupPtrOptions (required):
  Future<LookupPtrResults?> lookupPtr(LookupPtrOptions lookupPtrOptions,) async {
    final response = await lookupPtrWithHttpInfo(lookupPtrOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'LookupPtrResults',) as LookupPtrResults;
  ...
  /// Parameters:
  ///
  /// * [LookupSpfDomainOptions] lookupSpfDomainOptions (required):
  Future<Response> lookupSpfDomainWithHttpInfo(LookupSpfDomainOptions lookupSpfDomainOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/lookup-spf-domain';

    // ignore: prefer_final_locals
    Object? postBody = lookupSpfDomainOptions;
  ...
  ///
  /// * [LookupSpfDomainOptions] lookupSpfDomainOptions (required):
  Future<LookupSpfDomainResults?> lookupSpfDomain(LookupSpfDomainOptions lookupSpfDomainOptions,) async {
    final response = await lookupSpfDomainWithHttpInfo(lookupSpfDomainOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'LookupSpfDomainResults',) as LookupSpfDomainResults;
  ...
  /// Parameters:
  ///
  /// * [TestSmtpServerOptions] testSmtpServerOptions (required):
  Future<Response> testSmtpServerWithHttpInfo(TestSmtpServerOptions testSmtpServerOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/tools/test-smtp-server';

    // ignore: prefer_final_locals
    Object? postBody = testSmtpServerOptions;
  ...
  ///
  /// * [TestSmtpServerOptions] testSmtpServerOptions (required):
  Future<TestSmtpServerResults?> testSmtpServer(TestSmtpServerOptions testSmtpServerOptions,) async {
    final response = await testSmtpServerWithHttpInfo(testSmtpServerOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'TestSmtpServerResults',) as TestSmtpServerResults;
