...
class MissedEmailControllerApi {
  ...
  Future<Response> getAllMissedEmailsWithHttpInfo({ int page, int size, String sort }) async {
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageMissedEmailProjection> getAllMissedEmails({ int page, int size, String sort }) async {
    final response = await getAllMissedEmailsWithHttpInfo( page: page, size: size, sort: sort );
