...
class InboxControllerApi {
  ...
  Future<Response> cancelScheduledJobWithHttpInfo(String jobId) async {
    ...
    if (jobId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: jobId');
    }
  ...
  Future<ScheduledJobDto> cancelScheduledJob(String jobId) async {
    ...
    return Future<ScheduledJobDto>.value(null);
  }
  ...
  Future<Response> createInboxWithHttpInfo({ String emailAddress, List<String> tags, String name, String description, bool useDomainPool, bool favourite, DateTime expiresAt, int expiresIn, bool allowTeamAccess, String inboxType, bool virtualInbox, bool useShortAddress, String domainId, String domainName }) async {
    // Verify required params are set.
    ...
    if (useShortAddress != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'useShortAddress', useShortAddress));
    }
    if (domainId != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'domainId', domainId));
    }
    if (domainName != null) {
  ...
  Future<Response> doesInboxExistWithHttpInfo(String emailAddress, { bool allowCatchAll }) async {
    ...
    if (allowCatchAll != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'allowCatchAll', allowCatchAll));
    }
  ...
  Future<PageScheduledJobs> getAllScheduledJobs({ int page, int size, String sort, DateTime since, DateTime before }) async {
    ...
    return Future<PageScheduledJobs>.value(null);
  }
  ...
  Future<InboxByNameResult> getInboxByName(String name) async {
    ...
    return Future<InboxByNameResult>.value(null);
  }
  ...
  Future<Response> getInboxesWithHttpInfo({ int size, String sort, DateTime since, bool excludeCatchAllInboxes, DateTime before }) async {
    ...
    if (excludeCatchAllInboxes != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'excludeCatchAllInboxes', excludeCatchAllInboxes));
    }
    if (before != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'before', before));
    }
  ...
  Future<Response> sendEmailWithQueueWithHttpInfo(String inboxId, bool validateBeforeEnqueue, SendEmailOptions sendEmailOptions) async {
    ...
    if (validateBeforeEnqueue == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: validateBeforeEnqueue');
    }
    if (sendEmailOptions == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: sendEmailOptions');
    }
    ...
    final formParams = <String, String>{};
      ...
      queryParams.addAll(_convertParametersForCollectionFormat('', 'validateBeforeEnqueue', validateBeforeEnqueue));
  ...
  Future<Response> sendWithScheduleWithHttpInfo(String inboxId, SendEmailOptions sendEmailOptions, { DateTime sendAtTimestamp, int sendAtNowPlusSeconds, bool validateBeforeEnqueue }) async {
    ...
    if (sendAtTimestamp != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'sendAtTimestamp', sendAtTimestamp));
    }
    if (sendAtNowPlusSeconds != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'sendAtNowPlusSeconds', sendAtNowPlusSeconds));
    }
    if (validateBeforeEnqueue != null) {
      queryParams.addAll(_convertParametersForCollectionFormat('', 'validateBeforeEnqueue', validateBeforeEnqueue));
    }
