...
class InboxControllerApi {
  ...
  /// * [bool] unreadOnly:
  ///   unreadOnly
  Future<Response> getEmailsWithHttpInfo(String inboxId, { int delayTimeout, int limit, int minCount, int retryTimeout, DateTime since, int size, String sort, bool unreadOnly }) async {
    // Verify required params are set.
    if (inboxId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: inboxId');
    }
  ...
  /// * [bool] unreadOnly:
  ///   unreadOnly
  Future<List<EmailPreview>> getEmails(String inboxId, { int delayTimeout, int limit, int minCount, int retryTimeout, DateTime since, int size, String sort, bool unreadOnly }) async {
    final response = await getEmailsWithHttpInfo(inboxId,  delayTimeout: delayTimeout, limit: limit, minCount: minCount, retryTimeout: retryTimeout, since: since, size: size, sort: sort, unreadOnly: unreadOnly );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getInboxSentEmailsWithHttpInfo(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
    if (inboxId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: inboxId');
    }
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageSentEmailProjection> getInboxSentEmails(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    final response = await getInboxSentEmailsWithHttpInfo(inboxId,  page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getOrganizationInboxesWithHttpInfo({ int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageOrganizationInboxProjection> getOrganizationInboxes({ int page, String searchFilter, int size, String sort }) async {
    final response = await getOrganizationInboxesWithHttpInfo( page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> listInboxRulesetsWithHttpInfo(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
    if (inboxId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: inboxId');
    }
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageInboxRulesetDto> listInboxRulesets(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    final response = await listInboxRulesetsWithHttpInfo(inboxId,  page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> listInboxTrackingPixelsWithHttpInfo(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
    if (inboxId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: inboxId');
    }
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageTrackingPixelProjection> listInboxTrackingPixels(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    final response = await listInboxTrackingPixelsWithHttpInfo(inboxId,  page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
