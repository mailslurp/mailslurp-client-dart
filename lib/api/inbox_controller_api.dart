...
class InboxControllerApi {
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> listInboxRulesetsWithHttpInfo(String inboxId, { int page, int size, String sort }) async {
    // Verify required params are set.
    if (inboxId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: inboxId');
    }
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<void> listInboxRulesets(String inboxId, { int page, int size, String sort }) async {
    final response = await listInboxRulesetsWithHttpInfo(inboxId,  page: page, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
