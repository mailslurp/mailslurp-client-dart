...
class InboxControllerApi {
  ...
  Future<Response> createInboxWithHttpInfo({ String description, String emailAddress, DateTime expiresAt, bool favourite, String name, List<String> tags, bool useDomainPool }) async {
    Object postBody;
  ...
  ///
  /// Create a new inbox and with a randomized email address to send and receive from. Pass emailAddress parameter if you wish to use a specific email address. Creating an inbox is required before sending or receiving emails. If writing tests it is recommended that you create a new inbox during each test method so that it is unique and empty. 
  Future<Inbox> createInbox({ String description, String emailAddress, DateTime expiresAt, bool favourite, String name, List<String> tags, bool useDomainPool }) async {
    Response response = await createInboxWithHttpInfo( description: description, emailAddress: emailAddress, expiresAt: expiresAt, favourite: favourite, name: name, tags: tags, useDomainPool: useDomainPool );
  ...
  Future<Response> getAllInboxesWithHttpInfo({ bool favourite, int page, String search, int size, String sort, String tag }) async {
    Object postBody;
  ...
  Future<PageInboxProjection> getAllInboxes({ bool favourite, int page, String search, int size, String sort, String tag }) async {
    Response response = await getAllInboxesWithHttpInfo( favourite: favourite, page: page, search: search, size: size, sort: sort, tag: tag );
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
  ...
  Future<Response> getExpiredInboxRecordByIdWithHttpInfo(String expiredId) async {
    Object postBody;
    ...
    // create path and map variables
    String path = "/inboxes/expired-records/{expiredId}".replaceAll("{format}","json").replaceAll("{" + "expiredId" + "}", expiredId.toString());
  ...
  Future<ExpiredInboxDto> getExpiredInboxRecordById(String expiredId) async {
    Response response = await getExpiredInboxRecordByIdWithHttpInfo(expiredId);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
  ...
  Future<Response> getExpiredInboxRecordByInboxIdWithHttpInfo(String inboxId) async {
    Object postBody;
    ...
    // create path and map variables
    String path = "/inboxes/{inboxId}/expired-record".replaceAll("{format}","json").replaceAll("{" + "inboxId" + "}", inboxId.toString());
  ...
  Future<ExpiredInboxDto> getExpiredInboxRecordByInboxId(String inboxId) async {
    Response response = await getExpiredInboxRecordByInboxIdWithHttpInfo(inboxId);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'ExpiredInboxDto') as ExpiredInboxDto;
  ...
  Future<Response> getExpiredInboxRecordsWithHttpInfo({ int page, int size, String sort }) async {
    Object postBody;

    // verify required params are set

    // create path and map variables
    String path = "/inboxes/expired-records".replaceAll("{format}","json");
  ...
  Future<PageExpiredInboxRecordProjection> getExpiredInboxRecords({ int page, int size, String sort }) async {
    Response response = await getExpiredInboxRecordsWithHttpInfo( page: page, size: size, sort: sort );
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
