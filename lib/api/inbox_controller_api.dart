...
class InboxControllerApi {
  ...
  Future<Response> createInboxRulesetWithHttpInfo(String inboxId, CreateRulesetOptions createRulesetOptions,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [CreateRulesetOptions] createRulesetOptions (required):
  Future<RulesetDto?> createInboxRuleset(String inboxId, CreateRulesetOptions createRulesetOptions,) async {
    final response = await createInboxRulesetWithHttpInfo(inboxId, createRulesetOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sender:
  ///   Sender
  Future<Response> doesInboxExistWithHttpInfo(String emailAddress, { bool? allowCatchAll, String? ipAddress, String? sender, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] sender:
  ///   Sender
  Future<InboxExistsDto?> doesInboxExist(String emailAddress, { bool? allowCatchAll, String? ipAddress, String? sender, }) async {
    final response = await doesInboxExistWithHttpInfo(emailAddress,  allowCatchAll: allowCatchAll, ipAddress: ipAddress, sender: sender, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// Note: This method returns the HTTP [Response].
  Future<Response> doesInboxHaveAutomationsWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/automations';
  ...
  ///
  /// Check if an inbox has automations.
  Future<void> doesInboxHaveAutomations() async {
    final response = await doesInboxHaveAutomationsWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
  ...
  Future<Response> getAllPlusAddressesWithHttpInfo({ int? page, int? size, String? sort, String? inboxId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/plus-addresses';
  ...
  /// * [String] inboxId:
  ///   Optional inboxId filter
  Future<PagePlusAddressProjection?> getAllPlusAddresses({ int? page, int? size, String? sort, String? inboxId, }) async {
    final response = await getAllPlusAddressesWithHttpInfo( page: page, size: size, sort: sort, inboxId: inboxId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PagePlusAddressProjection',) as PagePlusAddressProjection;
  ...
  ///
  /// * [String] inboxId:
  Future<Response> getAllScheduledJobsWithHttpInfo({ int? page, int? size, String? sort, DateTime? since, DateTime? before, String? inboxId, }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [String] inboxId:
  Future<PageScheduledJobs?> getAllScheduledJobs({ int? page, int? size, String? sort, DateTime? since, DateTime? before, String? inboxId, }) async {
    final response = await getAllScheduledJobsWithHttpInfo( page: page, size: size, sort: sort, since: since, before: before, inboxId: inboxId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> getInboxEmailsPaginatedWithHttpInfo(String inboxId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, bool? syncConnectors, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] syncConnectors:
  ///   Sync connectors before fetching emails
  Future<PageEmailPreview?> getInboxEmailsPaginated(String inboxId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, bool? syncConnectors, }) async {
    final response = await getInboxEmailsPaginatedWithHttpInfo(inboxId,  page: page, size: size, sort: sort, since: since, before: before, syncConnectors: syncConnectors, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Parameters:
  ///
  /// * [String] plusAddressId (required):
  ///   ID of the plus address you want to fetch
  ///
  /// * [String] inboxId (required):
  ///   ID of the inbox you want to fetch
  Future<Response> getInboxPlusAddressWithHttpInfo(String plusAddressId, String inboxId,) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/plus-addresses/{plusAddressId}'
      .replaceAll('{plusAddressId}', plusAddressId)
      .replaceAll('{inboxId}', inboxId);
  ...
  /// * [String] inboxId (required):
  ///   ID of the inbox you want to fetch
  Future<PlusAddressDto?> getInboxPlusAddress(String plusAddressId, String inboxId,) async {
    final response = await getInboxPlusAddressWithHttpInfo(plusAddressId, inboxId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PlusAddressDto',) as PlusAddressDto;
  ...
  Future<Response> getInboxPlusAddressByIdWithHttpInfo(String plusAddressId, { String? inboxId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/plus-addresses/{plusAddressId}'
      .replaceAll('{plusAddressId}', plusAddressId);
  ...
  /// * [String] inboxId:
  ///   ID of the inbox you want to filter for
  Future<PlusAddressDto?> getInboxPlusAddressById(String plusAddressId, { String? inboxId, }) async {
    final response = await getInboxPlusAddressByIdWithHttpInfo(plusAddressId,  inboxId: inboxId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [DateTime] before:
  ///   Optional filter by created before given date time
  Future<Response> getInboxPlusAddressEmailsWithHttpInfo(String plusAddress, String inboxId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/plus-addresses/emails'
      .replaceAll('{inboxId}', inboxId);
    ...
    final formParams = <String, String>{};
      ...
      queryParams.addAll(_queryParams('', 'plusAddress', plusAddress));
    if (page != null) {
      queryParams.addAll(_queryParams('', 'page', page));
    }
    if (size != null) {
  ...
  /// * [DateTime] before:
  ///   Optional filter by created before given date time
  Future<PageEmailPreview?> getInboxPlusAddressEmails(String plusAddress, String inboxId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, }) async {
    final response = await getInboxPlusAddressEmailsWithHttpInfo(plusAddress, inboxId,  page: page, size: size, sort: sort, since: since, before: before, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [DateTime] before:
  ///   Optional filter by created before given date time
  Future<Response> getInboxPlusAddressEmailsForPlusAddressIdWithHttpInfo(String plusAddressId, String inboxId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/plus-addresses/{plusAddressId}/emails'
      .replaceAll('{plusAddressId}', plusAddressId)
      .replaceAll('{inboxId}', inboxId);
  ...
  /// * [DateTime] before:
  ///   Optional filter by created before given date time
  Future<PageEmailPreview?> getInboxPlusAddressEmailsForPlusAddressId(String plusAddressId, String inboxId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, }) async {
    final response = await getInboxPlusAddressEmailsForPlusAddressIdWithHttpInfo(plusAddressId, inboxId,  page: page, size: size, sort: sort, since: since, before: before, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getInboxPlusAddressesWithHttpInfo(String inboxId, { int? page, int? size, String? sort, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/plus-addresses'
      .replaceAll('{inboxId}', inboxId);
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PagePlusAddressProjection?> getInboxPlusAddresses(String inboxId, { int? page, int? size, String? sort, }) async {
    final response = await getInboxPlusAddressesWithHttpInfo(inboxId,  page: page, size: size, sort: sort, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> getInboxSentCountWithHttpInfo(String inboxId,) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/sent/count'
      .replaceAll('{inboxId}', inboxId);
  ...
  /// * [String] inboxId (required):
  ///   Id of inbox that emails were sent from
  Future<CountDto?> getInboxSentCount(String inboxId,) async {
    final response = await getInboxSentCountWithHttpInfo(inboxId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> getInboxTagsWithHttpInfo({ int? page, int? size, String? sort, String? searchFilter, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] searchFilter:
  ///   Optional search filter
  Future<List<String>?> getInboxTags({ int? page, int? size, String? sort, String? searchFilter, }) async {
    final response = await getInboxTagsWithHttpInfo( page: page, size: size, sort: sort, searchFilter: searchFilter, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] searchFilter:
  ///   Optional search filter
  Future<Response> getInboxTagsPaginatedWithHttpInfo({ int? page, int? size, String? sort, String? searchFilter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/tags/paginated';
  ...
  /// * [String] searchFilter:
  ///   Optional search filter
  Future<PageInboxTags?> getInboxTagsPaginated({ int? page, int? size, String? sort, String? searchFilter, }) async {
    final response = await getInboxTagsPaginatedWithHttpInfo( page: page, size: size, sort: sort, searchFilter: searchFilter, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PageInboxTags',) as PageInboxTags;
  ...
  Future<Response> getInboxesWithHttpInfo({ int? size, String? sort, DateTime? since, bool? excludeCatchAllInboxes, DateTime? before, List<String>? include, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes';
  ...
  /// * [List<String>] include:
  ///   Optional inboxIds to include in result
  Future<List<InboxDto>?> getInboxes({ int? size, String? sort, DateTime? since, bool? excludeCatchAllInboxes, DateTime? before, List<String>? include, }) async {
    final response = await getInboxesWithHttpInfo( size: size, sort: sort, since: since, excludeCatchAllInboxes: excludeCatchAllInboxes, before: before, include: include, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] searchFilter:
  ///   Optional search filter
  Future<Response> getInboxesByTagWithHttpInfo(String tag, { int? page, int? size, String? sort, String? searchFilter, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/tags/inboxes';
  ...
  /// * [String] searchFilter:
  ///   Optional search filter
  Future<PageInboxProjection?> getInboxesByTag(String tag, { int? page, int? size, String? sort, String? searchFilter, }) async {
    final response = await getInboxesByTagWithHttpInfo(tag,  page: page, size: size, sort: sort, searchFilter: searchFilter, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] inboxId (required):
  ///   ID of the inbox you want to target
  ///
  /// * [String] fullAddress (required):
  ///   Full recipient address including +suffix. Example: `inbox+alias@domain.com`
  Future<Response> getOrCreateInboxPlusAddressWithHttpInfo(String inboxId, String fullAddress,) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/plus-addresses/get-or-create'
      .replaceAll('{inboxId}', inboxId);
  ...
  /// * [String] fullAddress (required):
  ///   Full recipient address including +suffix. Example: `inbox+alias@domain.com`
  Future<PlusAddressDto?> getOrCreateInboxPlusAddress(String inboxId, String fullAddress,) async {
    final response = await getOrCreateInboxPlusAddressWithHttpInfo(inboxId, fullAddress,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] fullAddress (required):
  ///   Full recipient address including +suffix. Example: `inbox+alias@domain.com`
  Future<Response> getOrCreatePlusAddressByFullAddressWithHttpInfo(String fullAddress,) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/get-or-create-plus-address';
  ...
  /// * [String] fullAddress (required):
  ///   Full recipient address including +suffix. Example: `inbox+alias@domain.com`
  Future<PlusAddressDto?> getOrCreatePlusAddressByFullAddress(String fullAddress,) async {
    final response = await getOrCreatePlusAddressByFullAddressWithHttpInfo(fullAddress,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getOutboxesWithHttpInfo({ int? page, int? size, String? sort, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/outboxes';
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageInboxProjection?> getOutboxes({ int? page, int? size, String? sort, }) async {
    final response = await getOutboxesWithHttpInfo( page: page, size: size, sort: sort, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] inboxId (required):
  ///
  /// * [ImportEmailOptions] importEmailOptions (required):
  Future<Response> importEmailIntoInboxWithHttpInfo(String inboxId, ImportEmailOptions importEmailOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/emails/import'
      .replaceAll('{inboxId}', inboxId);

    // ignore: prefer_final_locals
    Object? postBody = importEmailOptions;
  ...
  ///
  /// * [ImportEmailOptions] importEmailOptions (required):
  Future<Email?> importEmailIntoInbox(String inboxId, ImportEmailOptions importEmailOptions,) async {
    final response = await importEmailIntoInboxWithHttpInfo(inboxId, importEmailOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<Response> importEmailIntoInboxBytesWithHttpInfo(String inboxId, String body, { String? externalId, bool? runPipeline, bool? overrideMessageId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/emails/import/raw'
      .replaceAll('{inboxId}', inboxId);
    ...
    if (runPipeline != null) {
      queryParams.addAll(_queryParams('', 'runPipeline', runPipeline));
    }
    if (overrideMessageId != null) {
      queryParams.addAll(_queryParams('', 'overrideMessageId', overrideMessageId));
    }

    const contentTypes = <String>['application/octet-stream', 'message/rfc822'];
  ...
  ///
  /// * [bool] overrideMessageId:
  Future<Email?> importEmailIntoInboxBytes(String inboxId, String body, { String? externalId, bool? runPipeline, bool? overrideMessageId, }) async {
    final response = await importEmailIntoInboxBytesWithHttpInfo(inboxId, body,  externalId: externalId, runPipeline: runPipeline, overrideMessageId: overrideMessageId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [bool] overrideMessageId:
  Future<Response> importEmailIntoInboxMultipartWithHttpInfo(String inboxId, MultipartFile file, { String? externalId, bool? runPipeline, bool? overrideMessageId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/inboxes/{inboxId}/emails/import/multipart'
      .replaceAll('{inboxId}', inboxId);
  ...
  ///
  /// * [bool] overrideMessageId:
  Future<Email?> importEmailIntoInboxMultipart(String inboxId, MultipartFile file, { String? externalId, bool? runPipeline, bool? overrideMessageId, }) async {
    final response = await importEmailIntoInboxMultipartWithHttpInfo(inboxId, file,  externalId: externalId, runPipeline: runPipeline, overrideMessageId: overrideMessageId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [DateTime] before:
  ///   Optional filter by created before given date time
  Future<PageRulesetDto?> listInboxRulesets(String inboxId, { int? page, int? size, String? sort, String? searchFilter, DateTime? since, DateTime? before, }) async {
