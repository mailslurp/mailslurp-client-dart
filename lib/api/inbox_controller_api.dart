...
class InboxControllerApi {
  ...
  Future<Response> createInboxWithHttpInfo({ String description, String emailAddress, DateTime expiresAt, int expiresIn, bool favourite, String name, List<String> tags, bool useDomainPool }) async {
    Object postBody;
  ...
  Future<Inbox> createInbox({ String description, String emailAddress, DateTime expiresAt, int expiresIn, bool favourite, String name, List<String> tags, bool useDomainPool }) async {
    Response response = await createInboxWithHttpInfo( description: description, emailAddress: emailAddress, expiresAt: expiresAt, expiresIn: expiresIn, favourite: favourite, name: name, tags: tags, useDomainPool: useDomainPool );
