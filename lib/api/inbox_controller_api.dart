...
class InboxControllerApi {
  ...
  Future<Response> createInboxWithHttpInfo({ String description, String emailAddress, DateTime expiresAt, bool favourite, String name, List<String> tags }) async {
    Object postBody;
  ...
  Future<Inbox> createInbox({ String description, String emailAddress, DateTime expiresAt, bool favourite, String name, List<String> tags }) async {
    Response response = await createInboxWithHttpInfo( description: description, emailAddress: emailAddress, expiresAt: expiresAt, favourite: favourite, name: name, tags: tags );
  ...
  /// List Inboxes Paginated with HTTP info returned
  ///
  ...
  /// Get emails in an Inbox with HTTP info returned
  ///
  /// List emails that an inbox has received. Only emails that are sent to the inbox&#39;s email address will appear in the inbox. It may take several seconds for any email you send to an inbox&#39;s email address to appear in the inbox. To make this endpoint wait for a minimum number of emails use the &#x60;minCount&#x60; parameter. The server will retry the inbox database until the &#x60;minCount&#x60; is satisfied or the &#x60;retryTimeout&#x60; is reached
  Future<Response> getEmailsWithHttpInfo(String inboxId, { int limit, int minCount, int retryTimeout, DateTime since, String sort }) async {
    Object postBody;
  ...
  Future<List<EmailPreview>> getEmails(String inboxId, { int limit, int minCount, int retryTimeout, DateTime since, String sort }) async {
    Response response = await getEmailsWithHttpInfo(inboxId,  limit: limit, minCount: minCount, retryTimeout: retryTimeout, since: since, sort: sort );
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
  ...
  Future<Response> getInboxesWithHttpInfo() async {
    Object postBody;
  ...
  Future<List<Inbox>> getInboxes() async {
    Response response = await getInboxesWithHttpInfo();
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
  ...
  Future<SentEmail> sendEmailAndConfirm(String inboxId, { SendEmailOptions sendEmailOptions }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(_decodeBodyBytes(response), 'SentEmail') as SentEmail;
    } else {
      return null;
    }
  }
