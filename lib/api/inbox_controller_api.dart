...
class InboxControllerApi {
  ...
  /// * [CreateInboxRulesetOptions] createInboxRulesetOptions (required):
  ///   createInboxRulesetOptions
  Future<void> createInboxRuleset(String inboxId, CreateInboxRulesetOptions createInboxRulesetOptions) async {
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<void> listInboxRulesets(String inboxId, { int page, String searchFilter, int size, String sort }) async {
