...
class WebhookControllerApi {
  ...
  Future<Response> getAllWebhooksWithHttpInfo({ int? page, int? size, String? sort, String? searchFilter, DateTime? since, String? inboxId, String? aiTransformerId, String? phoneId, DateTime? before, String? health, String? eventType, String? url, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] url:
  ///   Optional url endpoint filter
  Future<PageWebhookProjection?> getAllWebhooks({ int? page, int? size, String? sort, String? searchFilter, DateTime? since, String? inboxId, String? aiTransformerId, String? phoneId, DateTime? before, String? health, String? eventType, String? url, }) async {
    final response = await getAllWebhooksWithHttpInfo( page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, inboxId: inboxId, aiTransformerId: aiTransformerId, phoneId: phoneId, before: before, health: health, eventType: eventType, url: url, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
