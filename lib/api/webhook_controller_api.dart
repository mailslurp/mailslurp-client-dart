...
class WebhookControllerApi {
  ...
  Future<Response> getAllWebhookResultsWithHttpInfo({ DateTime before, int page, String searchFilter, DateTime since, int size, String sort, bool unseenOnly }) async {
    // Verify required params are set.
  ...
  /// * [bool] unseenOnly:
  ///   Filter for unseen exceptions only
  Future<PageWebhookResult> getAllWebhookResults({ DateTime before, int page, String searchFilter, DateTime since, int size, String sort, bool unseenOnly }) async {
    final response = await getAllWebhookResultsWithHttpInfo( before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort, unseenOnly: unseenOnly );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getAllWebhooksWithHttpInfo({ DateTime before, int page, String searchFilter, DateTime since, int size, String sort }) async {
    // Verify required params are set.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageWebhookProjection> getAllWebhooks({ DateTime before, int page, String searchFilter, DateTime since, int size, String sort }) async {
    final response = await getAllWebhooksWithHttpInfo( before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getInboxWebhooksPaginatedWithHttpInfo(String inboxId, { DateTime before, int page, String searchFilter, DateTime since, int size, String sort }) async {
    // Verify required params are set.
    if (inboxId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: inboxId');
    }
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageWebhookProjection> getInboxWebhooksPaginated(String inboxId, { DateTime before, int page, String searchFilter, DateTime since, int size, String sort }) async {
    final response = await getInboxWebhooksPaginatedWithHttpInfo(inboxId,  before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [bool] unseenOnly:
  ///   Filter for unseen exceptions only
  Future<Response> getWebhookResultsWithHttpInfo(String webhookId, { DateTime before, int page, String searchFilter, DateTime since, int size, String sort, bool unseenOnly }) async {
    // Verify required params are set.
    if (webhookId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: webhookId');
    }
  ...
  /// * [bool] unseenOnly:
  ///   Filter for unseen exceptions only
  Future<PageWebhookResult> getWebhookResults(String webhookId, { DateTime before, int page, String searchFilter, DateTime since, int size, String sort, bool unseenOnly }) async {
    final response = await getWebhookResultsWithHttpInfo(webhookId,  before: before, page: page, searchFilter: searchFilter, since: since, size: size, sort: sort, unseenOnly: unseenOnly );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
