...
class WebhookControllerApi {
  ...
  /// Parameters:
  ///
  /// * [String] transformerId (required):
  ///
  /// * [CreateWebhookOptions] createWebhookOptions (required):
  Future<Response> createWebhookForAITransformerWithHttpInfo(String transformerId, CreateWebhookOptions createWebhookOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/ai-transformers/{transformerId}/webhooks'
      .replaceAll('{transformerId}', transformerId);
  ...
  ///
  /// * [CreateWebhookOptions] createWebhookOptions (required):
  Future<WebhookDto?> createWebhookForAITransformer(String transformerId, CreateWebhookOptions createWebhookOptions,) async {
    final response = await createWebhookForAITransformerWithHttpInfo(transformerId, createWebhookOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///   Phone ID
  ///
  /// * [String] aiTransformerId:
  ///   AI Transformer ID
  Future<Response> getAllWebhookResultsWithHttpInfo({ int? page, int? size, String? sort, String? searchFilter, DateTime? since, DateTime? before, bool? unseenOnly, String? resultType, String? eventName, int? minStatusCode, int? maxStatusCode, String? inboxId, String? smsId, String? attachmentId, String? emailId, String? phoneId, String? aiTransformerId, }) async {
    // ignore: prefer_const_declarations
    ...
    if (aiTransformerId != null) {
      queryParams.addAll(_queryParams('', 'aiTransformerId', aiTransformerId));
    }
  ...
  /// * [String] aiTransformerId:
  ///   AI Transformer ID
  Future<PageWebhookResult?> getAllWebhookResults({ int? page, int? size, String? sort, String? searchFilter, DateTime? since, DateTime? before, bool? unseenOnly, String? resultType, String? eventName, int? minStatusCode, int? maxStatusCode, String? inboxId, String? smsId, String? attachmentId, String? emailId, String? phoneId, String? aiTransformerId, }) async {
  ...
  ///   Webhook source type category such as phone, inbox, aiTranformer
  ///
  /// * [bool] includeAccountWide:
  ///   Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters
  Future<Response> getAllWebhooksWithHttpInfo({ int? page, int? size, String? sort, String? searchFilter, DateTime? since, String? inboxId, String? aiTransformerId, String? phoneId, DateTime? before, String? health, String? eventType, String? url, String? eventTypeSource, bool? includeAccountWide, }) async {
    // ignore: prefer_const_declarations
    ...
    if (eventTypeSource != null) {
      queryParams.addAll(_queryParams('', 'eventTypeSource', eventTypeSource));
    }
    if (includeAccountWide != null) {
      queryParams.addAll(_queryParams('', 'includeAccountWide', includeAccountWide));
    }
  ...
  /// * [bool] includeAccountWide:
  ///   Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters
  Future<PageWebhookProjection?> getAllWebhooks({ int? page, int? size, String? sort, String? searchFilter, DateTime? since, String? inboxId, String? aiTransformerId, String? phoneId, DateTime? before, String? health, String? eventType, String? url, String? eventTypeSource, bool? includeAccountWide, }) async {
    final response = await getAllWebhooksWithHttpInfo( page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, inboxId: inboxId, aiTransformerId: aiTransformerId, phoneId: phoneId, before: before, health: health, eventType: eventType, url: url, eventTypeSource: eventTypeSource, includeAccountWide: includeAccountWide, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [bool] includeAccountWide:
  ///   Include account scope inbox webhooks
  Future<Response> getInboxWebhooksPaginatedWithHttpInfo(String inboxId, { int? page, int? size, String? sort, String? searchFilter, DateTime? since, DateTime? before, String? health, String? eventType, bool? includeAccountWide, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] includeAccountWide:
  ///   Include account scope inbox webhooks
  Future<PageWebhookProjection?> getInboxWebhooksPaginated(String inboxId, { int? page, int? size, String? sort, String? searchFilter, DateTime? since, DateTime? before, String? health, String? eventType, bool? includeAccountWide, }) async {
    final response = await getInboxWebhooksPaginatedWithHttpInfo(inboxId,  page: page, size: size, sort: sort, searchFilter: searchFilter, since: since, before: before, health: health, eventType: eventType, includeAccountWide: includeAccountWide, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [bool] includeAccountWide:
  ///   Include account scope phone webhooks
  Future<Response> getPhoneNumberWebhooksPaginatedWithHttpInfo(String phoneId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, String? eventType, String? searchFilter, String? health, bool? includeAccountWide, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] includeAccountWide:
  ///   Include account scope phone webhooks
  Future<PageWebhookProjection?> getPhoneNumberWebhooksPaginated(String phoneId, { int? page, int? size, String? sort, DateTime? since, DateTime? before, String? eventType, String? searchFilter, String? health, bool? includeAccountWide, }) async {
    final response = await getPhoneNumberWebhooksPaginatedWithHttpInfo(phoneId,  page: page, size: size, sort: sort, since: since, before: before, eventType: eventType, searchFilter: searchFilter, health: health, includeAccountWide: includeAccountWide, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [bool] overrideAuth:
  Future<Response> updateWebhookWithHttpInfo(String webhookId, CreateWebhookOptions createWebhookOptions, { String? inboxId, String? aiTransformerId, String? phoneNumberId, bool? overrideAuth, }) async {
    // ignore: prefer_const_declarations
    final path = r'/webhooks/{webhookId}'
      .replaceAll('{webhookId}', webhookId);
  ...
  ///
  /// * [bool] overrideAuth:
  Future<WebhookDto?> updateWebhook(String webhookId, CreateWebhookOptions createWebhookOptions, { String? inboxId, String? aiTransformerId, String? phoneNumberId, bool? overrideAuth, }) async {
    final response = await updateWebhookWithHttpInfo(webhookId, createWebhookOptions,  inboxId: inboxId, aiTransformerId: aiTransformerId, phoneNumberId: phoneNumberId, overrideAuth: overrideAuth, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
