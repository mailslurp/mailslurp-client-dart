...
class WebhookControllerApi {
  ...
  Future<Response> getAllWebhookResultsWithHttpInfo({ int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
  ...
  Future<PageWebhookResult> getAllWebhookResults({ int page, String searchFilter, int size, String sort }) async {
    final response = await getAllWebhookResultsWithHttpInfo( page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getAllWebhooksWithHttpInfo({ int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
  ...
  Future<PageWebhookProjection> getAllWebhooks({ int page, String searchFilter, int size, String sort }) async {
    final response = await getAllWebhooksWithHttpInfo( page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getInboxWebhooksPaginatedWithHttpInfo(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
    if (inboxId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: inboxId');
    }
  ...
  Future<PageWebhookProjection> getInboxWebhooksPaginated(String inboxId, { int page, String searchFilter, int size, String sort }) async {
    final response = await getInboxWebhooksPaginatedWithHttpInfo(inboxId,  page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  Future<WebhookResultEntity> getWebhookResult(String webhookResultId) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body != null && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'WebhookResultEntity',) as WebhookResultEntity;
        }
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getWebhookResultsWithHttpInfo(String webhookId, { int page, String searchFilter, int size, String sort }) async {
    // Verify required params are set.
    if (webhookId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: webhookId');
    }
  ...
  Future<PageWebhookResult> getWebhookResults(String webhookId, { int page, String searchFilter, int size, String sort }) async {
    final response = await getWebhookResultsWithHttpInfo(webhookId,  page: page, searchFilter: searchFilter, size: size, sort: sort );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
