...
class AttachmentControllerApi {
  ...
  Future<Response> extractAttachmentTextWithHttpInfo(String attachmentId, { ExtractAttachmentTextOptions? extractAttachmentTextOptions, }) async {
    // ignore: prefer_const_declarations
    final path = r'/attachments/{attachmentId}/text'
      .replaceAll('{attachmentId}', attachmentId);

    // ignore: prefer_final_locals
    Object? postBody = extractAttachmentTextOptions;
  ...
  ///
  /// * [ExtractAttachmentTextOptions] extractAttachmentTextOptions:
  Future<ExtractAttachmentTextResult?> extractAttachmentText(String attachmentId, { ExtractAttachmentTextOptions? extractAttachmentTextOptions, }) async {
    final response = await extractAttachmentTextWithHttpInfo(attachmentId,  extractAttachmentTextOptions: extractAttachmentTextOptions, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ExtractAttachmentTextResult',) as ExtractAttachmentTextResult;
  ...
  /// * [String] attachmentId (required):
  ///   ID of attachment
  Future<AttachmentEntityDto?> getAttachment(String attachmentId,) async {
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AttachmentEntityDto',) as AttachmentEntityDto;
  ...
  Future<Response> getAttachmentsWithHttpInfo({ int? page, int? size, String? sort, String? fileNameFilter, DateTime? since, DateTime? before, String? inboxId, String? emailId, String? sentEmailId, List<String>? include, }) async {
    // ignore: prefer_const_declarations
    final path = r'/attachments';
    ...
    if (sentEmailId != null) {
      queryParams.addAll(_queryParams('', 'sentEmailId', sentEmailId));
    }
    if (include != null) {
  ...
  /// * [List<String>] include:
  ///   Optional list of IDs to include in result
  Future<PageAttachmentEntity?> getAttachments({ int? page, int? size, String? sort, String? fileNameFilter, DateTime? since, DateTime? before, String? inboxId, String? emailId, String? sentEmailId, List<String>? include, }) async {
    final response = await getAttachmentsWithHttpInfo( page: page, size: size, sort: sort, fileNameFilter: fileNameFilter, since: since, before: before, inboxId: inboxId, emailId: emailId, sentEmailId: sentEmailId, include: include, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] filename2:
  Future<Response> uploadAttachmentBytesWithHttpInfo({ String? contentType, String? contentType2, String? contentId, String? filename, int? fileSize, String? filename2, }) async {
    // ignore: prefer_const_declarations
    ...
    if (contentType2 != null) {
      queryParams.addAll(_queryParams('', 'contentType', contentType2));
    }
    if (contentId != null) {
    ...
    if (fileSize != null) {
      queryParams.addAll(_queryParams('', 'fileSize', fileSize));
    }
    ...
    if (filename2 != null) {
      headerParams[r'filename'] = parameterToString(filename2);
    }
  ...
  ///
  /// * [String] filename2:
  Future<List<String>?> uploadAttachmentBytes({ String? contentType, String? contentType2, String? contentId, String? filename, int? fileSize, String? filename2, }) async {
    final response = await uploadAttachmentBytesWithHttpInfo( contentType: contentType, contentType2: contentType2, contentId: contentId, filename: filename, fileSize: fileSize, filename2: filename2, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [ImportEmailIntoInboxMultipartRequest] importEmailIntoInboxMultipartRequest:
  Future<Response> uploadMultipartFormWithHttpInfo({ String? contentId, String? contentType, String? filename, String? contentTypeHeader, String? xFilename, String? xFilenameRaw, int? xFilesize, ImportEmailIntoInboxMultipartRequest? importEmailIntoInboxMultipartRequest, }) async {
    // ignore: prefer_const_declarations
    final path = r'/attachments/multipart';

    // ignore: prefer_final_locals
    Object? postBody = importEmailIntoInboxMultipartRequest;
    ...
    if (contentTypeHeader != null) {
      queryParams.addAll(_queryParams('', 'contentTypeHeader', contentTypeHeader));
    }
    if (xFilename != null) {
      queryParams.addAll(_queryParams('', 'x-filename', xFilename));
    }
    if (xFilenameRaw != null) {
      queryParams.addAll(_queryParams('', 'x-filename-raw', xFilenameRaw));
    }
    if (xFilesize != null) {
      queryParams.addAll(_queryParams('', 'x-filesize', xFilesize));
    }
  ...
  ///
  /// * [ImportEmailIntoInboxMultipartRequest] importEmailIntoInboxMultipartRequest:
  Future<List<String>?> uploadMultipartForm({ String? contentId, String? contentType, String? filename, String? contentTypeHeader, String? xFilename, String? xFilenameRaw, int? xFilesize, ImportEmailIntoInboxMultipartRequest? importEmailIntoInboxMultipartRequest, }) async {
    final response = await uploadMultipartFormWithHttpInfo( contentId: contentId, contentType: contentType, filename: filename, contentTypeHeader: contentTypeHeader, xFilename: xFilename, xFilenameRaw: xFilenameRaw, xFilesize: xFilesize, importEmailIntoInboxMultipartRequest: importEmailIntoInboxMultipartRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
