...
class AttachmentControllerApi {
  ...
  Future<Response> uploadMultipartFormWithHttpInfo({ String? contentId, String? contentType, String? filename, String? contentTypeHeader, String? xFilename, String? xFilenameRaw, int? xFilesize, UploadMultipartFormRequest? uploadMultipartFormRequest, }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [UploadMultipartFormRequest] uploadMultipartFormRequest:
  Future<List<String>?> uploadMultipartForm({ String? contentId, String? contentType, String? filename, String? contentTypeHeader, String? xFilename, String? xFilenameRaw, int? xFilesize, UploadMultipartFormRequest? uploadMultipartFormRequest, }) async {
    final response = await uploadMultipartFormWithHttpInfo( contentId: contentId, contentType: contentType, filename: filename, contentTypeHeader: contentTypeHeader, xFilename: xFilename, xFilenameRaw: xFilenameRaw, xFilesize: xFilesize, uploadMultipartFormRequest: uploadMultipartFormRequest, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
