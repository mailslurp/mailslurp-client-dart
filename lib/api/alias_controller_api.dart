...
class AliasControllerApi {
  ...
  Future<Response> replyToEmailWithHttpInfo(String aliasId, String emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions) async {
  ...
  ///
  /// Send the reply to the email sender or reply-to and include same subject cc bcc etc. Reply to an email and the contents will be sent with the existing subject to the emails &#x60;to&#x60;, &#x60;cc&#x60;, and &#x60;bcc&#x60;.
  Future<SentEmailDto> replyToEmail(String aliasId, String emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions) async {
    Response response = await replyToEmailWithHttpInfo(aliasId, emailId, replyToAliasEmailOptions);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
