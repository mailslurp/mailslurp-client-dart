...
class EmailControllerApi {
  ...
  Future<Response> replyToEmail1WithHttpInfo(String emailId, ReplyToEmailOptions replyToEmailOptions) async {
  ...
  ///
  /// Send the reply to the email sender or reply-to and include same subject cc bcc etc. Reply to an email and the contents will be sent with the existing subject to the emails &#x60;to&#x60;, &#x60;cc&#x60;, and &#x60;bcc&#x60;.
  Future<SentEmailDto> replyToEmail1(String emailId, ReplyToEmailOptions replyToEmailOptions) async {
    Response response = await replyToEmail1WithHttpInfo(emailId, replyToEmailOptions);
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
