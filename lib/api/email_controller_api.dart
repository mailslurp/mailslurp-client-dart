...
class EmailControllerApi {
  ...
  ///
  /// * [String] emailId (required):
  Future<Response> checkEmailAudit1WithHttpInfo(String emailId,) async {
    // ignore: prefer_const_declarations
    final path = r'/emails/{emailId}/check-email-audit'
      .replaceAll('{emailId}', emailId);
  ...
  ///
  /// * [String] emailId (required):
  Future<EmailAuditAnalysisResult?> checkEmailAudit1(String emailId,) async {
    final response = await checkEmailAudit1WithHttpInfo(emailId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [String] emailId (required):
  Future<Response> createEmailAuditForEmailWithHttpInfo(String emailId,) async {
    // ignore: prefer_const_declarations
    final path = r'/emails/{emailId}/audit'
      .replaceAll('{emailId}', emailId);
  ...
  ///
  /// * [String] emailId (required):
  Future<EmailAuditDto?> createEmailAuditForEmail(String emailId,) async {
    final response = await createEmailAuditForEmailWithHttpInfo(emailId,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
