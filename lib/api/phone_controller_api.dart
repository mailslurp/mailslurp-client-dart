...
class PhoneControllerApi {
  ...
  Future<Response> getPhoneNumbersWithHttpInfo({ String? phoneCountry, String? lineType, String? carrierName, String? mobileCountryCode, String? mobileNetworkCode, String? providerLabel, int? page, int? size, String? sort, DateTime? since, DateTime? before, String? search, List<String>? include, bool? favourite, }) async {
    // ignore: prefer_const_declarations
    final path = r'/phone/numbers';
