...
class PhoneControllerApi {
  ...
  Future<Response> testPhoneNumberSendSmsWithHttpInfo(String phoneNumberId, TestPhoneNumberOptions testPhoneNumberOptions) async {
    // Verify required params are set.
    if (phoneNumberId == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: phoneNumberId');
    }
    if (testPhoneNumberOptions == null) {
     throw ApiException(HttpStatus.badRequest, 'Missing required param: testPhoneNumberOptions');
    }
  ...
  ///
  /// * [TestPhoneNumberOptions] testPhoneNumberOptions (required):
  Future<void> testPhoneNumberSendSms(String phoneNumberId, TestPhoneNumberOptions testPhoneNumberOptions) async {
    final response = await testPhoneNumberSendSmsWithHttpInfo(phoneNumberId, testPhoneNumberOptions);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
