...
class ApiUserControllerApi {
  ...
  /// Performs an HTTP 'GET /user/smtp/password' operation and returns the [Response].
  Future<Response> getSmtpPasswordWithHttpInfo() async {
    final path = r'/user/smtp/password';
  ...
  Future<String> getSmtpPassword() async {
    final response = await getSmtpPasswordWithHttpInfo();
  ...
  /// Performs an HTTP 'GET /user/smtp/username' operation and returns the [Response].
  Future<Response> getSmtpUsernameWithHttpInfo() async {
    final path = r'/user/smtp/username';
  ...
  Future<String> getSmtpUsername() async {
    final response = await getSmtpUsernameWithHttpInfo();
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
