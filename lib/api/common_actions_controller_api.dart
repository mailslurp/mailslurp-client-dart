...
class CommonActionsControllerApi {
  ...
  Future<Response> createNewEmailAddressWithHttpInfo() async {
    Object postBody;
  ...
  ///
  /// Returns an Inbox with an &#x60;id&#x60; and an &#x60;emailAddress&#x60;
  Future<Inbox> createNewEmailAddress() async {
    Response response = await createNewEmailAddressWithHttpInfo();
  ...
  ///
  /// Returns an Inbox with an &#x60;id&#x60; and an &#x60;emailAddress&#x60;
  Future<Response> createNewEmailAddress1WithHttpInfo() async {
    Object postBody;
  ...
  ///
  /// Returns an Inbox with an &#x60;id&#x60; and an &#x60;emailAddress&#x60;
  Future<Inbox> createNewEmailAddress1() async {
    Response response = await createNewEmailAddress1WithHttpInfo();
    if(response.statusCode >= 400) {
      throw ApiException(response.statusCode, _decodeBodyBytes(response));
    } else if(response.body != null) {
      return apiClient.deserialize(_decodeBodyBytes(response), 'Inbox') as Inbox;
