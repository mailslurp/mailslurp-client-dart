...
class CommonActionsControllerApi {
  ...
  ///
  /// * [bool] favourite:
  Future<Response> createNewEmailAddressWithHttpInfo({ bool allowTeamAccess, bool useDomainPool, DateTime expiresAt, int expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, bool favourite }) async {
  ...
  ///
  /// * [bool] favourite:
  Future<InboxDto> createNewEmailAddress({ bool allowTeamAccess, bool useDomainPool, DateTime expiresAt, int expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, bool favourite }) async {
  ...
  ///
  /// * [bool] favourite:
  Future<Response> createRandomInboxWithHttpInfo({ bool allowTeamAccess, bool useDomainPool, DateTime expiresAt, int expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, bool favourite }) async {
    // Verify required params are set.
  ...
  ///
  /// * [bool] favourite:
  Future<InboxDto> createRandomInbox({ bool allowTeamAccess, bool useDomainPool, DateTime expiresAt, int expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, bool favourite }) async {
    final response = await createRandomInboxWithHttpInfo( allowTeamAccess: allowTeamAccess, useDomainPool: useDomainPool, expiresAt: expiresAt, expiresIn: expiresIn, emailAddress: emailAddress, inboxType: inboxType, description: description, name: name, tags: tags, favourite: favourite );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
