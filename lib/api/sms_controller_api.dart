...
class SmsControllerApi {
  ...
  Future<Response> getAllSmsMessagesWithHttpInfo({ String? phoneNumber, int? page, int? size, String? sort, DateTime? since, DateTime? before, String? search, bool? favourite, }) async {
    // ignore: prefer_const_declarations
    final path = r'/sms';
  ...
  Future<PageSmsProjection?> getAllSmsMessages({ String? phoneNumber, int? page, int? size, String? sort, DateTime? since, DateTime? before, String? search, bool? favourite, }) async {
    final response = await getAllSmsMessagesWithHttpInfo( phoneNumber: phoneNumber, page: page, size: size, sort: sort, since: since, before: before, search: search, favourite: favourite, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
