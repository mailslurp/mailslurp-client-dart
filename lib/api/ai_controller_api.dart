...
class AIControllerApi {
  ...
  /// Parameters:
  ///
  /// * [ExportTransformerOptions] exportTransformerOptions (required):
  Future<Response> exportTransformerResultsWithHttpInfo(ExportTransformerOptions exportTransformerOptions,) async {
    // ignore: prefer_const_declarations
    final path = r'/ai/transformer/results/export';

    // ignore: prefer_final_locals
    Object? postBody = exportTransformerOptions;
  ...
  ///
  /// * [ExportTransformerOptions] exportTransformerOptions (required):
  Future<ExportTransformerResponse?> exportTransformerResults(ExportTransformerOptions exportTransformerOptions,) async {
    final response = await exportTransformerResultsWithHttpInfo(exportTransformerOptions,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ExportTransformerResponse',) as ExportTransformerResponse;
  ...
  ///
  /// * [String] id (required):
  Future<Response> getExportTransformerResultsJobWithHttpInfo(String id,) async {
    // ignore: prefer_const_declarations
    final path = r'/ai/transformer/results/export/{id}'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<ExportTransformerResultJobDto?> getExportTransformerResultsJob(String id,) async {
    final response = await getExportTransformerResultsJobWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'ExportTransformerResultJobDto',) as ExportTransformerResultJobDto;
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getTransformerResultsWithHttpInfo({ String? emailId, String? smsId, String? attachmentId, String? aiTransformId, String? aiTransformMappingId, String? entityId, String? entityType, int? page, int? size, String? sort, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageAITransformResultProjection?> getTransformerResults({ String? emailId, String? smsId, String? attachmentId, String? aiTransformId, String? aiTransformMappingId, String? entityId, String? entityType, int? page, int? size, String? sort, }) async {
    final response = await getTransformerResultsWithHttpInfo( emailId: emailId, smsId: smsId, attachmentId: attachmentId, aiTransformId: aiTransformId, aiTransformMappingId: aiTransformMappingId, entityId: entityId, entityType: entityType, page: page, size: size, sort: sort, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  /// Parameters:
  ///
  /// * [bool] includeMetaData (required):
  ///
  /// * [bool] flattenArraysToRows (required):
  ///
  /// * [String] emailId:
  ///
  /// * [String] smsId:
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<Response> getTransformerResultsTableWithHttpInfo(bool includeMetaData, bool flattenArraysToRows, { String? emailId, String? smsId, String? attachmentId, String? aiTransformId, String? aiTransformMappingId, String? entityId, String? entityType, int? page, int? size, String? sort, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ai/transformer/results/table';
    ...
    if (sort != null) {
      ...
      queryParams.addAll(_queryParams('', 'includeMetaData', includeMetaData));
      queryParams.addAll(_queryParams('', 'flattenArraysToRows', flattenArraysToRows));
  ...
  /// * [String] sort:
  ///   Optional createdAt sort direction ASC or DESC
  Future<PageTableData?> getTransformerResultsTable(bool includeMetaData, bool flattenArraysToRows, { String? emailId, String? smsId, String? attachmentId, String? aiTransformId, String? aiTransformMappingId, String? entityId, String? entityType, int? page, int? size, String? sort, }) async {
    final response = await getTransformerResultsTableWithHttpInfo(includeMetaData, flattenArraysToRows,  emailId: emailId, smsId: smsId, attachmentId: attachmentId, aiTransformId: aiTransformId, aiTransformMappingId: aiTransformMappingId, entityId: entityId, entityType: entityType, page: page, size: size, sort: sort, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PageTableData',) as PageTableData;
  ...
  ///
  /// * [String] attachmentId:
  Future<Response> testTransformerMappingMatchWithHttpInfo(String id, { String? emailId, String? smsId, String? attachmentId, }) async {
    // ignore: prefer_const_declarations
    final path = r'/ai/transformer/mappings/{id}/match'
      .replaceAll('{id}', id);
  ...
  ///
  /// * [String] attachmentId:
  Future<AITransformMappingMatchResult?> testTransformerMappingMatch(String id, { String? emailId, String? smsId, String? attachmentId, }) async {
    final response = await testTransformerMappingMatchWithHttpInfo(id,  emailId: emailId, smsId: smsId, attachmentId: attachmentId, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
    ...
    // FormatException when trying to decode an empty string.
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'AITransformMappingMatchResult',) as AITransformMappingMatchResult;
