...
// tests for PagePlusAddressProjection
void main() {
  // final instance = PagePlusAddressProjection();

  group('test PagePlusAddressProjection', () {
    // List<PlusAddressProjection> content (default value: const [])
