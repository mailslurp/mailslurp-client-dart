...
// tests for PageBouncedRecipients
void main() {
  // final instance = PageBouncedRecipients();

  group('test PageBouncedRecipients', () {
    // List<BounceRecipientProjection> content (default value: const [])
