...
// tests for CreateTotpDeviceBase32SecretKeyOptions
void main() {
  // final instance = CreateTotpDeviceBase32SecretKeyOptions();

  group('test CreateTotpDeviceBase32SecretKeyOptions', () {
    // Base32 secret key for TOTP device as alternative to OTP Auth URI or QR code.
    // String base32SecretKey
    test('to test the property `base32SecretKey`', () async {
      // TODO
    });
