...
// tests for CreateContactOptions
void main() {
  // final instance = CreateContactOptions();

  group('test CreateContactOptions', () {
    // String firstName
    ...
    // List<String> emailAddresses (default value: const [])
    ...
    test('to test the property `verifyEmailAddresses`', () async {
      // TODO
    });
