...
// tests for PageInboxReplierEvents
void main() {
  // final instance = PageInboxReplierEvents();

  group('test PageInboxReplierEvents', () {
    // List<InboxReplierEventProjection> content (default value: const [])
