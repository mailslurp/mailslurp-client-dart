...
// tests for PageEntityFavouriteItems
void main() {
  // final instance = PageEntityFavouriteItems();

  group('test PageEntityFavouriteItems', () {
    // List<EntityFavouriteItemProjection> content (default value: const [])
