...
// tests for PageInboxForwarderEvents
void main() {
  // final instance = PageInboxForwarderEvents();

  group('test PageInboxForwarderEvents', () {
    // List<InboxForwarderEventProjection> content (default value: const [])
