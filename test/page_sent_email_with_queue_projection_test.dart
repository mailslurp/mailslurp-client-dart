...
// tests for PageSentEmailWithQueueProjection
void main() {
  // final instance = PageSentEmailWithQueueProjection();

  group('test PageSentEmailWithQueueProjection', () {
    // List<SendWithQueueResult> content (default value: const [])
