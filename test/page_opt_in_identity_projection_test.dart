...
// tests for PageOptInIdentityProjection
void main() {
  // final instance = PageOptInIdentityProjection();

  group('test PageOptInIdentityProjection', () {
    // List<OptInIdentityProjection> content (default value: const [])
