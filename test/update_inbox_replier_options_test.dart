...
// tests for UpdateInboxReplierOptions
void main() {
  // final instance = UpdateInboxReplierOptions();

  group('test UpdateInboxReplierOptions', () {
    ...
    // bool ignoreReplyTo
    test('to test the property `ignoreReplyTo`', () async {
      // TODO
    });
