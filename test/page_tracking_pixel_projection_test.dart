...
// tests for PageTrackingPixelProjection
void main() {
  final instance = PageTrackingPixelProjection();

  group('test PageTrackingPixelProjection', () {
    // List<TrackingPixelProjection> content (default value: const [])
