...
// tests for PageEntityAutomationItems
void main() {
  // final instance = PageEntityAutomationItems();

  group('test PageEntityAutomationItems', () {
    // List<EntityAutomationItemProjection> content (default value: const [])
