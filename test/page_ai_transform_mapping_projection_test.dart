...
// tests for PageAITransformMappingProjection
void main() {
  // final instance = PageAITransformMappingProjection();

  group('test PageAITransformMappingProjection', () {
    // List<AITransformMappingProjection> content (default value: const [])
