...
// tests for CreateEmailAuditOptions
void main() {
  // final instance = CreateEmailAuditOptions();

  group('test CreateEmailAuditOptions', () {
    ...
    test('to test the property `emailAnalysis`', () async {
      // TODO
    });
