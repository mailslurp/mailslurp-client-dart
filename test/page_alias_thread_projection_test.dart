...
// tests for PageAliasThreadProjection
void main() {
  // final instance = PageAliasThreadProjection();

  group('test PageAliasThreadProjection', () {
    // List<AliasThreadProjection> content (default value: const [])
