...
// tests for GenerateStructuredContentAttachmentOptions
void main() {
  // final instance = GenerateStructuredContentAttachmentOptions();

  group('test GenerateStructuredContentAttachmentOptions', () {
    ...
    test('to test the property `outputSchema`', () async {
      // TODO
    });

    // ID of transformer to apply
    // String transformId
    test('to test the property `transformId`', () async {
      // TODO
    });
