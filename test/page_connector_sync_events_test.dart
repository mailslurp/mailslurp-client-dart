...
// tests for PageConnectorSyncEvents
void main() {
  // final instance = PageConnectorSyncEvents();

  group('test PageConnectorSyncEvents', () {
    // List<ConnectorSyncEventProjection> content (default value: const [])
