...
// tests for PagePhoneMessageThreadItemProjection
void main() {
  // final instance = PagePhoneMessageThreadItemProjection();

  group('test PagePhoneMessageThreadItemProjection', () {
    // List<PhoneMessageThreadItemProjection> content (default value: const [])
