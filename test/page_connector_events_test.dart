...
// tests for PageConnectorEvents
void main() {
  // final instance = PageConnectorEvents();

  group('test PageConnectorEvents', () {
    // List<ConnectorEventProjection> content (default value: const [])
