...
// tests for PageMissedEmailProjection
void main() {
  final instance = PageMissedEmailProjection();

  group('test PageMissedEmailProjection', () {
    // List<MissedEmailProjection> content (default value: const [])
