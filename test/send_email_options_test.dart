...
void main() {
  ...
  group('test SendEmailOptions', () {
    ...
    // Map<String, String> customHeaders (default value: const {})
    test('to test the property `customHeaders`', () async {
      // TODO
    });
    ...
    test('to test the property `ignoreEmptyRecipients`', () async {
      // TODO
    });

    // Is content AMP4EMAIL compatible. If set will send as x-amp-html part.
    // bool isXAmpHtml
    test('to test the property `isXAmpHtml`', () async {
      // TODO
    });

    // Email body content parts for multipart mime message. Will override body.
    // List<SendEmailBodyPart> bodyParts (default value: const [])
    test('to test the property `bodyParts`', () async {
      // TODO
    });
