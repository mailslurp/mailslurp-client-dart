...
// tests for EmailIntelligenceListResult
void main() {
  // final instance = EmailIntelligenceListResult();

  group('test EmailIntelligenceListResult', () {
    // List<EmailIntelligenceResultDto> content (default value: const [])
    ...
    // int billableCount
    test('to test the property `billableCount`', () async {
      // TODO
    });
