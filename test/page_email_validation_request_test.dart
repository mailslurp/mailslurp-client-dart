...
// tests for PageEmailValidationRequest
void main() {
  final instance = PageEmailValidationRequest();

  group('test PageEmailValidationRequest', () {
    // List<EmailValidationRequestDto> content (default value: const [])
