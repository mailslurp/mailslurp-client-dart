...
// tests for PagePhoneMessageThreadProjection
void main() {
  // final instance = PagePhoneMessageThreadProjection();

  group('test PagePhoneMessageThreadProjection', () {
    // List<PhoneMessageThreadProjection> content (default value: const [])
