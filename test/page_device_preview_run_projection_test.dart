...
// tests for PageDevicePreviewRunProjection
void main() {
  // final instance = PageDevicePreviewRunProjection();

  group('test PageDevicePreviewRunProjection', () {
    // List<DevicePreviewRunDto> content (default value: const [])
