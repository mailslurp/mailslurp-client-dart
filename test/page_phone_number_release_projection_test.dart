...
// tests for PagePhoneNumberReleaseProjection
void main() {
  // final instance = PagePhoneNumberReleaseProjection();

  group('test PagePhoneNumberReleaseProjection', () {
    // List<PhoneNumberReleaseProjection> content (default value: const [])
