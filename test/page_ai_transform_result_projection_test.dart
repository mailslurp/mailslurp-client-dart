...
// tests for PageAITransformResultProjection
void main() {
  // final instance = PageAITransformResultProjection();

  group('test PageAITransformResultProjection', () {
    // List<AITransformResultProjectionDto> content (default value: const [])
