...
// tests for PageUnknownMissedEmailProjection
void main() {
  final instance = PageUnknownMissedEmailProjection();

  group('test PageUnknownMissedEmailProjection', () {
    // List<UnknownMissedEmailProjection> content (default value: const [])
