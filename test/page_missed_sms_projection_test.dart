...
// tests for PageMissedSmsProjection
void main() {
  // final instance = PageMissedSmsProjection();

  group('test PageMissedSmsProjection', () {
    // List<MissedSmsProjection> content (default value: const [])
