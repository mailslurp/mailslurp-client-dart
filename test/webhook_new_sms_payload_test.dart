...
// tests for WebhookNewSmsPayload
void main() {
  // final instance = WebhookNewSmsPayload();

  group('test WebhookNewSmsPayload', () {
    ...
    // String toNumber
    test('to test the property `toNumber`', () async {
      // TODO
    });

    // Sender phone number
    // String fromNumber
    test('to test the property `fromNumber`', () async {
      // TODO
    });
