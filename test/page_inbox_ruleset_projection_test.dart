...
// tests for PageInboxRulesetProjection
void main() {
  final instance = PageInboxRulesetProjection();

  group('test PageInboxRulesetProjection', () {
    // List<InboxRulesetProjection> content (default value: const [])
