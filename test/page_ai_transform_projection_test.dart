...
// tests for PageAITransformProjection
void main() {
  // final instance = PageAITransformProjection();

  group('test PageAITransformProjection', () {
    // List<AITransformProjection> content (default value: const [])
