...
// tests for DevicePreviewFeedbackDto
void main() {
  // final instance = DevicePreviewFeedbackDto();

  group('test DevicePreviewFeedbackDto', () {
    // String feedbackId
    ...
    // String screenshotId
    test('to test the property `screenshotId`', () async {
      // TODO
    });
    ...
    // String liveViewUrl
    test('to test the property `liveViewUrl`', () async {
      // TODO
    });
