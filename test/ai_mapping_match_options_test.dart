...
// tests for AIMappingMatchOptions
void main() {
  // final instance = AIMappingMatchOptions();

  group('test AIMappingMatchOptions', () {
    ...
    // List<AIMappingMatchOption> matches (default value: const [])
