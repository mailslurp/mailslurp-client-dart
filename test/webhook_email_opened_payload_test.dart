...
// tests for WebhookEmailOpenedPayload
void main() {
  // final instance = WebhookEmailOpenedPayload();

  group('test WebhookEmailOpenedPayload', () {
    ...
    // String pixelId
    test('to test the property `pixelId`', () async {
      // TODO
    });
