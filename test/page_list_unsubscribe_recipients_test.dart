...
// tests for PageListUnsubscribeRecipients
void main() {
  // final instance = PageListUnsubscribeRecipients();

  group('test PageListUnsubscribeRecipients', () {
    // List<ListUnsubscribeRecipientProjection> content (default value: const [])
