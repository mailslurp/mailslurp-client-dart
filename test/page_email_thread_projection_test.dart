...
// tests for PageEmailThreadProjection
void main() {
  // final instance = PageEmailThreadProjection();

  group('test PageEmailThreadProjection', () {
    // List<EmailThreadProjection> content (default value: const [])
