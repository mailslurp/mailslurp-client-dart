...
// tests for PagePhoneNumberProjection
void main() {
  final instance = PagePhoneNumberProjection();

  group('test PagePhoneNumberProjection', () {
    // List<PhoneNumberProjection> content (default value: const [])
