...
// tests for PageEntityEventItems
void main() {
  // final instance = PageEntityEventItems();

  group('test PageEntityEventItems', () {
    // List<EntityEventItemProjection> content (default value: const [])
