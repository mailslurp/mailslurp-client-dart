...
// tests for SentEmailDto
void main() {
  // final instance = SentEmailDto();

  group('test SentEmailDto', () {
    // ID of sent email
    // String id
    ...
    // List<String> pixelIds (default value: const [])
    test('to test the property `pixelIds`', () async {
      // TODO
    });
    ...
    // bool virtualSend
    test('to test the property `virtualSend`', () async {
      // TODO
    });
    ...
    // String textExcerpt
    test('to test the property `textExcerpt`', () async {
      // TODO
    });
