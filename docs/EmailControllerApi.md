...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxIds** | [**List&lt;String&gt;**](String.md)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs | [optional] [default to []]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**String**](.md)| ID of the inbox you want to get the latest email from | [optional] [default to null]
