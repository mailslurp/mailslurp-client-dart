...
> PageWebhookResult getAllWebhookResults(page, size, sort, searchFilter, since, before, unseenOnly, resultType, eventName, minStatusCode, maxStatusCode, inboxId, smsId, attachmentId, emailId, phoneId)
...
try {
    final result = api_instance.getAllWebhookResults(page, size, sort, searchFilter, since, before, unseenOnly, resultType, eventName, minStatusCode, maxStatusCode, inboxId, smsId, attachmentId, emailId, phoneId);
    print(result);
} catch (e) {
...
# **getAllWebhooks**
> PageWebhookProjection getAllWebhooks(page, size, sort, searchFilter, since, inboxId, phoneId, before, health, eventType, url)
...
try {
    final result = api_instance.getAllWebhooks(page, size, sort, searchFilter, since, inboxId, phoneId, before, health, eventType, url);
    print(result);
} catch (e) {
...
# **getWebhookResults**
> PageWebhookResult getWebhookResults(webhookId, page, size, sort, searchFilter, since, before, unseenOnly, resultType, eventName, minStatusCode, maxStatusCode, inboxId, smsId, attachmentId, emailId, phoneId)
...
try {
    final result = api_instance.getWebhookResults(webhookId, page, size, sort, searchFilter, since, before, unseenOnly, resultType, eventName, minStatusCode, maxStatusCode, inboxId, smsId, attachmentId, emailId, phoneId);
    print(result);
} catch (e) {
...
# **updateWebhook**
> WebhookDto updateWebhook(webhookId, createWebhookOptions, inboxId, phoneNumberId, overrideAuth)
...
try {
    final result = api_instance.updateWebhook(webhookId, createWebhookOptions, inboxId, phoneNumberId, overrideAuth);
    print(result);
} catch (e) {
