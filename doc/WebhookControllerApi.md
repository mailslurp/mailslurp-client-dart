...
try { 
    final result = api_instance.getAllWebhookResults(page, searchFilter, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getAllWebhooks(page, searchFilter, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getInboxWebhooksPaginated(inboxId, page, searchFilter, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getWebhookResults(webhookId, page, searchFilter, size, sort);
    print(result);
} catch (e) {
