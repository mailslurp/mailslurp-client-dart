...
# **getAllWebhooks**
> PageWebhookProjection getAllWebhooks(page, size, sort, searchFilter, since, inboxId, aiTransformerId, phoneId, before, health, eventType, url, eventTypeSource, includeAccountWide)
...
final eventTypeSource = eventTypeSource_example; // String | Webhook source type category such as phone, inbox, aiTranformer
final includeAccountWide = true; // bool | Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters

try {
    final result = api_instance.getAllWebhooks(page, size, sort, searchFilter, since, inboxId, aiTransformerId, phoneId, before, health, eventType, url, eventTypeSource, includeAccountWide);
    print(result);
} catch (e) {
 ...
 **eventTypeSource** | **String**| Webhook source type category such as phone, inbox, aiTranformer | [optional] 
 **includeAccountWide** | **bool**| Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters | [optional] 
...
> PageWebhookProjection getInboxWebhooksPaginated(inboxId, page, size, sort, searchFilter, since, before, health, eventType, includeAccountWide)
...
final health = health_example; // String | Filter by webhook health
final eventType = eventType_example; // String | Optional event type
final includeAccountWide = true; // bool | Include account scope inbox webhooks

try {
    final result = api_instance.getInboxWebhooksPaginated(inboxId, page, size, sort, searchFilter, since, before, health, eventType, includeAccountWide);
    print(result);
} catch (e) {
 ...
 **health** | **String**| Filter by webhook health | [optional] 
 **eventType** | **String**| Optional event type | [optional] 
 **includeAccountWide** | **bool**| Include account scope inbox webhooks | [optional] 
...
> PageWebhookProjection getPhoneNumberWebhooksPaginated(phoneId, page, size, sort, since, before, eventType, searchFilter, health, includeAccountWide)
...
final searchFilter = searchFilter_example; // String | Optional search filter
final health = health_example; // String | Filter by webhook health
final includeAccountWide = true; // bool | Include account scope phone webhooks

try {
    final result = api_instance.getPhoneNumberWebhooksPaginated(phoneId, page, size, sort, since, before, eventType, searchFilter, health, includeAccountWide);
    print(result);
} catch (e) {
 ...
 **searchFilter** | **String**| Optional search filter | [optional] 
 **health** | **String**| Filter by webhook health | [optional] 
 **includeAccountWide** | **bool**| Include account scope phone webhooks | [optional] 
