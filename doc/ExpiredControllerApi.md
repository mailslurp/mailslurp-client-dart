...
> ExpiredInboxDto getExpiredInboxRecord(iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis)
...
final api_instance = ExpiredControllerApi();
final iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 

try { 
    final result = api_instance.getExpiredInboxRecord(iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis);
    print(result);
} catch (e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **iDOfTheExpiredInboxRecordYouWantToRetrievePeriodThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInPeriodSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxIdRightParenthesis** | [**String**]()|  | 
