...
# **getExpiredInboxes**
> PageExpiredInboxRecordProjection getExpiredInboxes(page, size, sort, since, before, inboxId)
...
final inboxId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | Optionally filter by inbox ID

try {
    final result = api_instance.getExpiredInboxes(page, size, sort, since, before, inboxId);
    print(result);
} catch (e) {
 ...
 **inboxId** | **String**| Optionally filter by inbox ID | [optional] 
