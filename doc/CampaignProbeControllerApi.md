...
> CampaignProbeRunComparisonDto compareCampaignProbeRuns(probeId, runId, otherRunId)
...
try {
    final result = api_instance.compareCampaignProbeRuns(probeId, runId, otherRunId);
    print(result);
} catch (e) {
    print('Exception when calling CampaignProbeControllerApi->compareCampaignProbeRuns: $e\n');
}
```
...
# **getCampaignProbeRun**
> CampaignProbeRunDto getCampaignProbeRun(probeId, runId)
...
try {
    final result = api_instance.getCampaignProbeRun(probeId, runId);
    print(result);
} catch (e) {
    print('Exception when calling CampaignProbeControllerApi->getCampaignProbeRun: $e\n');
}
```
