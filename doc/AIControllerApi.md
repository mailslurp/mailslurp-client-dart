...
> ExportTransformerResponse exportTransformerResults(exportTransformerOptions)
...
final api_instance = AIControllerApi();
final exportTransformerOptions = ExportTransformerOptions(); // ExportTransformerOptions | 

try {
    final result = api_instance.exportTransformerResults(exportTransformerOptions);
    print(result);
} catch (e) {
    print('Exception when calling AIControllerApi->exportTransformerResults: $e\n');
}
```
...
> ExportTransformerResultJobDto getExportTransformerResultsJob(id)
...
try {
    final result = api_instance.getExportTransformerResultsJob(id);
    print(result);
} catch (e) {
    print('Exception when calling AIControllerApi->getExportTransformerResultsJob: $e\n');
}
```
...
> PageAITransformResultProjection getTransformerResults(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort)
...
try {
    final result = api_instance.getTransformerResults(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort);
    print(result);
} catch (e) {
...
> PageTableData getTransformerResultsTable(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort)
...
final api_instance = AIControllerApi();
final includeMetaData = true; // bool | 
final flattenArraysToRows = true; // bool | 
final emailId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
final smsId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
final attachmentId = attachmentId_example; // String | 
final aiTransformId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
...
try {
    final result = api_instance.getTransformerResultsTable(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort);
    print(result);
} catch (e) {
    print('Exception when calling AIControllerApi->getTransformerResultsTable: $e\n');
}
```
...
> AITransformMappingMatchResult testTransformerMappingMatch(id, emailId, smsId, attachmentId)
...
try {
    final result = api_instance.testTransformerMappingMatch(id, emailId, smsId, attachmentId);
    print(result);
} catch (e) {
    print('Exception when calling AIControllerApi->testTransformerMappingMatch: $e\n');
}
```
