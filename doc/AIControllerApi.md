...
# **createTransformer**
> PageAITransformProjection createTransformer(options, page, size, sort)
...
final options = ; // AITranformCreateOptions | 
final page = 56; // int | 
...
try {
    final result = api_instance.createTransformer(options, page, size, sort);
    print(result);
} catch (e) {
...
# **createTransformer1**
> AITransformDto createTransformer1(aITranformCreateOptions)
...
final api_instance = AIControllerApi();
final aITranformCreateOptions = AITranformCreateOptions(); // AITranformCreateOptions | 

try {
    final result = api_instance.createTransformer1(aITranformCreateOptions);
    print(result);
} catch (e) {
    print('Exception when calling AIControllerApi->createTransformer1: $e\n');
}
```
