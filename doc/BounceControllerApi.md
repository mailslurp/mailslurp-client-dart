...
# **getReputationItems**
> PageReputationItems getReputationItems(page, size, sort, since, before)
...
try {
    final result = api_instance.getReputationItems(page, size, sort, since, before);
    print(result);
} catch (e) {
    print('Exception when calling BounceControllerApi->getReputationItems: $e\n');
}
```
...
> TenantReputationFindingsDto getTenantReputationFindings(accountRegion)
...
final api_instance = BounceControllerApi();
final accountRegion = accountRegion_example; // String | Optional account region filter

try {
    final result = api_instance.getTenantReputationFindings(accountRegion);
    print(result);
} catch (e) {
    print('Exception when calling BounceControllerApi->getTenantReputationFindings: $e\n');
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **accountRegion** | **String**| Optional account region filter | [optional] 
...
> TenantReputationStatusSummaryDto getTenantReputationStatusSummary(accountRegion)
...
try {
    final result = api_instance.getTenantReputationStatusSummary(accountRegion);
    print(result);
} catch (e) {
    print('Exception when calling BounceControllerApi->getTenantReputationStatusSummary: $e\n');
}
```
