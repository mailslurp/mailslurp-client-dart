...
# **getSmsCodes**
> ExtractCodesResult getSmsCodes(smsId, extractCodesOptions)
...
final api_instance = SmsControllerApi();
final smsId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | ID of SMS to extract codes from
final extractCodesOptions = ExtractCodesOptions(); // ExtractCodesOptions | 

try {
    final result = api_instance.getSmsCodes(smsId, extractCodesOptions);
    print(result);
} catch (e) {
    print('Exception when calling SmsControllerApi->getSmsCodes: $e\n');
}
```
...
# **markAllSmsAsRead**
> markAllSmsAsRead(read, phoneNumberId)
...
final api_instance = SmsControllerApi();
final read = true; // bool | 
final phoneNumberId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 

try {
    api_instance.markAllSmsAsRead(read, phoneNumberId);
} catch (e) {
    print('Exception when calling SmsControllerApi->markAllSmsAsRead: $e\n');
}
```
...
# **markSmsAsRead**
> SmsDto markSmsAsRead(smsId, read)
...
try {
    final result = api_instance.markSmsAsRead(smsId, read);
    print(result);
} catch (e) {
    print('Exception when calling SmsControllerApi->markSmsAsRead: $e\n');
}
```
