...
# **getEmails**
> List<EmailPreview> getEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly)
...
try { 
    final result = api_instance.getEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getInboxSentEmails(inboxId, page, searchFilter, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getOrganizationInboxes(page, searchFilter, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.listInboxRulesets(inboxId, page, searchFilter, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.listInboxTrackingPixels(inboxId, page, searchFilter, size, sort);
    print(result);
} catch (e) {
