...
final search = search_example; // String | Optionally filter by search words partial matching name and email address
...
> PlusAddressDto getOrCreateInboxPlusAddress(inboxId, fullAddress)
...
final api_instance = InboxControllerApi();
final inboxId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | ID of the inbox you want to target
final fullAddress = fullAddress_example; // String | Full recipient address including +suffix. Example: `inbox+alias@domain.com`

try {
    final result = api_instance.getOrCreateInboxPlusAddress(inboxId, fullAddress);
    print(result);
} catch (e) {
    print('Exception when calling InboxControllerApi->getOrCreateInboxPlusAddress: $e\n');
}
```
...
> PlusAddressDto getOrCreatePlusAddressByFullAddress(fullAddress)
...
try {
    final result = api_instance.getOrCreatePlusAddressByFullAddress(fullAddress);
    print(result);
} catch (e) {
    print('Exception when calling InboxControllerApi->getOrCreatePlusAddressByFullAddress: $e\n');
}
```
...
> Email importEmailIntoInbox(inboxId, importEmailOptions)
...
final api_instance = InboxControllerApi();
final inboxId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
final importEmailOptions = ImportEmailOptions(); // ImportEmailOptions | 

try {
    final result = api_instance.importEmailIntoInbox(inboxId, importEmailOptions);
    print(result);
} catch (e) {
    print('Exception when calling InboxControllerApi->importEmailIntoInbox: $e\n');
}
```
...
> Email importEmailIntoInboxBytes(inboxId, body, externalId, runPipeline, overrideMessageId)
...
final runPipeline = true; // bool | 
final overrideMessageId = true; // bool | 

try {
    final result = api_instance.importEmailIntoInboxBytes(inboxId, body, externalId, runPipeline, overrideMessageId);
    print(result);
} catch (e) {
    print('Exception when calling InboxControllerApi->importEmailIntoInboxBytes: $e\n');
}
```
 ...
 **runPipeline** | **bool**|  | [optional] [default to false]
 **overrideMessageId** | **bool**|  | [optional] [default to true]
...
> Email importEmailIntoInboxMultipart(inboxId, file, externalId, runPipeline, overrideMessageId)
...
try {
    final result = api_instance.importEmailIntoInboxMultipart(inboxId, file, externalId, runPipeline, overrideMessageId);
    print(result);
} catch (e) {
    print('Exception when calling InboxControllerApi->importEmailIntoInboxMultipart: $e\n');
}
```
...
# **updateImapAccess**
> updateImapAccess(updateImapAccessOptions, inboxId)
...
final api_instance = InboxControllerApi();
final updateImapAccessOptions = UpdateImapAccessOptions(); // UpdateImapAccessOptions | 
final inboxId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | Inbox ID

try {
    api_instance.updateImapAccess(updateImapAccessOptions, inboxId);
} catch (e) {
    print('Exception when calling InboxControllerApi->updateImapAccess: $e\n');
}
```
...
# **updateSmtpAccess**
> updateSmtpAccess(updateSmtpAccessOptions, inboxId)
...
final api_instance = InboxControllerApi();
final updateSmtpAccessOptions = UpdateSmtpAccessOptions(); // UpdateSmtpAccessOptions | 
final inboxId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | Inbox ID

try {
    api_instance.updateSmtpAccess(updateSmtpAccessOptions, inboxId);
} catch (e) {
    print('Exception when calling InboxControllerApi->updateSmtpAccess: $e\n');
}
```
