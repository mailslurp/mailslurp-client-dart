...
> TestInboxRulesetReceivingResult testInboxRulesetReceiving(testInboxRulesetReceivingOptions)
...
final api_instance = InboxRulesetControllerApi();
final testInboxRulesetReceivingOptions = TestInboxRulesetReceivingOptions(); // TestInboxRulesetReceivingOptions | 

try {
    final result = api_instance.testInboxRulesetReceiving(testInboxRulesetReceivingOptions);
    print(result);
} catch (e) {
    print('Exception when calling InboxRulesetControllerApi->testInboxRulesetReceiving: $e\n');
}
```
...
> TestInboxRulesetSendingResult testInboxRulesetSending(testInboxRulesetSendingOptions)
...
try {
    final result = api_instance.testInboxRulesetSending(testInboxRulesetSendingOptions);
    print(result);
} catch (e) {
    print('Exception when calling InboxRulesetControllerApi->testInboxRulesetSending: $e\n');
}
```
