...
try {
    api_instance.deleteAllValidationRequests();
} catch (e) {
    print('Exception when calling EmailVerificationControllerApi->deleteAllValidationRequests: $e\n');
}
```
...
try {
    api_instance.deleteValidationRequest(id);
} catch (e) {
    print('Exception when calling EmailVerificationControllerApi->deleteValidationRequest: $e\n');
}
```
...
> EmailIntelligenceListResult getEmailIntelligence(emailIntelligenceOptions)
...
final api_instance = EmailVerificationControllerApi();
final emailIntelligenceOptions = EmailIntelligenceOptions(); // EmailIntelligenceOptions | 

try {
    final result = api_instance.getEmailIntelligence(emailIntelligenceOptions);
    print(result);
} catch (e) {
    print('Exception when calling EmailVerificationControllerApi->getEmailIntelligence: $e\n');
}
```
