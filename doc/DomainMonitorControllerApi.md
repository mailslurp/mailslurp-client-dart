...
> DomainMonitorRunComparisonDto compareDomainMonitorRuns(monitorId, runId, otherRunId)
...
final otherRunId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 

try {
    final result = api_instance.compareDomainMonitorRuns(monitorId, runId, otherRunId);
    print(result);
} catch (e) {
    print('Exception when calling DomainMonitorControllerApi->compareDomainMonitorRuns: $e\n');
}
```
...
> CheckEmailAuthStackResults getDomainMonitorAuthStack(monitorId, dkimSelector)
...
final api_instance = DomainMonitorControllerApi();
final monitorId = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | 
final dkimSelector = dkimSelector_example; // String | 

try {
    final result = api_instance.getDomainMonitorAuthStack(monitorId, dkimSelector);
    print(result);
} catch (e) {
    print('Exception when calling DomainMonitorControllerApi->getDomainMonitorAuthStack: $e\n');
}
```
...
# **getDomainMonitorRun**
> DomainMonitorRunDto getDomainMonitorRun(monitorId, runId)
...
try {
    final result = api_instance.getDomainMonitorRun(monitorId, runId);
    print(result);
} catch (e) {
    print('Exception when calling DomainMonitorControllerApi->getDomainMonitorRun: $e\n');
}
```
...
> DomainMonitorSummaryDto getDomainMonitorSummary(monitorId, dkimSelector)
...
try {
    final result = api_instance.getDomainMonitorSummary(monitorId, dkimSelector);
    print(result);
} catch (e) {
    print('Exception when calling DomainMonitorControllerApi->getDomainMonitorSummary: $e\n');
}
```
