...
try { 
    final result = api_instance.getAliasEmails(aliasId, page, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getAliasThreads(aliasId, page, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getAliases(page, size, sort);
    print(result);
} catch (e) {
