...
# **getAliasThreads**
> PageAliasThreadProjection getAliasThreads(aliasId, page, size, sort, since, before)
...
# **getThread**
> AliasThreadProjection getThread(threadId)
...
# **getThreadsPaginated**
> PageAliasThreadProjection getThreadsPaginated(page, size, sort, since, before)
