...
# **getPhoneNumbers**
> PagePhoneNumberProjection getPhoneNumbers(phoneCountry, lineType, carrierName, mobileCountryCode, mobileNetworkCode, providerLabel, page, size, sort, since, before, search, include, favourite)
...
try {
    final result = api_instance.getPhoneNumbers(phoneCountry, lineType, carrierName, mobileCountryCode, mobileNetworkCode, providerLabel, page, size, sort, since, before, search, include, favourite);
    print(result);
} catch (e) {
