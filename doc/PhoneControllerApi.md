...
> PhoneNumberDto getPhoneNumberByName()
...
try {
    final result = api_instance.getPhoneNumberByName();
    print(result);
} catch (e) {
...
> PhoneNumberDto getPhoneNumberByPhoneNumber()
...
try {
    final result = api_instance.getPhoneNumberByPhoneNumber();
    print(result);
} catch (e) {
