...
# **waitForEmailCount**
> List<EmailPreview> waitForEmailCount(count, delay, inboxId, since, sort, timeout, unreadOnly)
...
try { 
    final result = api_instance.waitForEmailCount(count, delay, inboxId, since, sort, timeout, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForLatestEmail(delay, inboxId, since, sort, timeout, unreadOnly);
    print(result);
} catch (e) {
...
> List<EmailPreview> waitForMatchingEmails(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly)
...
try { 
    final result = api_instance.waitForMatchingEmails(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForMatchingFirstEmail(matchOptions, delay, inboxId, since, sort, timeout, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForNthEmail(delay, inboxId, index, since, sort, timeout, unreadOnly);
    print(result);
} catch (e) {
