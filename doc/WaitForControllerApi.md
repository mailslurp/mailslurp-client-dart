...
final waitForConditions = WaitForConditions(); // WaitForConditions | Conditions to wait for
...
try { 
    final result = api_instance.waitForEmailCount(count, inboxId, timeout, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForLatestEmail(inboxId, timeout, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForMatchingEmail(matchOptions, count, inboxId, timeout, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForMatchingFirstEmail(matchOptions, inboxId, timeout, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForNthEmail(inboxId, index, timeout, unreadOnly);
    print(result);
} catch (e) {
