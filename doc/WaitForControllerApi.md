...
> List<EmailPreview> waitForMatchingEmail(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly)
...
try { 
    final result = api_instance.waitForMatchingEmail(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly);
    print(result);
} catch (e) {
