...
> ExtractAttachmentTextResult extractAttachmentText(attachmentId, extractAttachmentTextOptions)
...
final api_instance = AttachmentControllerApi();
final attachmentId = attachmentId_example; // String | ID of attachment
final extractAttachmentTextOptions = ExtractAttachmentTextOptions(); // ExtractAttachmentTextOptions | 

try {
    final result = api_instance.extractAttachmentText(attachmentId, extractAttachmentTextOptions);
    print(result);
} catch (e) {
    print('Exception when calling AttachmentControllerApi->extractAttachmentText: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **attachmentId** | **String**| ID of attachment | 
 **extractAttachmentTextOptions** | [**ExtractAttachmentTextOptions**](ExtractAttachmentTextOptions)|  | [optional] 
...
# **uploadMultipartForm**
> List<String> uploadMultipartForm(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest)
...
final importEmailIntoInboxMultipartRequest = ImportEmailIntoInboxMultipartRequest(); // ImportEmailIntoInboxMultipartRequest | 

try {
    final result = api_instance.uploadMultipartForm(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest);
    print(result);
} catch (e) {
 ...
 **importEmailIntoInboxMultipartRequest** | [**ImportEmailIntoInboxMultipartRequest**](ImportEmailIntoInboxMultipartRequest)|  | [optional] 
