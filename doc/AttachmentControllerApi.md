...
# **getAttachments**
> PageAttachmentEntity getAttachments(page, size, sort, fileNameFilter, since, before, inboxId, emailId, sentEmailId)
...
try {
    final result = api_instance.getAttachments(page, size, sort, fileNameFilter, since, before, inboxId, emailId, sentEmailId);
    print(result);
} catch (e) {
