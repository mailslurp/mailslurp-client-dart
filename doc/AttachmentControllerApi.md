...
try { 
    final result = api_instance.getAttachments(before, fileNameFilter, page, since, size, sort);
    print(result);
} catch (e) {
...
> List<String> uploadAttachmentBytes(contentType, filename, byteArray)
...
try { 
    final result = api_instance.uploadAttachmentBytes(contentType, filename, byteArray);
    print(result);
} catch (e) {
