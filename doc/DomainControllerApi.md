...
final api_instance = DomainControllerApi();
final domainOptions = CreateDomainOptions(); // CreateDomainOptions | domainOptions

try { 
    final result = api_instance.createDomain(domainOptions);
    print(result);
} catch (e) {
...
final api_instance = DomainControllerApi();
final id = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | id
final updateDomainDto = UpdateDomainOptions(); // UpdateDomainOptions | updateDomainDto

try { 
    final result = api_instance.updateDomain(id, updateDomainDto);
    print(result);
} catch (e) {
