...
try { 
    final result = api_instance.getAllMissedEmails(before, inboxId, page, searchFilter, since, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getAllUnknownMissedEmails(before, inboxId, page, searchFilter, since, size, sort);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.waitForNthMissedEmail(before, inboxId, index, since, timeout);
    print(result);
} catch (e) {
