...
# **checkEmailAudit1**
> EmailAuditAnalysisResult checkEmailAudit1(emailId)
...
try {
    final result = api_instance.checkEmailAudit1(emailId);
    print(result);
} catch (e) {
    print('Exception when calling EmailControllerApi->checkEmailAudit1: $e\n');
}
```
...
> EmailAuditDto createEmailAuditForEmail(emailId)
...
try {
    final result = api_instance.createEmailAuditForEmail(emailId);
    print(result);
} catch (e) {
    print('Exception when calling EmailControllerApi->createEmailAuditForEmail: $e\n');
}
```
