...
final api_instance = EmailControllerApi();
final htmlSelector = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | Optional inbox filter
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **htmlSelector** | **String**| Optional inbox filter | [optional] 
...
> PageEmailProjection getEmailsOffsetPaginated(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId)
...
try {
    final result = api_instance.getEmailsOffsetPaginated(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId);
    print(result);
} catch (e) {
