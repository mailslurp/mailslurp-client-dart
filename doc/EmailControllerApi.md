...
# **getAttachments1**
> List<AttachmentMetaData> getAttachments1(emailId)
...
try { 
    ...
    print('Exception when calling EmailControllerApi->getAttachments1: $e\n');
}
```
...
try { 
    final result = api_instance.getEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly);
    print(result);
} catch (e) {
...
try { 
    final result = api_instance.getOrganizationEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly);
    print(result);
} catch (e) {
